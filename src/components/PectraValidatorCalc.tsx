...
export default function PectraValidatorCalc() {
  ...
  const focusHandlers = {
    onFocus: (e: React.FocusEvent<HTMLInputElement>) => (e.target.style.borderColor = "#6366f1"),
    onBlur: (e: React.FocusEvent<HTMLInputElement>) => (e.target.style.borderColor = "#30363d"),
  };
            ...
            >
              <style>{`
                @media (max-width: 640px) {
                  ...
                  .pectra-comparison .pectra-arrow {
