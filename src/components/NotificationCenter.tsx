...
const INITIAL_NOTIFICATIONS: Notification[] = [
  {
    id: "n1",
    type: "price",
    title: "BTC broke $88,000",
    message: "Bitcoin surpassed $88K for the first time since January. Your price alert was triggered.",
    timestamp: Date.now() - 1000 * 60 * 15,
    read: false,
    actionUrl: "/tools/price-alerts",
  },
  {
    id: "n2",
    type: "achievement",
    title: "Achievement Unlocked!",
    message: "You earned the 'Daily Degen' badge for visiting 5 days in a row.",
  ...
  },
  {
    ...
    message: "Core devs confirmed the next Ethereum upgrade date. Read the full analysis.",
    timestamp: Date.now() - 1000 * 60 * 60 * 5,
    read: true,
    actionUrl: "/learn/how-to-buy-ethereum",
  },
  {
    id: "n4",
    type: "system",
    title: "New Tool: Token Compare",
    message: "Compare any two tokens side-by-side with our new comparison tool.",
    timestamp: Date.now() - 1000 * 60 * 60 * 12,
    read: true,
    actionUrl: "/tools/token-compare",
  },
  {
    id: "n5",
    type: "price",
    title: "SOL up 6.3% today",
    message: "Solana is one of today's top performers. Check the market recap.",
    timestamp: Date.now() - 1000 * 60 * 60 * 8,
    read: true,
    actionUrl: "/tools/market-recap",
  },
];
