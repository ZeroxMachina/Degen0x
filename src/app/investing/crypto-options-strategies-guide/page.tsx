...
export const metadata: Metadata = {
  title: "Crypto Options Strategies Guide: Covered Calls, Puts &",
  description: "Master crypto options strategies on Deribit, Lyra, and Premia. Real BTC/ETH examples, strike prices, and when to use covered calls, puts, straddles, and iron",
  keywords: [
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Crypto Options Strategies Guide', },
  ],
};
...
export default function CryptoOptionsStrategiesGuide() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Crypto Options Strategies Guide: Covered Calls, Puts &"
        description="Master crypto options strategies on Deribit, Lyra, and Premia. Real BTC/ETH examples, strike prices, and when to use covered calls, puts, straddles, and iron"
        url="https://degen0x.com/investing/crypto-options-strategies-guide"
      ...
      />
        ...
        <LastUpdated pathKey="/investing/crypto-options-strategies-guide" />
        <ReadingTime />
      </div>
<AuthoritySources url="/investing/crypto-options-strategies-guide" />
