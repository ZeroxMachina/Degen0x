...
export const metadata: Metadata = {
  title: 'Crypto Whale Watching Guide 2026: Tools, Signals & Strategies | degen0x',
  description: 'Master crypto whale tracking with Nansen, Arkham, DeBank. Learn whale behavior patterns, identify smart money, read exchange inflows/outflows, and build profitable trading signals.',
