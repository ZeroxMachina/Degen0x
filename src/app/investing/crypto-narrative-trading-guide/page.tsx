...
export const metadata: Metadata = {
  title: 'Crypto Narrative Trading Guide: AI, RWA, DePIN, Memecoins | degen0x',
  description: 'Master narrative trading with 2024-2026 themes: AI tokens, RWA, DePIN, restaking, memecoins, BTCFi. Track lifecycle from discovery to mania to collapse with on-chain signals.',
  keywords: [
