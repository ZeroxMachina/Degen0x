...
export default function EigenLayerVsLidoPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="EigenLayer vs Lido: Restaking vs Liquid Staking (2026) | degen0x"
        description="Detailed comparison of EigenLayer vs Lido. Compare restaking yields, risks, composability, and fees to understand how these protocols complement each other."
        url="https://degen0x.com/investing/staking/compare/eigenlayer-vs-lido"
      ...
      <MethodologyBlock variant="compare" />
        ...
        <LastUpdated pathKey="/investing/staking/compare/eigenlayer-vs-lido" />
        <ReadingTime />
      </div>
<AuthoritySources url="/investing/staking/compare/eigenlayer-vs-lido" />
    </div>
  );
}
