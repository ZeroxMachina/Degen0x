// Auto-generated dynamic route for investing/staking
export const revalidate = 3600;
import type { Metadata } from "next";
import { notFound } from "next/navigation";
import LearnPageLayout from "@/components/LearnPage";
import { pages } from "@/data/pages/investing-staking";
...
export default async function DynamicPage({ params }: Props) {
  ...
  <a href="/investing/staking/best" style={{ color: "#fb923c", marginRight: "1rem", display: "inline-block", marginBottom: "0.5rem" }}>Best</a>
</nav>