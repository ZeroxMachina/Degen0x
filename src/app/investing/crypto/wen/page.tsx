...
export const metadata: Metadata = {
  title: `What Is Wen (WEN)? Price, Guide & How to Buy (${CURRENT_YEAR}) | degen0x`,
...
export default function WenPage() {
  return (
    <LearnPageLayout title="What Is Wen (WEN)? Price, Guide & How to Buy" categoryName="Investing" categorySlug="investing" readTime="8 min read" intro="Wen (WEN) is a meme coin on Solana that originated from the popular crypto phrase 'wen?' (slang for 'when?'). The token was airdropped to Solana users and gained traction as part of the broader Solana meme coin ecosystem, becoming one of the recognizable community tokens on the network." toc={[
        { id: "what-is", title: "what-is", level: 2 },
        { id: "what-is-wen", title: "What Is Wen?", level: 2 },
        { id: "how-it-works", title: "how-it-works", level: 2 },
        { id: "how-does-wen-work", title: "How Does Wen Work?", level: 2 },
        { id: "tokenomics", title: "tokenomics", level: 2 },
        { id: "wen-tokenomics", title: "WEN Tokenomics", level: 2 },
        { id: "use-cases", title: "use-cases", level: 2 },
        { id: "key-use-cases", title: "Key Use Cases", level: 2 },
        { id: "how-to-buy", title: "how-to-buy", level: 2 },
        { id: "how-to-buy-wen", title: "How to Buy WEN", level: 2 },
