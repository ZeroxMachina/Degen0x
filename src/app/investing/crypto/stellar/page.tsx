  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <FAQSection faqs={faqs} />
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Investing/crypto/stellar", "description": "Crypto content on degen0x", "url": "https://degen0x.com/investing/crypto/stellar"}) }} />
          <div style={{
        marginTop: "32px",
        padding: "24px",
