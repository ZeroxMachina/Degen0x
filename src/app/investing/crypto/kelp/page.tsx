...
export const metadata: Metadata = {
  title: `What Is Kelp DAO (rsETH)? Price, Guide & How to Buy (${CURRENT_YEAR}) | CryptoDegen`,
...
export default function KelpPage() {
  return (
    <LearnPageLayout
      ...
      toc={[
        { id: "what-is", title: "What Is Kelp DAO?", level: 2 },
        { id: "how-it-works", title: "How Does Kelp DAO Work?", level: 2 },
        { id: "tokenomics", title: "rsETH Tokenomics", level: 2 },
        { id: "use-cases", title: "Key Use Cases", level: 2 },
        { id: "how-to-buy", title: "How to Buy rsETH", level: 2 },
