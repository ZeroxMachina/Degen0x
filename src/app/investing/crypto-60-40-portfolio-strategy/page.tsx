...
export const metadata: Metadata = {
  title: 'Crypto 60/40 Portfolio Strategy 2026: BTC/ETH Allocation & Rebalancing | degen0x',
  description: 'Crypto 60/40 portfolio: 60% BTC (stability) + 40% ETH (growth) + alts (0-40%). Rebalancing framework, risk management, tax-efficient strategies. Real allocation models for conservative/balanced/aggressive.',
