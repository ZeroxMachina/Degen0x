...
export const metadata: Metadata = {
  title: 'Best Privacy Coins 2026: Monero, Zcash, Secret Network | degen0x',
  description: 'Complete guide to privacy coins 2026. Compare Monero (XMR), Zcash (ZEC), Secret Network, Oasis Network. Discover privacy technologies, regulatory challenges, and anonymity risks.',
