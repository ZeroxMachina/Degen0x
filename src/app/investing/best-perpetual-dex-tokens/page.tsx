...
export const metadata: Metadata = {
  title: 'Best Perpetual DEX Tokens 2024-2026: GMX, dYdX, Synthetix, Drift | degen0x',
  description: 'Compare perpetual DEX tokens by volume, real yield, and staker APY. GMX, dYdX, Synthetix, Drift, Gains, Hyperliquid with fee revenue and liquidity provider metrics.',
  keywords: [
