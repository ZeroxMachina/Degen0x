...
export default function Page() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10">
      <ArticleSchema
        headline="Bitcoin vs Litecoin (2026) | degen0x"
        description="Bitcoin vs Litecoin comparison for ${CURRENT_YEAR}. The original cryptocurrency vs its silver counterpart — technology, adoption, investment thesis compared."
        url="https://degen0x.com/investing/compare/bitcoin-vs-litecoin"
      ...
      <MethodologyBlock variant="compare" />
        ...
        <LastUpdated pathKey="/investing/compare/bitcoin-vs-litecoin" />
        <ReadingTime />
      </div>
<AuthoritySources url="/investing/compare/bitcoin-vs-litecoin" />
    </div>
  );
}
