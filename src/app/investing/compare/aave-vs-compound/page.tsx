...
export default function Page() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10">
      <ArticleSchema
        headline="Aave vs Compound (2026) | degen0x"
        description="Aave vs Compound DeFi lending comparison for ${CURRENT_YEAR}. Interest rates, supported assets, multi-chain presence, governance, and token investment thesis compared."
        url="https://degen0x.com/investing/compare/aave-vs-compound"
      ...
      <MethodologyBlock variant="compare" />
        ...
        <LastUpdated pathKey="/investing/compare/aave-vs-compound" />
        <ReadingTime />
      </div>
<AuthoritySources url="/investing/compare/aave-vs-compound" />
    </div>
  );
}
