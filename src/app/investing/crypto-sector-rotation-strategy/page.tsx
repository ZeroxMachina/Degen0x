...
export const metadata: Metadata = {
  title: 'Crypto Sector Rotation Strategy: 2024-2026 Cycle Analysis | degen0x',
  description: 'Master crypto sector rotation across BTC → ETH → L1s → DeFi → memes. Track BTC dominance, cycle phases, and narrative-driven allocation models with real 2021/2024 examples.',
  keywords: [
