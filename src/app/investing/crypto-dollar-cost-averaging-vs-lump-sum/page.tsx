...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Crypto Dollar Cost Averaging Vs Lump Sum', },
  ],
};
...
export default function DCAvLumpSumInvesting() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="DCA vs Lump Sum Investing: Crypto Backtesting & Strategy"
        description="Bitcoin and Ethereum DCA vs lump sum backtests (2015-2025). Compare returns, drawdowns, frequency. Learn value averaging and automated DCA tools (Coinbase,"
        url="https://degen0x.com/investing/crypto-dollar-cost-averaging-vs-lump-sum"
      ...
      />
        ...
        <LastUpdated pathKey="/investing/crypto-dollar-cost-averaging-vs-lump-sum" />
        <ReadingTime />
      </div>
<AuthoritySources url="/investing/crypto-dollar-cost-averaging-vs-lump-sum" />
