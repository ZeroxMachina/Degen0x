...
const products = [
  { name: "Bitwise 10 Crypto Index Fund", slug: "bitwise-10", rating: 4.5, description: "Tracks the 10 largest cryptocurrencies by market cap, rebalancing monthly. The most established crypto index fund with institutional-grade custody and transparent methodology.", pros: ["Diversified top-10 crypto exposure", "Professional management and rebalancing", "Institutional-grade custody"], cons: ["Higher expense ratio than buying directly", "OTC shares may trade at premium/discount", "Limited to top 10 by market cap"], bestFor: "Passive diversified crypto exposure for traditional investors", affiliateUrl: "#", category: "investing" },
