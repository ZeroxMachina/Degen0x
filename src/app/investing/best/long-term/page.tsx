    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section id="faq">
        <FAQSection faqs={INVESTING_FAQS} />
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Top Long-Term Picks", "description": "Crypto content on degen0x", "url": "https://degen0x.com/investing/best/long-term"}) }} />
          <div style={{
        marginTop: "32px",
        padding: "24px",
