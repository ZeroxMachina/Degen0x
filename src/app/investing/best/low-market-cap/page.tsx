...
export default function Page() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      <ArticleSchema
        headline="Investing"
        description="Yield tokenization protocol enabling trading of future yield and fixed-rate strategies. Innovative DeFi primitive with growing TVL and unique market position."
        url="/investing/best/low-market-cap"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Investing"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/investing/best/low-market-cap" />
        <ReadingTime />
      </div>
<AuthoritySources url="/investing/best/low-market-cap" />
