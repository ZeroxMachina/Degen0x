...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Crypto Scalping Strategy Guide', },
  ],
};
...
export default function CryptoScalpingStrategyGuide() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Crypto Scalping Strategy Guide 2026: 1-5 Min Timeframes,"
        description="Crypto scalping guide: 1-5 minute timeframes, order flow analysis, tight stops 0.5-1%, RSI + VWAP, Bybit vs Binance. Win rate vs R:R targeting."
        url="https://degen0x.com/trading/crypto-scalping-strategy-guide"
      ...
      />
        ...
        <LastUpdated pathKey="/trading/crypto-scalping-strategy-guide" />
        <ReadingTime />
      </div>
<AuthoritySources url="/trading/crypto-scalping-strategy-guide" />
