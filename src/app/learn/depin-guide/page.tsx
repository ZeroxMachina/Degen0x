...
export const metadata: Metadata = {
  title: "DePIN Guide 2026: Decentralised Physical Infrastructure Networks Explained",
  description: "This is one of those topics where surface-level understanding is dangerous. We've seen traders lose significant capital from misconceptions covered in this guid — depin g",
  alternates: { canonical: "https://degen0x.com/learn/depin-guide" },
  openGraph: {
    title: "DePIN Guide 2026: Decentralised Physical Infrastructure Networks Explained",
...
export default function Page() {
  return (
    <>
      <ArticleSchema
        headline="DePIN Guide 2026: Decentralised Physical Infrastructure Networks Explained"
