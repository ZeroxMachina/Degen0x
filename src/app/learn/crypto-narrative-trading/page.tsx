  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section id="what-is-narrative" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">What is Narrative Trading?</h2>
      ...
      <section id="history-narratives" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">History of Crypto Narratives</h2>

        <h3 className="text-xl font-semibold text-white mb-3">2017: ICO Boom</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">2020-2021: DeFi Summer</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">2021: NFTs and Metaverse</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">2022-2023: Bitcoin Spot ETF</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">2024-2025: AI, RWA, and Modular</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="identify-early" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">How to Identify Early Narratives</h2>

        <h3 className="text-xl font-semibold text-white mb-3">1. Monitor Emerging Themes</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">2. Watch Institutional Interest</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">3. Track Developer Activity</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">4. Analyze Capital Flow</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">5. Look for Mainstream Coverage</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">6. Use Narrative Tracker Tools</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="rotation-patterns" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Narrative Rotation Patterns</h2>

        <p className="text-gray-300 mb-4">
          Narratives don't last forever. Understanding rotation patterns helps you exit trades before momentum collapses.
        </p>

        <h3 className="text-xl font-semibold text-white mb-3">The Narrative Lifecycle</h3>
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-4">
          <p className="text-gray-300 mb-3"><strong className="text-white">Phase 1: Discovery (Early Builders)</strong></p>
          <p className="text-gray-400 text-sm mb-4">Small group of developers and enthusiasts building. Prices are low. Few notice.</p>

          <p className="text-gray-300 mb-3"><strong className="text-white">Phase 2: Early Adoption (Smart Money)</strong></p>
          <p className="text-gray-400 text-sm mb-4">VCs fund projects. Prices begin rising. Community grows. Early traders accumulate.</p>

          <p className="text-gray-300 mb-3"><strong className="text-white">Phase 3: Mainstream (Retail FOMO)</strong></p>
          ...
          <p className="text-gray-300 mb-3"><strong className="text-white">Phase 4: Saturation</strong></p>
          <p className="text-gray-400 text-sm mb-4">Narrative becomes crowded. Price growth slows. Early traders take profits.</p>

          <p className="text-gray-300"><strong className="text-white">Phase 5: Collapse & Rotation</strong></p>
          <p className="text-gray-400 text-sm">Capital shifts to next narrative. Prices fall. Weak hands panic sell. Cycle repeats.</p>
        </div>

        <h3 className="text-xl font-semibold text-white mb-3">Identifying Rotation Signals</h3>
      ...
      <section id="risk-management" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Risk Management for Narrative Traders</h2>

        <h3 className="text-xl font-semibold text-white mb-3">1. Position Sizing</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">2. Use Stop Losses</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">3. Take Profits Gradually</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">4. Diversify Across Narratives</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">5. Understand Fundamentals</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">6. Watch for Rug Risks</h3>
        <p className="text-gray-300 mb-4">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mt-12">
        <h3 className="text-white font-bold mb-3">Recommended Tools & Resources</h3>
        <ul className="space-y-2 text-blue-400">
