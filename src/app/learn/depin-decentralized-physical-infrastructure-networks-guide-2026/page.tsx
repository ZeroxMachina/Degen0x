...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'DePIN Networks' },
  ],
};
...
const page = () => {
  ...
  return (
    <div style={{ backgroundColor: "#0d1117", color: "#e6edf3", minHeight: "100vh", padding: "40px 20px" }}>
      <ArticleSchema
        headline="DePIN Networks: Decentralized Physical Infrastructure 2026"
        description="Master DePIN (Decentralized Physical Infrastructure Networks). Learn how crypto incentives power real-world networks: IoT, compute, mobile, storage"
        url="https://degen0x.com/learn/depin-decentralized-physical-infrastructure-networks-guide-2026"
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ marginBottom: "40px" }}>
          ...
          <LastUpdated pathKey="/learn/depin-decentralized-physical-infrastructure-networks-guide-2026" />
          <ReadingTime />
          <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Depin Decentralized Physical Infrastructure Networks Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/depin-decentralized-physical-infrastructure-networks-guide-2026"
            })
          }}
        />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "DePIN Networks: Decentralized Physical Infrastructure 2026", "description": "Master DePIN (Decentralized Physical Infrastructure Networks). Learn how crypto incentives power real-world networks: IoT, compute, mobile, storage", "url": "https://degen0x.com/learn/depin-decentralized-physical-infrastructure-networks-guide-2026", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
<AuthoritySources url="/learn/depin-decentralized-physical-infrastructure-networks-guide-2026" />
</div>
  );
};
