...
export const metadata: Metadata = {
  ...
  description: "We wrote this guide because the existing explanations online are either too simplified or assume PhD-level knowledge. Neither serves most readers — eip 7702 smart account",
  alternates: { canonical: "https://degen0x.com/learn/eip-7702-smart-accounts-guide-2026" },
  openGraph: {
    title: "EIP-7702 & Smart Accounts Guide 2026: Gasless Transactions & Account Abstraction",
  ...
  return (
    <>
      <ArticleSchema
        ...
        section="Learn"
      />
      <AuthoritySources url="/learn/eip-7702-smart-accounts-guide-2026" />
      <AuthorAttribution
        author="DegenSensei"
      ...
      <ClientPage />
      <RelatedContent pathname="/learn/eip-7702-smart-accounts-guide-2026" />
    </>
  );
}
