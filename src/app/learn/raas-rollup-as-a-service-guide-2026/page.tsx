    ...
    <div style={{ backgroundColor: '#0d1117', color: '#e6edf3', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ maxWidth: '820px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <LastUpdated pathKey="/learn/raas-rollup-as-a-service-guide-2026" />
          <ReadingTime />
          <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Raas Rollup As A Service Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/raas-rollup-as-a-service-guide-2026"
            })
          }}
        />
            <div style={{
