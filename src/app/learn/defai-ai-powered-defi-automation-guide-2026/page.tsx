...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'DeFAI' },
  ],
};
...
const page = () => {
  ...
  return (
    <div style={{ backgroundColor: "#0d1117", color: "#e6edf3", minHeight: "100vh", padding: "40px 20px" }}>
      <ArticleSchema
        headline="DeFAI: AI-Powered DeFi Automation & Trading Guide 2026"
        description="Master DeFAI protocols. Learn AI agents, automated trading, portfolio optimization, and how artificial intelligence transforms DeFi investing at scale."
        url="https://degen0x.com/learn/defai-ai-powered-defi-automation-guide-2026"
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ marginBottom: "40px" }}>
          ...
          <LastUpdated pathKey="/learn/defai-ai-powered-defi-automation-guide-2026" />
          <ReadingTime />
          <AutoTOC />
        ...
        />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "DeFAI: AI-Powered DeFi Automation & Trading Guide 2026", "description": "Master DeFAI protocols. Learn AI agents, automated trading, portfolio optimization, and how artificial intelligence transforms DeFi investing at scale.", "url": "https://degen0x.com/learn/defai-ai-powered-defi-automation-guide-2026", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
<AuthoritySources url="/learn/defai-ai-powered-defi-automation-guide-2026" />
</div>
  );
};
