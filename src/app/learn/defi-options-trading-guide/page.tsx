...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Defi Options Trading Guide', },
  ],
};
    ...
    <div style={{ minHeight: "100vh", background: "#0d1117", color: "#e6edf3" }}>
      ...
      <article className="defi-options-article" style={{ maxWidth: 820, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        <header style={{ marginBottom: 32 }}>
          ...
          <LastUpdated pathKey="/learn/defi-options-trading-guide" />
          <ReadingTime />
          <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Defi Options Trading Guide",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/defi-options-trading-guide"
            })
          }}
        />
      </article>
