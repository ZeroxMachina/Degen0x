  ...
  return (
    <div style={{ backgroundColor: 'var(--color-bg)', color: 'var(--color-text)', minHeight: '100vh' }}>
      ...
      <style>{`
        ...
        .erc-toc-link:focus-visible { outline: 2px solid var(--color-primary); outline-offset: 2px; }
        .erc-related-card:hover { border-color: var(--color-primary-light) !important; background-color: var(--color-bg) !important; }
        .erc-related-card:focus-visible { outline: 2px solid var(--color-primary); outline-offset: 2px; }
      ...
      <div className="erc-container" style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '18px', color: 'var(--color-text-secondary)', marginBottom: '20px', lineHeight: '1.6' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            {tableOfContents.map((item, index) => (
              <li key={item.id} style={{ marginBottom: '8px' }}>
                ...
                >
                  <span style={{ color: 'var(--color-text-secondary)' }}>{index + 1}.</span> {item.label}
                </a>
              </li>
            ))}
          </ul>
        ...
        <section id="what-is-erc-8183" style={{ marginBottom: '48px' }}>
          <h2 style={{ fontSize: '32px', fontWeight: '700', marginBottom: '20px', color: 'var(--color-text)' }}>
            1. What Is ERC-8183?
          </h2>

          <p style={{ fontSize: '16px', lineHeight: '1.7', marginBottom: '16px', color: 'var(--color-text)' }}>
        ...
        <section id="the-problem" style={{ marginBottom: '48px' }}>
          ...
          <h3 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '12px', color: 'var(--color-primary-light)' }}>
        ...
        <section id="job-lifecycle" style={{ marginBottom: '48px' }}>
          ...
          >
            <p style={{ fontSize: '16px', fontWeight: '600', color: 'var(--color-primary-light)', marginTop: 0, marginBottom: '8px' }}>
              Open
            </p>
            <p style={{ fontSize: '16px', lineHeight: '1.6', margin: 0, color: 'var(--color-text)' }}>
        ...
        <section id="comparison" style={{ marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '16px', lineHeight: '1.7', marginBottom: '24px', color: 'var(--color-text)' }}>
            ...
            >
              <thead>
                <tr style={{ borderBottom: '2px solid var(--color-border)' }}>
                  <th style={{ padding: '12px', textAlign: 'left', color: 'var(--color-primary-light)', fontWeight: '600' }}>
                    Aspect
                  </th>
                  <th style={{ padding: '12px', textAlign: 'left', color: 'var(--color-primary-light)', fontWeight: '600' }}>
                    ERC-8183 (Commerce)
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                  <td style={{ padding: '12px', color: 'var(--color-text-secondary)' }}>Purpose</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Full transaction lifecycle with escrow</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Simple HTTP payment protocol</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Agent identity and reputation</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                  <td style={{ padding: '12px', color: 'var(--color-text-secondary)' }}>Escrow</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Yes, required</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>No (pay-per-request)</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>No</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                  <td style={{ padding: '12px', color: 'var(--color-text-secondary)' }}>Delivery Verification</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Yes, via evaluator oracle</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>No (assumes delivery)</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>No</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                  <td style={{ padding: '12px', color: 'var(--color-text-secondary)' }}>Best For</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Complex jobs, high-value work</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>API calls, simple tasks</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Building trust and reputation</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                  <td style={{ padding: '12px', color: 'var(--color-text-secondary)' }}>Settlement Speed</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Minutes (after evaluation)</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>Seconds (immediate)</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>N/A</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                  <td style={{ padding: '12px', color: 'var(--color-text-secondary)' }}>Integrates With</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>ERC-8004, X402</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>ERC-8183, ERC-8004</td>
                  <td style={{ padding: '12px', color: 'var(--color-text)' }}>ERC-8183, X402</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p style={{ color: 'var(--color-text-secondary)', fontSize: '12px', textAlign: 'center', marginTop: '4px' }}>
        ...
        <section id="faq" style={{ marginBottom: '48px' }}>
          <h2 style={{ fontSize: '32px', fontWeight: '700', marginBottom: '24px', color: 'var(--color-text)' }}>
          ...
          <div style={{ display: 'grid', gap: '16px' }}>
            {[
              ...
              >
                <h3 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '12px', color: 'var(--color-primary-light)', marginTop: 0 }}>
                  Q: {faq.q}
                </h3>
                <p style={{ fontSize: '14px', lineHeight: '1.6', margin: 0, color: 'var(--color-text)' }}>
                  {faq.a}
                </p>
              </div>
            ))}
        ...
        <section style={{ marginBottom: '48px' }}>
          <h2 style={{ fontSize: '24px', fontWeight: '700', marginBottom: '20px', color: 'var(--color-text)' }}>
            Related Resources
          </h2>
          ...
          >
            ...
            >
              <h3 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '8px', color: 'var(--color-primary-light)', marginTop: 0 }}>
            ...
            >
              <h3 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '8px', color: 'var(--color-primary-light)', marginTop: 0 }}>
                Agentic Payment Protocols 2026
              </h3>
              <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)', margin: 0 }}>
