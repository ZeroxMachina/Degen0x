...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'How To Read Crypto Whitepaper', },
  ],
};
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 sm:px-6 py-12">
      ...
      <div className="mb-8">
        ...
        <LastUpdated pathKey="/learn/how-to-read-crypto-whitepaper" />
        <ReadingTime />
        <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "How To Read Crypto Whitepaper",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/how-to-read-crypto-whitepaper"
            })
          }}
        />
            <div style={{
