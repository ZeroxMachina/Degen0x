...
export const metadata: Metadata = {
  title: "Restaking & AVS Ecosystem Guide 2026: EigenLayer, Symbiotic & Karak Compared | degen0x",
  description:
    "Complete guide to the restaking ecosystem in 2026. Understand AVS (Actively Validated Services), compare EigenLayer vs Symbiotic vs Karak, and learn how restaking generates yield from shared security.",
  keywords: [
