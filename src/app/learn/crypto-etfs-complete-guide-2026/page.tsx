...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive guide to crypto ETFs in 2026. Learn about Bitcoin, Ethereum, Solana, XRP, and altcoin ETFs, staking yields, institutional adoption, and investment strategies.',
  keywords: [
    'crypto ETFs',
    'bitcoin ETF',
    'ethereum ETF',
