...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Grass Protocol Depin Guide', },
  ],
};
    ...
    <div style={{ minHeight: "100vh", background: "#0d1117", color: "#e6edf3" }}>
      ...
      <article aria-label="GRASS Protocol Guide 2026" style={{ maxWidth: 820, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        <div style={{ marginTop: 24, marginBottom: 32 }}>
          ...
          <LastUpdated pathKey="/learn/grass-protocol-depin-guide" />
          <ReadingTime />
          <AutoTOC />
...
<AuthoritySources url="/learn/grass-protocol-depin-guide" />
</div>
  );
}
