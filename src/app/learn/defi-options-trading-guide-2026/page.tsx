  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm mb-8">
        <a href="/learn" className="text-[var(--color-primary)] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">
          Learn
        </a>
        <span className="text-[var(--color-text-secondary)] mx-2">/</span>
        <span className="text-[var(--color-text)]">DeFi Options Trading Guide 2026</span>
      </nav>
      ...
      {/* Meta Info */}
      <div className="flex flex-wrap gap-6 mb-12 text-sm text-[var(--color-text-secondary)] pb-8 border-b border-[var(--color-border)]">
      ...
      {/* Table of Contents */}
      <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-6 mb-12">
        <h3 className="text-[var(--color-text)] font-semibold mb-4">Table of Contents</h3>
        <ol className="space-y-2 text-[var(--color-primary)] text-sm">
          <li><a href="#what-are-options" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">1. What Are Crypto Options?</a></li>
          <li><a href="#defi-vs-cex" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">2. DeFi Options vs. Centralized Options (Deribit, OKX)</a></li>
          <li><a href="#derive" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">3. Derive (formerly Lyra): The Market Leader</a></li>
          <li><a href="#stryke" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">4. Stryke (formerly Dopex): Liquidity-First Options</a></li>
          <li><a href="#panoptic" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">5. Panoptic: Permissionless Options on Uniswap</a></li>
          <li><a href="#strategies" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">6. Core Options Strategies for Crypto</a></li>
          <li><a href="#risks" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">7. Risks to Understand Before Trading</a></li>
          <li><a href="#comparison" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">8. Platform Comparison Table</a></li>
          <li><a href="#faq" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">9. FAQ</a></li>
        </ol>
      </div>
      ...
      <section id="what-are-options" className="mb-12">
        ...
        <p className="text-[var(--color-text)] mb-4 leading-relaxed">
          A crypto option is a contract that gives you the <strong className="text-[var(--color-text)]">right, but not the
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[var(--color-border)]">
                <th className="text-left py-3 pr-6 text-[var(--color-primary)]">Term</th>
                <th className="text-left py-3 text-[var(--color-primary)]">What It Means</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-[var(--color-border)]">
                <td className="py-3 pr-6 text-[var(--color-text)] font-semibold">Premium</td>
                <td className="py-3 text-[var(--color-text)]">Price you pay for the option contract</td>
              </tr>
              <tr className="border-b border-[var(--color-border)]">
                <td className="py-3 pr-6 text-[var(--color-text)] font-semibold">Strike Price</td>
                <td className="py-3 text-[var(--color-text)]">The price at which you can exercise the option</td>
              </tr>
              <tr className="border-b border-[var(--color-border)]">
                <td className="py-3 pr-6 text-[var(--color-text)] font-semibold">Expiry</td>
                <td className="py-3 text-[var(--color-text)]">Date the contract expires worthless if not exercised</td>
              </tr>
              <tr className="border-b border-[var(--color-border)]">
                <td className="py-3 pr-6 text-[var(--color-text)] font-semibold">IV (Implied Volatility)</td>
                <td className="py-3 text-[var(--color-text)]">Market's expectation of future price swings — higher IV = pricier options</td>
              </tr>
              <tr className="border-b border-[var(--color-border)]">
                <td className="py-3 pr-6 text-[var(--color-text)] font-semibold">Delta</td>
                <td className="py-3 text-[var(--color-text)]">How much the option price moves per $1 move in the underlying</td>
              </tr>
              <tr>
                <td className="py-3 pr-6 text-[var(--color-text)] font-semibold">Theta Decay</td>
                <td className="py-3 text-[var(--color-text)]">Daily value lost as time passes — options "bleed" toward expiry</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="w-full text-sm border border-[var(--color-border)] rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-[var(--color-bg-card)]">
                <th className="text-left py-3 px-4 text-[var(--color-primary)]">Factor</th>
                <th className="text-left py-3 px-4 text-[var(--color-primary)]">CEX (Deribit, OKX)</th>
                <th className="text-left py-3 px-4 text-[var(--color-primary)]">DeFi (Derive, Stryke, Panoptic)</th>
              </tr>
            </thead>
            <tbody>
      ...
      <section id="derive" className="mb-12">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mt-6 mb-4">How Derive Works</h3>
        <p className="text-[var(--color-text)] mb-4 leading-relaxed">
        ...
        <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-6 my-6">
          <h4 className="text-[var(--color-primary)] font-semibold mb-3">📈 Derive at a Glance</h4>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-[var(--color-text-secondary)]">Monthly Volume</p>
              <p className="text-[var(--color-text)] font-semibold">$369M+</p>
            </div>
            <div>
              <p className="text-[var(--color-text-secondary)]">Market Share (DeFi)</p>
              <p className="text-[var(--color-text)] font-semibold">~70%</p>
            </div>
            <div>
              <p className="text-[var(--color-text-secondary)]">TVL</p>
              <p className="text-[var(--color-text)] font-semibold">$100M+</p>
            </div>
            <div>
              <p className="text-[var(--color-text-secondary)]">Supported Assets</p>
              <p className="text-[var(--color-text)] font-semibold">ETH, BTC + growing</p>
            </div>
          </div>
        </div>
      ...
      <section id="stryke" className="mb-12">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mt-6 mb-4">Stryke's Innovation: Dual-Earning LPs</h3>
        <p className="text-[var(--color-text)] mb-4 leading-relaxed">
        ...
        <p className="text-[var(--color-text)] mb-4 leading-relaxed">
          The result is LPs earning up to <strong className="text-[var(--color-text)]">40× higher returns</strong> than
        ...
        <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-6 my-6">
          <h4 className="text-[var(--color-primary)] font-semibold mb-3">💡 The Stryke LP Model Simplified</h4>
          <div className="space-y-3 text-[var(--color-text)] text-sm">
            <div className="flex items-start gap-3">
              <span className="text-[var(--color-text-secondary)] mt-0.5">1.</span>
              <p>LP deposits into a Stryke vault at a specific price range</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-[var(--color-text-secondary)] mt-0.5">2.</span>
              <p>When price is <strong className="text-[var(--color-text)]">in range</strong>: earns normal swap fees like any AMM LP</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-[var(--color-text-secondary)] mt-0.5">3.</span>
              <p>When price is <strong className="text-[var(--color-text)]">out of range</strong>: idle liquidity is lent to options buyers as collateral, earning option premiums (up to 40× AMM fees)</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-[var(--color-text-secondary)] mt-0.5">4.</span>
      ...
      <section id="panoptic" className="mb-12">
        ...
        <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-6 my-6">
          <h4 className="text-[var(--color-primary)] font-semibold mb-3">🔍 What Makes Panoptic Unique</h4>
          <ul className="text-[var(--color-text)] space-y-2 text-sm">
            <li>• <strong className="text-[var(--color-text)]">No expiries</strong> — options are perpetual, priced via "streaming premiums" accrued continuously</li>
            <li>• <strong className="text-[var(--color-text)]">No oracles</strong> — price discovery comes directly from Uniswap's TWAP</li>
            <li>• <strong className="text-[var(--color-text)]">Any token pair</strong> — if it has a Uniswap v3 pool, Panoptic can create options on it</li>
            <li>• <strong className="text-[var(--color-text)]">Fully on-chain</strong> — no off-chain components, maximally trustless</li>
          </ul>
        </div>
      ...
      <section id="strategies" className="mb-12">
        ...
        <div className="space-y-6">
          <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-6">
            <h4 className="text-[var(--color-text)] font-semibold mb-2">🟢 Buy Calls (Bullish, Defined Risk)</h4>
            <p className="text-[var(--color-text)] text-sm mb-2">
              <strong className="text-[var(--color-text)]">Setup:</strong> Buy an out-of-the-money (OTM) call with 1–4 weeks to expiry.
            </p>
            <p className="text-[var(--color-text)] text-sm mb-2">
              <strong className="text-[var(--color-text)]">When to use:</strong> You expect a significant upward move but want limited downside.
              Great before catalysts (token launches, protocol upgrades, market events).
            </p>
            <p className="text-[var(--color-text)] text-sm">
              <strong className="text-[var(--color-text)]">Max loss:</strong> Premium paid. Max gain: theoretically unlimited.
            </p>
          </div>

          <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-6">
            <h4 className="text-[var(--color-text)] font-semibold mb-2">🔴 Buy Puts (Bearish Hedge)</h4>
            <p className="text-[var(--color-text)] text-sm mb-2">
              <strong className="text-[var(--color-text)]">Setup:</strong> Buy a put below the current price.
            </p>
            <p className="text-[var(--color-text)] text-sm mb-2">
              <strong className="text-[var(--color-text)]">When to use:</strong> Hedging a large spot position during uncertain macro events,
              or expressing a bearish view without shorting. Common before major market events (FOMC, regulatory news).
            </p>
            <p className="text-[var(--color-text)] text-sm">
              <strong className="text-[var(--color-text)]">Max loss:</strong> Premium paid. Max gain: strike price minus zero (if asset goes to zero).
            </p>
          </div>

          <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-6">
            <h4 className="text-[var(--color-text)] font-semibold mb-2">⚡ Sell Covered Calls (Yield on Holdings)</h4>
            <p className="text-[var(--color-text)] text-sm mb-2">
              <strong className="text-[var(--color-text)]">Setup:</strong> Hold ETH or BTC, sell an OTM call against it to collect premium.
            </p>
            <p className="text-[var(--color-text)] text-sm mb-2">
              <strong className="text-[var(--color-text)]">When to use:</strong> You're happy holding long-term but want extra yield in ranging
              markets. This is essentially what Stryke automates for LPs.
            </p>
            <p className="text-[var(--color-text)] text-sm">
              <strong className="text-[var(--color-text)]">Risk:</strong> You cap your upside if the asset rallies past the strike.
            </p>
          </div>

          <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-6">
            <h4 className="text-[var(--color-text)] font-semibold mb-2">🎯 Straddle (Bet on Volatility)</h4>
            <p className="text-[var(--color-text)] text-sm mb-2">
              <strong className="text-[var(--color-text)]">Setup:</strong> Buy both a call and a put at the same strike and expiry.
            </p>
            <p className="text-[var(--color-text)] text-sm mb-2">
              <strong className="text-[var(--color-text)]">When to use:</strong> You expect a major move but don't know the direction.
              Popular around protocol launch events, macroeconomic reports, or regulatory decisions.
            </p>
            <p className="text-[var(--color-text)] text-sm">
              <strong className="text-[var(--color-text)]">Risk:</strong> Both premiums lost if price stays flat. Theta decay hurts straddle buyers.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="risks" className="mb-12">
        ...
        <div className="space-y-4">
          <div className="border-b border-[var(--color-border)] pb-4">
            <h4 className="text-[var(--color-text)] font-semibold mb-2">Smart Contract Risk</h4>
            <p className="text-[var(--color-text)] text-sm">
          ...
          <div className="border-b border-[var(--color-border)] pb-4">
            <h4 className="text-[var(--color-text)] font-semibold mb-2">Liquidity Risk</h4>
            <p className="text-[var(--color-text)] text-sm">
          ...
          <div className="border-b border-[var(--color-border)] pb-4">
            <h4 className="text-[var(--color-text)] font-semibold mb-2">Volatility & Theta Decay</h4>
            <p className="text-[var(--color-text)] text-sm">
          ...
          <div className="pb-4">
            <h4 className="text-[var(--color-text)] font-semibold mb-2">LP Vault Risk (Stryke, Derive LPs)</h4>
            <p className="text-[var(--color-text)] text-sm">
        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full text-sm border border-[var(--color-border)] rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-[var(--color-bg-card)]">
                <th className="text-left py-3 px-4 text-[var(--color-primary)]">Factor</th>
                <th className="text-left py-3 px-4 text-[var(--color-primary)]">Derive</th>
                <th className="text-left py-3 px-4 text-[var(--color-primary)]">Stryke</th>
                <th className="text-left py-3 px-4 text-[var(--color-primary)]">Panoptic</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-t border-[var(--color-border)]">
              ...
              <tr className="border-t border-[var(--color-border)]">
                <td className="py-3 px-4 text-[var(--color-text-secondary)]">Option Type</td>
                <td className="py-3 px-4 text-[var(--color-text)]">Standard (calls/puts)</td>
                <td className="py-3 px-4 text-[var(--color-text)]">AMM-based</td>
                <td className="py-3 px-4 text-[var(--color-text)]">Perpetual</td>
              </tr>
              <tr className="border-t border-[var(--color-border)] bg-[var(--color-bg-card)]/30">
              ...
              <tr className="border-t border-[var(--color-border)] bg-[var(--color-bg-card)]/30">
                ...
                <td className="py-3 px-4 text-[var(--color-text)]">Active options traders</td>
                <td className="py-3 px-4 text-[var(--color-text)]">LPs seeking yield boost</td>
                <td className="py-3 px-4 text-[var(--color-text)]">Long-tail token options</td>
              </tr>
              <tr className="border-t border-[var(--color-border)]">
        ...
        <div className="space-y-6">
          <div className="border-b border-[var(--color-border)] pb-6">
            ...
            <p className="text-[var(--color-text)]">
              ...
              to learn more, check out our <a href="/learn/perpetual-futures-guide" className="text-[var(--color-primary)] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded">perpetual futures guide</a>.
            </p>
          </div>
      ...
      <section className="border-t border-[var(--color-border)] pt-8">
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-4">Related Guides</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <a href="/learn/perpetual-futures-guide" className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-4 hover:border-[var(--color-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] transition-colors">
            <p className="text-[var(--color-primary)] font-medium text-sm">Perpetual Futures Guide</p>
            <p className="text-[var(--color-text-secondary)] text-xs mt-1">How perps work and the best DEXes to trade them</p>
          </a>
          <a href="/learn/advanced-defi-strategies" className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-4 hover:border-[var(--color-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] transition-colors">
            <p className="text-[var(--color-primary)] font-medium text-sm">Advanced DeFi Strategies</p>
            <p className="text-[var(--color-text-secondary)] text-xs mt-1">Yield optimization, delta-neutral, and more</p>
          </a>
          <a href="/tools/defi-yields" className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-4 hover:border-[var(--color-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] transition-colors">
            <p className="text-[var(--color-primary)] font-medium text-sm">DeFi Yields Tracker</p>
            <p className="text-[var(--color-text-secondary)] text-xs mt-1">Live APY comparison across 200+ DeFi protocols</p>
          </a>
          <a href="/learn/best-perpetual-dex-guide" className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-lg p-4 hover:border-[var(--color-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] transition-colors">
            <p className="text-[var(--color-primary)] font-medium text-sm">Best Perpetual DEX Guide</p>
            <p className="text-[var(--color-text-secondary)] text-xs mt-1">Hyperliquid, GMX, dYdX compared for 2026</p>
          </a>
        </div>
      </section>
