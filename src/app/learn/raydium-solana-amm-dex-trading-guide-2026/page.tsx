...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Raydium Solana AMM' },
  ],
};
...
const page = () => {
  ...
  return (
    <div style={{ backgroundColor: "#0d1117", color: "#e6edf3", minHeight: "100vh", padding: "40px 20px" }}>
      <ArticleSchema
        headline="Raydium Solana AMM: Automated Market Maker & Liquidity Guide"
        description="Master Raydium AMM on Solana. Learn liquidity provision, yield farming, impermanent loss, and market making strategies for DeFi traders and LPs."
        url="https://degen0x.com/learn/raydium-solana-amm-dex-trading-guide-2026"
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ marginBottom: "40px" }}>
          ...
          <LastUpdated pathKey="/learn/raydium-solana-amm-dex-trading-guide-2026" />
          <ReadingTime />
          <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Raydium Solana Amm Dex Trading Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/raydium-solana-amm-dex-trading-guide-2026"
            })
          }}
        />
...
<AuthoritySources url="/learn/raydium-solana-amm-dex-trading-guide-2026" />
</div>
  );
};
