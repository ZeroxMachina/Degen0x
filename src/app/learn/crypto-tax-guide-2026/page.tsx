...
export default function CryptoTaxGuide2026() {
  ...
  return (
    <div id="top" style={{ backgroundColor: "var(--color-bg)", color: "var(--color-text)", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <style dangerouslySetInnerHTML={{ __html: `
        #top a:focus-visible, #top button:focus-visible, #top [tabindex]:focus-visible {
    ...
    >
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "40px 20px" }}>
        {/* Breadcrumb */}
        <nav aria-label="Breadcrumb" style={{ fontSize: "13px", color: "var(--color-text-secondary)", marginBottom: "30px" }}>
          <Link href="/" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Home</Link>
          <span style={{ margin: "0 6px" }}>›</span>
          <Link href="/learn" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Learn</Link>
          <span style={{ margin: "0 6px" }}>›</span>
          <span style={{ color: "var(--color-text)" }}>Crypto Tax Guide 2026</span>
        </nav>
    ...
    >
        ...
        <div style={{ display: "flex", gap: "10px", marginBottom: "16px" }}>
          <span
            style={{
              backgroundColor: "var(--color-accent-dark, #92400e)",
    ...
    >
        ...
        {/* Meta info */}
        <div style={{ display: "flex", gap: "24px", fontSize: "14px", color: "var(--color-text-secondary)", marginBottom: "40px" }}>
    ...
    >
          ...
          <ul style={{ margin: "0", paddingLeft: "20px", color: "var(--color-text-secondary)" }}>
            <li style={{ marginBottom: "8px" }}>
              <a href="#how-irs-taxes-crypto" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
                How the IRS Taxes Crypto
              </a>
            </li>
            <li style={{ marginBottom: "8px" }}>
              <a href="#capital-gains" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
                Capital Gains: Short-Term vs Long-Term
              </a>
            </li>
            <li style={{ marginBottom: "8px" }}>
              <a href="#crypto-income" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
                Crypto Income: Staking, Mining & Airdrops
              </a>
            </li>
            <li style={{ marginBottom: "8px" }}>
              <a href="#defi-taxes" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
                DeFi Taxes: Swaps, LPs & Yield Farming
              </a>
            </li>
            <li style={{ marginBottom: "8px" }}>
              <a href="#nft-taxes" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
                NFT Taxes: The 28% Collectibles Trap
              </a>
            </li>
            <li style={{ marginBottom: "8px" }}>
              <a href="#form-1099-da" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
                Form 1099-DA: The New Reporting Era
              </a>
            </li>
            <li style={{ marginBottom: "8px" }}>
              <a href="#tax-loss-harvesting" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
                Tax-Loss Harvesting Strategies
              </a>
            </li>
            <li style={{ marginBottom: "8px" }}>
              <a href="#common-mistakes" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
                Common Mistakes That Trigger Audits
              </a>
            </li>
            <li style={{ marginBottom: "8px" }}>
              <a href="#tax-software" style={{ color: "var(--color-primary)", textDecoration: "none" }}>
        ...
        <section id="how-irs-taxes-crypto" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>How the IRS Taxes Crypto</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
    ...
    >
            <p style={{ fontSize: "14px", color: "var(--color-text-secondary)", marginBottom: "10px", fontWeight: "600" }}>Key Point</p>
            <p style={{ fontSize: "15px", color: "var(--color-text)", margin: "0" }}>
        ...
        <section id="capital-gains" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>Capital Gains: Short-Term vs Long-Term</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Short-Term Capital Gains (&lt;1 Year)</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Long-Term Capital Gains (&gt;1 Year)</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
    ...
    >
              ...
              <tbody>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>10%</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$0–$11,000</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>0%</td>
                </tr>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>12%</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$11,001–$44,725</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>0%</td>
                </tr>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>22%</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$44,726–$95,375</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>15%</td>
                </tr>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>24%</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$95,376–$182,100</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>15%</td>
                </tr>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>32%</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$182,101–$231,250</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>20%</td>
                </tr>
                <tr>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>37%</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$231,251+</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>20%</td>
                </tr>
              </tbody>
            </table>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Cost Basis Methods</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
    ...
    >
            <p style={{ fontSize: "14px", color: "var(--color-text-secondary)", marginBottom: "10px", fontWeight: "600" }}>Example: Capital Gains Calculation</p>
            <p style={{ fontSize: "15px", color: "var(--color-text)", margin: "0" }}>
        ...
        <section id="crypto-income" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>Crypto Income: Staking, Mining &amp; Airdrops</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Staking Rewards</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Mining Income</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Airdrops</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Hard Forks</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
    ...
    >
              ...
              <tbody>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Staking Rewards</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Ordinary Income</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Receipt (annual)</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Schedule 1</td>
                </tr>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Mining Income</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Self-Employment</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Receipt</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Schedule C</td>
                </tr>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Airdrops</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Ordinary Income</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Dominion &amp; Control</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Schedule 1</td>
                </tr>
                <tr>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Hard Forks</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Ordinary Income (if accessible)</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Accessibility</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Schedule 1</td>
                </tr>
              </tbody>
            </table>
        ...
        <section id="defi-taxes" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>DeFi Taxes: Swaps, LPs &amp; Yield Farming</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Token-to-Token Swaps</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Liquidity Provider (LP) Positions</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Yield Farming Rewards</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Wrapping and Unwrapping</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Bridge Transfers</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
    ...
    >
            <p style={{ fontSize: "14px", color: "var(--color-accent)", marginBottom: "10px", fontWeight: "600" }}>⚠️ DeFi Creates Complex Tax Trails</p>
            <p style={{ fontSize: "15px", color: "var(--color-text)", margin: "0" }}>
        ...
        <section id="nft-taxes" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>NFT Taxes: The 28% Collectibles Trap</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Collectibles Classification</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Creating and Selling NFTs</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Royalties</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Buying and Selling NFTs as an Investor</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
    ...
    >
            <p style={{ fontSize: "14px", color: "var(--color-text-secondary)", marginBottom: "10px", fontWeight: "600" }}>NFT Collectibles Tax Impact</p>
            <p style={{ fontSize: "15px", color: "var(--color-text)", margin: "0" }}>
        ...
        <section id="form-1099-da" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>Form 1099-DA: The New Reporting Era</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Timeline and Rollout</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
    ...
    >
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Who Must Issue 1099-DA</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>How to Report 1099-DA</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Correcting 1099-DA Errors</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
        ...
        <section id="tax-loss-harvesting" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>Tax-Loss Harvesting Strategies</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Basic Mechanics</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Strategic Timing</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Wash Sale Rule</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "15px" }}>
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>Advanced Strategy: Swapping to Similar Assets</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
    ...
    >
            <p style={{ fontSize: "14px", color: "var(--color-accent)", marginBottom: "10px", fontWeight: "600" }}>⚠️ Wash Sale Rule Legislation Pending</p>
            <p style={{ fontSize: "15px", color: "var(--color-text)", margin: "0" }}>
        ...
        <section id="common-mistakes" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>Common Mistakes That Trigger Audits</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
    ...
    >
        ...
        <section id="tax-software" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>Best Crypto Tax Software</h2>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
    ...
    >
              ...
              <tbody>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Koinly</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Limited (≤50 txns)</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Excellent</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$79–$149/yr</td>
                </tr>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>CoinTracker</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Yes, full features</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Good</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$100–$200/yr</td>
                </tr>
                <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>TokenTax</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>No</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Excellent</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$99–$299/yr</td>
                </tr>
                <tr>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>ZenLedger</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Limited (≤20 txns)</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>Very Good</td>
                  <td style={{ padding: "12px", color: "var(--color-text)" }}>$60–$240/yr</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>What to Look for in Crypto Tax Software</h3>
          <ul
            style={{
              fontSize: "16px",
              lineHeight: "1.8",
    ...
    >
          ...
          <h3 style={{ fontSize: "20px", marginBottom: "15px", color: "var(--color-text)", marginTop: "25px" }}>When to Hire a CPA</h3>
          <p style={{ fontSize: "16px", lineHeight: "1.8", color: "var(--color-text)", marginBottom: "20px" }}>
        ...
        <section id="faq" style={{ marginBottom: "50px", scrollMarginTop: "24px"}}>
          <h2 style={{ fontSize: "28px", marginBottom: "30px", color: "var(--color-text)" }}>Frequently Asked Questions</h2>
    ...
    >
            <h3 style={{ marginTop: "0", marginBottom: "10px", fontSize: "16px", color: "var(--color-text)" }}>
    ...
    >
        ...
        <section style={{ marginBottom: "50px", scrollMarginTop: "24px" }}>
          <h2 style={{ fontSize: "28px", marginBottom: "20px", color: "var(--color-text)" }}>Related Learning Guides</h2>
          <div
            style={{
              display: "grid",
