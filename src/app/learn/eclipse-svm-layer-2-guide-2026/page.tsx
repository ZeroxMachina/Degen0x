...
export const metadata: Metadata = {
  title: "Eclipse (ES) Guide 2026: The First SVM Layer 2 on Ethereum",
  description:
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Eclipse Svm Layer 2 Guide 2026', },
  ],
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Eclipse Svm Layer 2 Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/eclipse-svm-layer-2-guide-2026"
            })
          }}
        />
      </article>
...
<AuthoritySources url="/learn/eclipse-svm-layer-2-guide-2026" />
</div>
  );
}
