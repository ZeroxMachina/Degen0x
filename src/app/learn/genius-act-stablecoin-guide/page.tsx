...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Genius Act Stablecoin Guide', },
  ],
};
...
export default function GeniusActStablecoinGuide() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <LastUpdated pathKey="/learn/genius-act-stablecoin-guide" />
      <ReadingTime />
      <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Genius Act Stablecoin Guide",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/genius-act-stablecoin-guide"
            })
          }}
        />
            <div style={{
...
<AuthoritySources url="/learn/genius-act-stablecoin-guide" />
</div>
  );
}
