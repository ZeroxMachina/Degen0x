...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Aerodrome Finance Guide', },
  ],
};
  ...
  return (
    <div style={{ backgroundColor: "var(--color-bg)", color: "var(--color-text)", minHeight: '100vh', padding: 'clamp(1rem, 3vw, 2rem)' }} className="max-w-4xl mx-auto">
      ...
      <div className="flex gap-3 mb-4 mt-8">
        <span style={{ backgroundColor: 'rgba(31, 111, 235, 0.2)', color: 'var(--color-primary)', borderColor: 'rgba(31, 111, 235, 0.3)' }} className="px-3 py-1 rounded-full text-xs font-semibold border">
          DeFi
        </span>
        <span style={{ backgroundColor: 'rgba(26, 127, 55, 0.2)', color: 'var(--color-success)', borderColor: 'rgba(26, 127, 55, 0.3)' }} className="px-3 py-1 rounded-full text-xs font-semibold border">
          Intermediate
        </span>
      </div>

      {/* Title */}
      <h1 style={{ background: 'linear-gradient(to right, var(--color-primary), var(--color-success))', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} className="text-5xl font-bold mb-4">
        Aerodrome Finance: Base Chain&apos;s Dominant DEX Explained
      </h1>
      <p style={{ color: 'var(--color-text-tertiary)' }} className="text-xl mb-8">
      ...
      {/* Meta Info */}
      <div style={{ color: 'var(--color-text-tertiary)', borderColor: 'var(--color-border)' }} className="flex flex-wrap gap-6 mb-10 text-sm pb-8 border-b">
        <span>14 min read</span>
        <span>Updated March 2026</span>
      </div>

      {/* Disclaimer */}
      <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'rgba(240, 136, 62, 0.3)' }} className="border rounded-lg p-5 mb-10">
        <p style={{ color: 'var(--color-warning)' }} className="text-sm font-medium mb-1">⚠️ Educational Content Only</p>
      ...
      {/* Table of Contents */}
      <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-6 mb-12">
        <h3 style={{ color: 'var(--color-text)' }} className="font-semibold mb-4">📋 Table of Contents</h3>
        <ol style={{ color: 'var(--color-primary)' }} className="space-y-2 text-sm">
          <li>
      ...
      <section id="what-is-aerodrome" className="mb-14">
        <h2 style={{ color: 'var(--color-text)' }} className="text-3xl font-bold mb-5">1. What Is Aerodrome Finance?</h2>
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          Aerodrome Finance is the principal decentralized exchange on{" "}
          <strong style={{ color: 'var(--color-text)' }}>Base</strong>, Coinbase&apos;s Ethereum Layer 2
        ...
        <div style={{ background: 'var(--color-bg-card)', border: '1px solid var(--color-border)', borderRadius: 10, padding: '20px 24px', marginTop: 32, marginBottom: 32 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
            ...
            <strong style={{ color: 'var(--color-accent)', fontSize: 15 }}>Why This Matters</strong>
          </div>
        ...
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          ...
          commands approximately <strong style={{ color: 'var(--color-text)' }}>68% of Base&apos;s DEX
          trading volume</strong> — processing around $810M in daily trades — while holding roughly{" "}
          <strong style={{ color: 'var(--color-text)' }}>$500M in total value locked</strong> (TVL peaked
        ...
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          ...
          <strong style={{ color: 'var(--color-text)' }}>ve(3,3) tokenomics model</strong>: a sophisticated
        ...
        <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-6 my-6">
          <h4 style={{ color: 'var(--color-success)' }} className="font-semibold mb-3">
            📊 Aerodrome at a Glance (March 2026)
          </h4>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            <div>
              <p style={{ color: 'var(--color-text-tertiary)' }}>TVL</p>
              <p style={{ color: 'var(--color-text)' }} className="font-bold text-lg">~$500M</p>
            </div>
            <div>
              <p style={{ color: 'var(--color-text-tertiary)' }}>Daily Volume</p>
              <p style={{ color: 'var(--color-text)' }} className="font-bold text-lg">~$810M</p>
            </div>
            <div>
              <p style={{ color: 'var(--color-text-tertiary)' }}>Base DEX Share</p>
              <p style={{ color: 'var(--color-text)' }} className="font-bold text-lg">~68%</p>
            </div>
            <div>
              <p style={{ color: 'var(--color-text-tertiary)' }}>Annualized Revenue</p>
              <p style={{ color: 'var(--color-text)' }} className="font-bold text-lg">~$202M</p>
            </div>
            <div>
              <p style={{ color: 'var(--color-text-tertiary)' }}>Chain</p>
              <p style={{ color: 'var(--color-text)' }} className="font-bold text-lg">Base (L2)</p>
            </div>
            <div>
              <p style={{ color: 'var(--color-text-tertiary)' }}>Launched</p>
              <p style={{ color: 'var(--color-text)' }} className="font-bold text-lg">Aug 2023</p>
            </div>
          </div>
        ...
        />
          ...
          <p style={{ color: 'var(--color-text-tertiary)' }} className="text-xs mt-4">
      ...
      <section id="ve33-model" className="mb-14">
        <h2 style={{ color: 'var(--color-text)' }} className="text-3xl font-bold mb-5">
          2. The ve(3,3) Model: How Aerodrome&apos;s Flywheel Works
        </h2>
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          Aerodrome&apos;s architecture is built on the{" "}
          <strong style={{ color: 'var(--color-text)' }}>ve(3,3) model</strong> — a design that combines two
          ideas from earlier DeFi protocols. The &ldquo;ve&rdquo; part comes from{" "}
          <strong style={{ color: 'var(--color-text)' }}>Curve Finance</strong>, which pioneered vote-escrowed
        ...
        <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-6 my-6">
          <h4 style={{ color: 'var(--color-primary)' }} className="font-semibold mb-4">⚙️ The Aerodrome Flywheel</h4>
          <div className="space-y-4 text-sm">
            <div className="flex gap-4">
              <span style={{ backgroundColor: 'rgba(31, 111, 235, 0.2)', color: 'var(--color-primary)', borderColor: 'rgba(31, 111, 235, 0.3)' }} className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center font-bold text-xs border">1</span>
              <div>
                <p style={{ color: 'var(--color-text)' }} className="font-medium">Emissions flow to voted pools</p>
                <p style={{ color: 'var(--color-text-tertiary)' }} className="mt-1">Each week, new AERO tokens are emitted to liquidity pools in proportion to the votes they receive from veAERO holders.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <span style={{ backgroundColor: 'rgba(31, 111, 235, 0.2)', color: 'var(--color-primary)', borderColor: 'rgba(31, 111, 235, 0.3)' }} className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center font-bold text-xs border">2</span>
              <div>
                <p style={{ color: 'var(--color-text)' }} className="font-medium">LPs stake in voted pools</p>
                <p style={{ color: 'var(--color-text-tertiary)' }} className="mt-1">Liquidity providers deposit assets and stake their LP tokens in the protocol gauges to earn those AERO emissions.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <span style={{ backgroundColor: 'rgba(31, 111, 235, 0.2)', color: 'var(--color-primary)', borderColor: 'rgba(31, 111, 235, 0.3)' }} className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center font-bold text-xs border">3</span>
              <div>
                <p style={{ color: 'var(--color-text)' }} className="font-medium">Deep liquidity attracts traders</p>
                <p style={{ color: 'var(--color-text-tertiary)' }} className="mt-1">More liquidity means tighter spreads and lower slippage, attracting trading volume to those pools.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <span style={{ backgroundColor: 'rgba(31, 111, 235, 0.2)', color: 'var(--color-primary)', borderColor: 'rgba(31, 111, 235, 0.3)' }} className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center font-bold text-xs border">4</span>
              <div>
                <p style={{ color: 'var(--color-text)' }} className="font-medium">Fees flow to veAERO voters</p>
                <p style={{ color: 'var(--color-text-tertiary)' }} className="mt-1">100% of trading fees from each pool go to the veAERO holders who voted for that pool — not to LPs. This is a key distinction from traditional AMMs.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <span style={{ backgroundColor: 'rgba(31, 111, 235, 0.2)', color: 'var(--color-primary)', borderColor: 'rgba(31, 111, 235, 0.3)' }} className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center font-bold text-xs border">5</span>
              <div>
                <p style={{ color: 'var(--color-text)' }} className="font-medium">Protocols bribe to attract votes</p>
                <p style={{ color: 'var(--color-text-tertiary)' }} className="mt-1">Protocols wanting liquidity for their tokens pay bribes to veAERO voters to direct emissions to their pools. This creates a transparent, market-based liquidity marketplace.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pool-types" className="mb-14">
        ...
        <h3 style={{ color: 'var(--color-text)' }} className="text-xl font-semibold mt-8 mb-3">
        ...
        <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-6 my-6 overflow-x-auto">
          <h4 style={{ color: 'var(--color-primary)' }} className="font-semibold mb-4">📊 Pool Type Comparison</h4>
          <table className="w-full text-sm text-left">
            <thead>
              <tr style={{ borderColor: 'var(--color-border)' }} className="border-b">
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 pr-4 font-medium">Pool Type</th>
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 pr-4 font-medium">Best For</th>
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 pr-4 font-medium">Fee Range</th>
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 font-medium">IL Risk</th>
              </tr>
            </thead>
            <tbody style={{ borderColor: 'var(--color-border)' }} className="divide-y">
              <tr>
                <td style={{ color: 'var(--color-text)' }} className="py-3 pr-4 font-medium">Stable</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">USDC/USDT, ETH/wstETH</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">0.01–0.05%</td>
                <td style={{ color: 'var(--color-success)' }} className="py-3">Low</td>
              </tr>
              <tr>
                <td style={{ color: 'var(--color-text)' }} className="py-3 pr-4 font-medium">Volatile</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">ETH/USDC, AERO/WETH</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">0.3%</td>
                <td style={{ color: 'var(--color-warning)' }} className="py-3">Medium</td>
              </tr>
              <tr>
                <td style={{ color: 'var(--color-text)' }} className="py-3 pr-4 font-medium">Slipstream (clAMM)</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">Any pair, active LPs</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">0.01–1.0%</td>
                <td style={{ color: 'var(--color-error)' }} className="py-3">High (if unmanaged)</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section id="veareo-voting" className="mb-14">
        ...
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          ...
          your <code style={{ backgroundColor: 'var(--color-bg-card)', color: 'var(--color-primary)' }} className="px-1.5 py-0.5 rounded text-sm">AERO</code>{" "}
          tokens, you receive a{" "}
          <code style={{ backgroundColor: 'var(--color-bg-card)', color: 'var(--color-primary)' }} className="px-1.5 py-0.5 rounded text-sm">veAERO</code>{" "}
        ...
        <h3 style={{ color: 'var(--color-text)' }} className="text-xl font-semibold mt-8 mb-3">Lock Duration</h3>
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          You can lock AERO for any duration from 1 week to 4 years. The longer you lock, the more
          voting power you receive:
        </p>
        <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5 my-5 text-sm">
          <div className="grid grid-cols-2 gap-3">
            <div style={{ borderColor: 'var(--color-border)' }} className="flex justify-between border-b pb-2">
              <span style={{ color: 'var(--color-text-tertiary)' }}>100 AERO × 4 years</span>
              <span style={{ color: 'var(--color-success)' }} className="font-semibold">= 100 veAERO</span>
            </div>
            <div style={{ borderColor: 'var(--color-border)' }} className="flex justify-between border-b pb-2">
              <span style={{ color: 'var(--color-text-tertiary)' }}>100 AERO × 2 years</span>
              <span style={{ color: 'var(--color-success)' }} className="font-semibold">= 50 veAERO</span>
            </div>
            <div style={{ borderColor: 'var(--color-border)' }} className="flex justify-between border-b pb-2">
              <span style={{ color: 'var(--color-text-tertiary)' }}>100 AERO × 1 year</span>
              <span style={{ color: 'var(--color-primary)' }} className="font-semibold">= 25 veAERO</span>
            </div>
            <div className="flex justify-between">
              <span style={{ color: 'var(--color-text-tertiary)' }}>100 AERO × 6 months</span>
              <span style={{ color: 'var(--color-primary)' }} className="font-semibold">= 12.5 veAERO</span>
            </div>
          </div>
          <p style={{ color: 'var(--color-text-tertiary)' }} className="text-xs mt-3">
        ...
        <h3 style={{ color: 'var(--color-text)' }} className="text-xl font-semibold mt-8 mb-3">Weekly Voting Epochs</h3>
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
        ...
        <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5 my-6">
          <p style={{ color: 'var(--color-warning)' }} className="text-sm font-medium mb-2">💡 Pro Tip: Bribes</p>
          <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm leading-relaxed">
            ...
            <strong style={{ color: 'var(--color-text)' }}>bribes</strong> — additional token rewards paid
      ...
      <section id="tokenomics" className="mb-14">
        ...
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          The <code style={{ backgroundColor: 'var(--color-bg-card)', color: 'var(--color-primary)' }} className="px-1.5 py-0.5 rounded text-sm">AERO</code>{" "}
        ...
        <h3 style={{ color: 'var(--color-text)' }} className="text-xl font-semibold mt-8 mb-3">Emissions Schedule</h3>
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          ...
          <strong style={{ color: 'var(--color-text)' }}>Epoch 67</strong>: when weekly emissions fall below
          9 million AERO per epoch, governance control over monetary policy transfers fully to
          veAERO holders via the{" "}
          <strong style={{ color: 'var(--color-text)' }}>Aero Fed</strong>.
        </p>
        ...
        <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5 my-5">
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-3">
              <span style={{ color: 'var(--color-success)' }} className="font-bold mt-0.5">↑</span>
              <div>
                <p style={{ color: 'var(--color-text)' }} className="font-medium">Increase emissions by 0.01%</p>
                <p style={{ color: 'var(--color-text-tertiary)' }}>Mint more AERO to attract more liquidity</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span style={{ color: 'var(--color-error)' }} className="font-bold mt-0.5">↓</span>
              <div>
                <p style={{ color: 'var(--color-text)' }} className="font-medium">Decrease emissions by 0.01%</p>
                <p style={{ color: 'var(--color-text-tertiary)' }}>Slow new supply to support token price</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span style={{ color: 'var(--color-text-tertiary)' }} className="font-bold mt-0.5">→</span>
              <div>
                <p style={{ color: 'var(--color-text)' }} className="font-medium">Maintain current emissions</p>
                <p style={{ color: 'var(--color-text-tertiary)' }}>No change this epoch</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="key-metrics" className="mb-14">
        <h2 style={{ color: 'var(--color-text)' }} className="text-3xl font-bold mb-5">6. Key Metrics (March 2026)</h2>
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-6 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5">
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm mb-1">TVL</p>
            <p style={{ color: 'var(--color-text)' }} className="text-2xl font-bold">~$500M</p>
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-xs mt-1">Peak: $1.07B (Dec 2025)</p>
          </div>
          <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5">
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm mb-1">30-Day Trading Volume</p>
            <p style={{ color: 'var(--color-text)' }} className="text-2xl font-bold">~$4.2B</p>
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-xs mt-1">Annualized: ~$50B+</p>
          </div>
          <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5">
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm mb-1">Annualized Fee Revenue</p>
            <p style={{ color: 'var(--color-text)' }} className="text-2xl font-bold">~$202M</p>
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-xs mt-1">~$550K per day</p>
          </div>
          <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5">
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm mb-1">Base DEX Market Share</p>
            <p style={{ color: 'var(--color-text)' }} className="text-2xl font-bold">~68%</p>
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-xs mt-1">Up from ~40% (early 2024)</p>
          </div>
        </div>
      ...
      <section id="competitive-landscape" className="mb-14">
        ...
        <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-6 my-6 overflow-x-auto">
          <h4 style={{ color: 'var(--color-primary)' }} className="font-semibold mb-4">⚔️ DEX Competitive Comparison</h4>
          <table className="w-full text-sm text-left">
            <thead>
              <tr style={{ borderColor: 'var(--color-border)' }} className="border-b">
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 pr-4 font-medium">Protocol</th>
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 pr-4 font-medium">Chain</th>
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 pr-4 font-medium">TVL</th>
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 pr-4 font-medium">Model</th>
                <th style={{ color: 'var(--color-text-tertiary)' }} className="py-2 font-medium">Fee to LPs</th>
              </tr>
            </thead>
            <tbody style={{ borderColor: 'var(--color-border)' }} className="divide-y">
              <tr>
                <td style={{ color: 'var(--color-success)' }} className="py-3 pr-4 font-semibold">Aerodrome</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">Base</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">~$500M</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">ve(3,3) + clAMM</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3">100% to voters</td>
              </tr>
              <tr>
                <td style={{ color: 'var(--color-text)' }} className="py-3 pr-4 font-medium">Uniswap v3</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">Multi-chain</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">&gt;$5B</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">clAMM</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3">100% to LPs</td>
              </tr>
              <tr>
                <td style={{ color: 'var(--color-text)' }} className="py-3 pr-4 font-medium">Velodrome</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">Optimism</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">~$200M</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">ve(3,3) + clAMM</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3">100% to voters</td>
              </tr>
              <tr>
                <td style={{ color: 'var(--color-text)' }} className="py-3 pr-4 font-medium">Curve Finance</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">Multi-chain</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">&gt;$2B</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3 pr-4">StableSwap + ve</td>
                <td style={{ color: 'var(--color-text-secondary)' }} className="py-3">Split (LPs + veCRV)</td>
              </tr>
            </tbody>
          </table>
          <p style={{ color: 'var(--color-text-tertiary)' }} className="text-xs mt-3">
      ...
      <section id="risks" className="mb-14">
        ...
        <div className="space-y-4">
          <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'rgba(248, 81, 73, 0.3)' }} className="border rounded-lg p-5">
            <p style={{ color: 'var(--color-error)' }} className="font-semibold mb-2">🔐 Smart Contract Risk</p>
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm leading-relaxed">
          ...
          <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'rgba(240, 136, 62, 0.3)' }} className="border rounded-lg p-5">
            <p style={{ color: 'var(--color-warning)' }} className="font-semibold mb-2">📉 Impermanent Loss</p>
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm leading-relaxed">
          ...
          <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'rgba(240, 136, 62, 0.3)' }} className="border rounded-lg p-5">
            <p style={{ color: 'var(--color-warning)' }} className="font-semibold mb-2">🔒 Lock-Up Risk (veAERO)</p>
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm leading-relaxed">
          ...
          <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5">
            <p style={{ color: 'var(--color-text)' }} className="font-semibold mb-2">📊 Emission Dilution</p>
            <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm leading-relaxed">
      ...
      <section id="getting-started" className="mb-14">
        ...
        <h3 style={{ color: 'var(--color-text)' }} className="text-xl font-semibold mb-3">Option A: Trade on Aerodrome</h3>
        <p style={{ color: 'var(--color-text-secondary)' }} className="mb-4 leading-relaxed">
          The simplest entry point. Connect your wallet to{" "}
          <strong style={{ color: 'var(--color-text)' }}>aerodrome.finance</strong>, ensure you&apos;re on the
        ...
        <div style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-5 my-6">
          <p style={{ color: 'var(--color-primary)' }} className="text-sm font-medium mb-2">🔗 Useful Tools</p>
          <ul className="space-y-2 text-sm" style={{ color: 'var(--color-text-tertiary)' }}>
            <li>
              <strong style={{ color: 'var(--color-text)' }}>Aerodrome.finance</strong> — Official DEX UI for
              trading, providing liquidity, and locking veAERO
            </li>
            <li>
              <strong style={{ color: 'var(--color-text)' }}>DefiLlama</strong> — Track Aerodrome TVL, fees,
              and revenue in real-time
            </li>
            <li>
              <strong style={{ color: 'var(--color-text)' }}>Our{" "}
              <a href="/tools/impermanent-loss" style={{ color: 'var(--color-primary)' }} className="hover:underline">
            ...
            <li>
              <strong style={{ color: 'var(--color-text)' }}>Our{" "}
              <a href="/tools/yield-farming-calculator" style={{ color: 'var(--color-primary)' }} className="hover:underline">
      ...
      <section className="mb-14">
        <h2 style={{ color: 'var(--color-text)' }} className="text-2xl font-bold mb-6">Related Guides</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <a
              ...
              className="border rounded-lg p-5 transition-colors hover:border-opacity-100"
              onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = 'var(--color-bg-card-hover)'; }}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'var(--color-bg-card)'}
            >
              <p style={{ color: 'var(--color-primary)' }} className="font-semibold mb-1">{article.title}</p>
              <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm">{article.desc}</p>
            </a>
          ))}
        </div>
      </section>
      ...
      <section id="faq" className="mb-14">
        <h2 style={{ color: 'var(--color-text)' }} className="text-3xl font-bold mb-8">
          10. Frequently Asked Questions
        </h2>
        <div className="space-y-6">
          {[
            ...
            <div key={i} style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }} className="border rounded-lg p-6">
              <h3 style={{ color: 'var(--color-text)' }} className="font-semibold mb-3">{item.q}</h3>
              <p style={{ color: 'var(--color-text-tertiary)' }} className="text-sm leading-relaxed">{item.a}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <BackToTop />
        ...
        <h3 style={{ marginBottom: "16px", color: "var(--color-text)" }}>Explore More</h3>
