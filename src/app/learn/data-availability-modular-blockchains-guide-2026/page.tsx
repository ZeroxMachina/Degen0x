...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Data Availability Modular Blockchains Guide 2026', },
  ],
};
    ...
    <article style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <LastUpdated pathKey="/learn/data-availability-modular-blockchains-guide-2026" />
          <ReadingTime />
          <AutoTOC />
