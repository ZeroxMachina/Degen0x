  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section id="what-is-payfi" className="mb-8">
        <h2 className="text-2xl font-bold text-[var(--color-text)] mb-4">What is PayFi?</h2>
      ...
      <section id="how-it-works" className="mb-8">
        <h2 className="text-2xl font-bold text-[var(--color-text)] mb-4">How PayFi Works</h2>

        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Payment Routing & Staking</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Settlement Optimization</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Composability with DeFi</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="key-protocols" className="mb-8">
        <h2 className="text-2xl font-bold text-[var(--color-text)] mb-4">Key PayFi Protocols</h2>

        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Ondo Finance (ONDO)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Lido Finance (LDO)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Aave (AAVE)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Curve (CRV)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Emerging Protocols</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="differs-from-tradfi" className="mb-8">
        <h2 className="text-2xl font-bold text-[var(--color-text)] mb-4">PayFi vs Traditional Payments</h2>

        <div className="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden mb-6">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="text-left p-4 text-[var(--color-text)] font-semibold">Aspect</th>
                <th className="text-left p-4 text-[var(--color-text)] font-semibold">Traditional</th>
                <th className="text-left p-4 text-[var(--color-text)] font-semibold">PayFi</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-700">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Key Advantages</h3>
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Key Risks</h3>
      ...
      <section id="use-cases" className="mb-8">
        <h2 className="text-2xl font-bold text-[var(--color-text)] mb-4">Real-World Use Cases</h2>

        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Corporate Treasury</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Cross-Border Payments</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Payment Processors</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Merchant Settlement</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Lending Infrastructure</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="future-outlook" className="mb-8">
        <h2 className="text-2xl font-bold text-[var(--color-text)] mb-4">Future Outlook</h2>

        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Near-Term (2026-2027)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Medium-Term (2027-2029)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Long-Term (2029+)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-[var(--color-text)] mb-3">Investment Thesis</h3>
        <p className="text-gray-300 mb-4">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mt-12">
        <h3 className="text-[var(--color-text)] font-bold mb-3">PayFi Tools & Protocols</h3>
        <ul className="space-y-2 text-blue-400">
