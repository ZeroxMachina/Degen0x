...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to Morpho Protocol - the 2nd largest DeFi lending platform with $6.9B+ TVL. Learn about Morpho Blue, MetaMorpho vaults, institutional adoption, and the V2 roadmap.',
  keywords: [
    'Morpho Protocol',
    'DeFi lending',
    'Morpho Blue',
