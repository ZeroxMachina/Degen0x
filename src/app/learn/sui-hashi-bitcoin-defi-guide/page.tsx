...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Sui Hashi Bitcoin Defi Guide', },
  ],
};
...
export default function HashiBitcoinDefiGuide() {
  return (
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Sui Hashi Bitcoin Defi Guide",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/sui-hashi-bitcoin-defi-guide"
            })
          }}
        />
            <div style={{
    ...
    <AuthoritySources url="/learn/sui-hashi-bitcoin-defi-guide" />
    </div>
