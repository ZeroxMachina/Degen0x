...
export default function PasskeyEmbeddedWalletsPage() {
  ...
  return (
    <main style={{ backgroundColor: S.bg, color: S.text, minHeight: "100vh" }}>
      <ArticleSchema
        headline="Seed Phrase Wallets"
        description="Seed Phrase Wallets"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Article",
              "headline": "Passkey Embedded Wallets Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/passkey-embedded-wallets-guide-2026"
            })
          }}
        />
      </article>
