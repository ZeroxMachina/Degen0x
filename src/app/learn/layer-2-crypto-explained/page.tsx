...
{/* section-footer */}
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Layer 2 Crypto Explained: Rollups, zkSync, Arbitrum 2026", "description": "Layer 2 scaling explained: optimistic rollups (Arbitrum, Optimism, Base), ZK rollups (zkSync, StarkNet, Scroll), fraud proofs, validity proofs, TPS, TVL,", "url": "https://degen0x.com/learn/layer-2-crypto-explained", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
