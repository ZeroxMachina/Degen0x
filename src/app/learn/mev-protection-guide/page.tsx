  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section id="what-is-mev" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">What is MEV?</h2>
      ...
      <section id="types-of-mev" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Types of MEV Attacks</h2>

        <h3 className="text-xl font-semibold text-white mb-3">Sandwich Attacks</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Front-Running</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Flashbots and Arbitrage</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Liquidation Extraction</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="sandwich-attacks" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">How Sandwich Attacks Work</h2>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-4">
          <p className="text-gray-300 mb-2"><strong className="text-white">Step 1: Observation</strong> - Bot monitors mempool and identifies your pending swap transaction</p>
          <p className="text-gray-300 mb-2"><strong className="text-white">Step 2: Front-Run</strong> - Bot submits transaction with higher gas fee to execute before yours, moving the price</p>
          <p className="text-gray-300"><strong className="text-white">Step 3: Back-Run</strong> - Bot submits another transaction after yours to exit their position profitably</p>
        </div>
      ...
      <section id="protection-strategies" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Protection Strategies</h2>

        <h3 className="text-xl font-semibold text-white mb-3">1. Use Private RPCs and Dark Pools</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">2. Set Aggressive Slippage Limits</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">3. Use MEV-Resistant Protocols</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">4. Implement Intent-Based Trading</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">5. Route Through Multiple Aggregators</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="recommended-tools" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Recommended Tools</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="border border-gray-700 rounded-lg p-4">
            <h3 className="text-white font-semibold mb-2">MEV-Blocker</h3>
          ...
          <div className="border border-gray-700 rounded-lg p-4">
            <h3 className="text-white font-semibold mb-2">CoW Swap</h3>
          ...
          <div className="border border-gray-700 rounded-lg p-4">
            <h3 className="text-white font-semibold mb-2">MEV-Inspect</h3>
          ...
          <div className="border border-gray-700 rounded-lg p-4">
            <h3 className="text-white font-semibold mb-2">MEV-Scanner</h3>
