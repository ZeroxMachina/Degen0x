...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Liquid Staking Derivatives' },
  ],
};
...
const page = () => {
  ...
  return (
    <div style={{ backgroundColor: "#0d1117", color: "#e6edf3", minHeight: "100vh", padding: "40px 20px" }}>
      <ArticleSchema
        headline="Liquid Staking Derivatives: LSDs Explained 2026"
        description="Master liquid staking tokens. Learn how LSDs enable staking without lockups, understand economics, yield strategies, and compare Lido, Marinade, and other"
        url="https://degen0x.com/learn/liquid-staking-derivatives-explained"
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ marginBottom: "40px" }}>
          ...
          <LastUpdated pathKey="/learn/liquid-staking-derivatives-explained" />
          <ReadingTime />
          <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Liquid Staking Derivatives Explained",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/liquid-staking-derivatives-explained"
            })
          }}
        />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Liquid Staking Derivatives: LSDs Explained 2026", "description": "Master liquid staking tokens. Learn how LSDs enable staking without lockups, understand economics, yield strategies, and compare Lido, Marinade, and other", "url": "https://degen0x.com/learn/liquid-staking-derivatives-explained", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
<AuthoritySources url="/learn/liquid-staking-derivatives-explained" />
</div>
  );
};
