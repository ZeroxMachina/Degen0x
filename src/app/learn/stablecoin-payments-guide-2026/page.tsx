...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      url: 'https://degen0x.com/api/og?title=Stablecoin+Payments+Guide+2026&category=Learn&type=learn',
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    images: ['https://degen0x.com/api/og?title=Stablecoin+Payments+Guide+2026&category=Learn&type=learn'],
  },
  alternates: {
...
const articleSchema = generateArticleSchema({
  ...
  author: 'degen0x Team',
  image: 'https://degen0x.com/api/og?title=Stablecoin+Payments+Guide+2026&category=Learn&type=learn',
  wordCount: 3200,
})
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Stablecoin Payments Guide 2026', },
  ],
};
...
export default function StablecoinPaymentsGuidePage() {
  return (
    ...
    <article className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <LastUpdated pathKey="/learn/stablecoin-payments-guide-2026" />
      <ReadingTime />
      <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Stablecoin Payments Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/stablecoin-payments-guide-2026"
            })
          }}
        />
