...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Crypto Lending Borrowing Defi Guide 2026', },
  ],
};
  ...
  return (
    <main id="top" style={pageStyle}>
      ...
      <div style={containerStyle}>
        ...
        <LastUpdated pathKey="/learn/crypto-lending-borrowing-defi-guide-2026" />
        <ReadingTime />
        <AutoTOC />
        <div style={metaStyle}>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Crypto Lending Borrowing Defi Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/crypto-lending-borrowing-defi-guide-2026"
            })
          }}
        />
      </div>
