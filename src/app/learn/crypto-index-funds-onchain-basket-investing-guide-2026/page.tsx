...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Crypto Index Funds Onchain Basket Investing Guide 2026', },
  ],
};
    ...
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <LastUpdated pathKey="/learn/crypto-index-funds-onchain-basket-investing-guide-2026" />
          <ReadingTime />
          <AutoTOC />
...
{/* section-footer */}
      ...
      <RelatedContent category="learn" currentSlug="/learn/crypto-index-funds-onchain-basket-investing-guide-2026" />
      <AuthoritySources url="/learn/crypto-index-funds-onchain-basket-investing-guide-2026" />
      </article>
  );
}
