...
export const metadata: Metadata = {
  title: "Perp DEX Wars 2026: Hyperliquid vs Aster vs Lighter vs",
  description: "Complete comparison of top perpetual DEXs in 2026. Hyperliquid ($40.7B weekly volume), Aster ($31.78B), Lighter ($25.38B), Paradex ZK perps, and emerging",
  keywords: [
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Perp Dex Wars Comparison 2026', },
  ],
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Perp Dex Wars Comparison 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/perp-dex-wars-comparison-2026"
            })
          }}
        />
      </article>
...
<AuthoritySources url="/learn/perp-dex-wars-comparison-2026" />
</div>
  );
}
