...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Tokenomics Protocol Revenue Guide', },
  ],
};
...
export default function TokenomicsProtocolRevenueGuide() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <LastUpdated pathKey="/learn/tokenomics-protocol-revenue-guide" />
      <ReadingTime />
      <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Tokenomics Protocol Revenue Guide",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/tokenomics-protocol-revenue-guide"
            })
          }}
        />
            <div style={{
