...
export const metadata: Metadata = {
  title: 'Solana ETF Spot Funds Staking Guide 2026 — Complete Fee Comparison & Yields | degen0x',
  description: 'Complete guide to SEC-approved Solana spot ETFs trading 2026. Compare 16 ETFs, staking yields, fees, and regulatory changes from the March 2026 digital commodity ruling.',
  keywords: [
    'Solana ETF',
    'SOL ETF',
    'spot ETF',
