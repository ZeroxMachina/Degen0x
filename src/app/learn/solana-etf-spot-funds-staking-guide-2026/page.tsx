...
export default function SolanaETFGuide() {
      ...
      <header className="border-b border-[var(--border)] bg-[var(--background)] sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-[var(--muted)] mb-4">
            ...
            <span>/</span>
            <span className="text-[var(--foreground-strong)]">Solana ETF Guide 2026</span>
          </nav>
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight" style={{ background: 'linear-gradient(135deg, var(--accent-badge), var(--secondary))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <article id="main-content" className="lg:col-span-2 space-y-8">
          ...
          <section id="what-solana-etfs" className="space-y-4">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">What Are Solana ETFs?</h2>
            <p className="text-[var(--foreground-strong)] leading-relaxed">
        ...
        <div style={{ background: 'var(--card-alt)', border: '1px solid var(--border-alt)', borderRadius: 10, padding: '20px 24px', marginTop: 32, marginBottom: 32 }}>
          ...
          <section id="approval-timeline" className="space-y-4">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">How Solana ETFs Got Approved: The Timeline</h2>
            <p className="text-[var(--foreground-strong)] leading-relaxed">
              ...
              <div className="space-y-3">
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--accent-badge)] text-white text-sm font-bold">
                      1
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-[var(--foreground)]">October 28, 2025: First Approvals</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-[var(--foreground)]">January 6, 2026: Institutional Demand</h3>
                    <p className="text-[var(--muted)] text-sm mt-1">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-[var(--foreground)]">March 17, 2026: Digital Commodity Ruling</h3>
                    <p className="text-[var(--muted)] text-sm mt-1">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-[var(--foreground)]">April 2026: Rapid Expansion</h3>
                    <p className="text-[var(--muted)] text-sm mt-1">
            ...
            <p className="text-[var(--foreground-strong)] leading-relaxed text-sm italic text-[var(--muted)]">
          ...
          <section id="etf-list" className="space-y-4">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">Complete List of 16 Solana Spot ETFs (2026)</h2>
            <p className="text-[var(--foreground-strong)] leading-relaxed">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[var(--border)] bg-[var(--card)]">
                    <th className="px-4 py-3 text-left font-semibold text-[var(--foreground)]">Ticker</th>
                    <th className="px-4 py-3 text-left font-semibold text-[var(--foreground)]">Issuer</th>
                    <th className="px-4 py-3 text-left font-semibold text-[var(--foreground)]">Exchange</th>
                    <th className="px-4 py-3 text-left font-semibold text-[var(--foreground)]">Expense Ratio</th>
                    <th className="px-4 py-3 text-left font-semibold text-[var(--foreground)]">Fee Waiver</th>
                    <th className="px-4 py-3 text-left font-semibold text-[var(--foreground)]">Staking</th>
                  </tr>
                </thead>
                <tbody>
                  {etfs.map((etf, idx) => (
                    <tr key={idx} className="border-b border-[var(--border)] hover:bg-[var(--card)] transition-colors">
                      <td className="px-4 py-3 font-mono font-bold text-[var(--primary)]">{etf.ticker}</td>
                      <td className="px-4 py-3 text-[var(--foreground-strong)]">{etf.issuer}</td>
                      <td className="px-4 py-3 text-[var(--muted)]">{etf.exchange}</td>
                      <td className="px-4 py-3 font-semibold text-[var(--success)]">{etf.expenseRatio}</td>
                      <td className="px-4 py-3 text-[var(--muted)] text-xs">{etf.feeWaiver}</td>
                      <td className="px-4 py-3 text-[var(--success)]">{etf.staking}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-4 space-y-2">
              ...
              <ul className="space-y-2 text-sm text-[var(--foreground-strong)]">
          ...
          <section id="staking-how-it-works" className="space-y-4">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">Solana ETF Staking: How It Works</h2>
            <p className="text-[var(--foreground-strong)] leading-relaxed">
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-6 space-y-4">
              <h3 className="text-lg font-semibold text-[var(--foreground)]">Current Staking Yields</h3>
              ...
              <h3 className="text-lg font-semibold text-[var(--foreground)]">The March 2026 Regulatory Breakthrough</h3>
              <p className="text-[var(--foreground-strong)]">
              ...
              <ul className="space-y-2 text-[var(--foreground-strong)]">
                <li className="flex gap-2">
                  <span className="text-[var(--primary)]">•</span>
                  <span>
              ...
              <h3 className="text-lg font-semibold text-[var(--foreground)]">How ETF Issuers Handle Staking</h3>
              <p className="text-[var(--foreground-strong)]">
                Most Solana ETFs use one of two models:
              </p>
              <ul className="space-y-3 text-[var(--foreground-strong)]">
                <li className="flex gap-2">
              ...
              <h3 className="text-lg font-semibold text-[var(--foreground)]">What This Means for You</h3>
              <p className="text-[var(--foreground-strong)]">
          ...
          <section id="performance-flows" className="space-y-4">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">Solana ETF Performance &amp; Net Inflows</h2>
            <p className="text-[var(--foreground-strong)] leading-relaxed">
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-6 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-[var(--background)] p-4 rounded border border-[var(--border)]">
                  <p className="text-[var(--muted)] text-sm">Total AUM (as of April 2026)</p>
                  <p className="text-2xl font-bold text-[var(--success)] mt-1">$1B+</p>
                  <p className="text-xs text-[var(--muted)] mt-2">Exceeded $1B by January 2026, indicating rapid growth</p>
                </div>

                <div className="bg-[var(--background)] p-4 rounded border border-[var(--border)]">
                  <p className="text-[var(--muted)] text-sm">BSOL (Bitwise) Leadership</p>
                  <p className="text-2xl font-bold text-[var(--success)] mt-1">$357M Net Inflows</p>
                  <p className="text-xs text-[var(--muted)] mt-2">Largest single ETF by cumulative inflows</p>
                </div>

                <div className="bg-[var(--background)] p-4 rounded border border-[var(--border)]">
                  <p className="text-[var(--muted)] text-sm">Consecutive Positive Days</p>
                  <p className="text-2xl font-bold text-[var(--success)] mt-1">14 Days</p>
                  <p className="text-xs text-[var(--muted)] mt-2">14 consecutive days of net inflows reported</p>
                </div>

                <div className="bg-[var(--background)] p-4 rounded border border-[var(--border)]">
                  <p className="text-[var(--muted)] text-sm">ETF Count</p>
                  <p className="text-2xl font-bold text-[var(--success)] mt-1">16 Approved</p>
                  <p className="text-xs text-[var(--muted)] mt-2">16 distinct Solana spot ETFs by April 2026</p>
                </div>
              </div>

              <h3 className="text-lg font-semibold text-[var(--foreground)] mt-4">Key Insights</h3>
              <ul className="space-y-2 text-[var(--foreground-strong)] text-sm">
                <li className="flex gap-2">
                  <span className="text-[var(--primary)]">•</span>
                  <span>
              ...
              <p className="text-[var(--muted)] text-xs italic mt-4">
          ...
          <section id="commodity-ruling" className="space-y-4">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">The Digital Commodity Ruling: What Changed on March 17, 2026</h2>
            <p className="text-[var(--foreground-strong)] leading-relaxed">
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-6 space-y-4">
              ...
              <p className="text-[var(--foreground-strong)] text-sm">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-3">
                {[
                  ...
                  <div key={i} className="bg-[var(--background)] px-3 py-2 rounded border border-[var(--border)] text-sm text-[var(--foreground-strong)]">
                    {asset}
                  </div>
                ))}
              </div>

              <h3 className="text-lg font-semibold text-[var(--foreground)] mt-4">What This Means</h3>
              <ul className="space-y-3 text-[var(--foreground-strong)] text-sm">
                <li className="flex gap-2">
                  <span className="text-[var(--accent-badge)] font-bold">🔓</span>
                  <span>
              ...
              <h3 className="text-lg font-semibold text-[var(--foreground)] mt-4">The CLARITY Act: Why This Matters</h3>
              <p className="text-[var(--foreground-strong)] text-sm">
              ...
              <p className="text-[var(--foreground-strong)] text-sm mt-3">
          ...
          <section id="how-to-choose" className="space-y-4">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">How to Choose a Solana ETF</h2>
            <p className="text-[var(--foreground-strong)] leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-3">Decision Tree</h3>
                <div className="space-y-3 text-sm text-[var(--foreground-strong)]">
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-3">Recommended Picks for Different Investor Types</h3>

                <div className="space-y-4">
                  <div className="border-l-4 border-[var(--success)] pl-4">
                    <p className="font-semibold text-[var(--foreground)]">Fee-Conscious Investors</p>
                    <p className="text-[var(--muted)] text-sm mt-1">
                  ...
                  <div className="border-l-4 border-[var(--success)] pl-4">
                    <p className="font-semibold text-[var(--foreground)]">Institutional Investors</p>
                    <p className="text-[var(--muted)] text-sm mt-1">
                  ...
                  <div className="border-l-4 border-[var(--success)] pl-4">
                    <p className="font-semibold text-[var(--foreground)]">Growth/Inflow Investors</p>
                    <p className="text-[var(--muted)] text-sm mt-1">
                  ...
                  <div className="border-l-4 border-[var(--success)] pl-4">
                    <p className="font-semibold text-[var(--foreground)]">Long-Term Buy &amp; Hold</p>
                    <p className="text-[var(--muted)] text-sm mt-1">
          ...
          <section id="risks-considerations" className="space-y-4">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">Risks &amp; Considerations</h2>
            <p className="text-[var(--foreground-strong)] leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="bg-red-900/20 border border-red-800 rounded-lg p-5">
                ...
                <ul className="space-y-2 text-[var(--foreground-strong)] text-sm mt-3 ml-4">
                ...
                <p className="text-[var(--foreground-strong)] text-sm mt-3 italic">
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-4">
              <p className="text-[var(--foreground-strong)] text-sm font-semibold">Bottom Line on Risks</p>
          ...
          {/* Disclaimer */}
          <section id="disclaimer" className="space-y-4 mt-8 pt-8 border-t border-[var(--border)]">
            <h2 className="text-lg font-bold text-[var(--foreground)]">Disclaimer</h2>
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-4 text-sm text-[var(--muted)] space-y-3">
              <p>
          ...
          {/* Related Resources */}
          <section id="related-resources" className="space-y-4 mt-8 pt-8 border-t border-[var(--border)]">
            <h2 className="text-lg font-bold text-[var(--foreground)]">Related Resources</h2>
            <div className="space-y-3">
              <Link href="#"
                className="block p-4 bg-[var(--card)] border border-[var(--border)] rounded-lg hover:border-[var(--primary)] transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
              >
                <p className="font-semibold text-[var(--primary)] group-hover:underline">
  ...
  <a href="/learn/sui-blockchain-guide-2026" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] rounded-sm" style={{ color: "var(--primary)", marginRight: "1rem" }}>Sui Blockchain Guide 2026</a>
  <a href="/learn/cross-chain-intents-guide" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] rounded-sm" style={{ color: "var(--primary)", marginRight: "1rem" }}>Cross Chain Intents Guide</a>
  <a href="/learn/ai-agent-frameworks-comparison-2026" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] rounded-sm" style={{ color: "var(--primary)", marginRight: "1rem" }}>Ai Agent Frameworks Comparison 2026</a>

          <a href="/learn/sui-private-transactions-seal-framework-guide-2026" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] rounded-sm" style={{ color: "var(--primary)", marginRight: "1rem" }}>Sui Private Transactions Seal Framework Guide 2026</a>
        </nav>
      </article>
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-[120px] space-y-6">
            {/* Table of Contents */}
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-4">
              <h3 className="font-bold text-[var(--foreground)] mb-4">Table of Contents</h3>
              <nav className="space-y-2 text-sm">
                {[
                  ...
                  <a
                    key={item.id}
                    href={`#${item.id}`}
                    className="block px-3 py-1 text-[var(--muted)] hover:text-[var(--primary)] transition-colors rounded hover:bg-[var(--background)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--card)] rounded-sm"
                  >
                    {item.label}
                  </a>
                ))}
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-4 space-y-3">
              <h3 className="font-bold text-[var(--foreground)]">Quick Stats</h3>
              <div className="space-y-2 text-sm">
                <div>
                  <p className="text-[var(--muted)]">Total Approved ETFs</p>
                  <p className="text-lg font-bold text-[var(--success)]">16</p>
                </div>
                <div>
                  <p className="text-[var(--muted)]">Lowest Fee</p>
                  <p className="text-lg font-bold text-[var(--success)]">0.19% (SOEZ)</p>
                </div>
                <div>
                  <p className="text-[var(--muted)]">Staking Yield</p>
                  <p className="text-lg font-bold text-[var(--success)]">~7% APY</p>
                </div>
                <div>
                  <p className="text-[var(--muted)]">Total AUM</p>
                  <p className="text-lg font-bold text-[var(--success)]">$1B+</p>
                </div>
              </div>
            </div>
            ...
            {/* Key Dates */}
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-4 space-y-3">
              <h3 className="font-bold text-[var(--foreground)]">Key Dates</h3>
              <div className="space-y-2 text-xs">
                <div>
                  <p className="text-[var(--muted)]">First Approvals</p>
                  <p className="font-semibold text-[var(--foreground-strong)]">Oct 28, 2025</p>
                </div>
                <div>
                  <p className="text-[var(--muted)]">Digital Commodity Ruling</p>
                  <p className="font-semibold text-[var(--foreground-strong)]">Mar 17, 2026</p>
                </div>
                <div>
                  <p className="text-[var(--muted)]">SOEZ Fee Waiver Expires</p>
                  <p className="font-semibold text-[var(--foreground-strong)]">May 31, 2026</p>
                </div>
              </div>
            </div>

            {/* CTA */}
            <div className="bg-gradient-to-br from-[var(--accent-badge)] to-[var(--secondary)] rounded-lg p-4 text-white">
              ...
              <a
                href="#etf-list"
                className="inline-block px-3 py-2 bg-white text-[var(--accent-badge)] rounded font-semibold text-xs hover:bg-gray-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--accent-badge)]"
              >
                View ETF Comparison
              </a>
            </div>
      ...
      {/* Footer */}
      <footer className="border-t border-[var(--border)] bg-[var(--background)] mt-12">
        <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8 text-center text-sm text-[var(--muted)]">
          <p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "12px" }}>
          <Link href="/learn" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] rounded-lg" style={{
            padding: "12px 16px",
          ...
          <Link href="/tools" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] rounded-lg" style={{
            padding: "12px 16px",
            backgroundColor: "var(--card)",
            borderRadius: "8px",
            color: "var(--primary)",
          ...
          <Link href="/compare" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] rounded-lg" style={{
            padding: "12px 16px",
            backgroundColor: "var(--card)",
            borderRadius: "8px",
            color: "var(--primary)",
