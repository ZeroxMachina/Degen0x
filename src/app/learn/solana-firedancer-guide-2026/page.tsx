...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Solana Firedancer Guide 2026', },
  ],
};
    ...
    <div style={{ minHeight: "100vh", background: "#0d1117", color: "#e6edf3" }}>
      ...
      <article className="firedancer-article" style={{ maxWidth: 820, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        <header style={{ marginBottom: 32 }}>
          ...
          <LastUpdated pathKey="/learn/solana-firedancer-guide-2026" />
          <ReadingTime />
          <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Solana Firedancer Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/solana-firedancer-guide-2026"
            })
          }}
        />
      </article>
