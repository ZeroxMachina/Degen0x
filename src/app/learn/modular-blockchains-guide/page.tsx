  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section id="monolithic-vs-modular" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Monolithic vs Modular Blockchains</h2>

        <h3 className="text-xl font-semibold text-white mb-3">Monolithic Architecture</h3>
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Modular Architecture</h3>
        <p className="text-gray-300 mb-4">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-4">
          <p className="text-gray-300 mb-3"><strong className="text-white">Data Availability Layer:</strong> Stores transaction data (Celestia, EigenDA)</p>
          <p className="text-gray-300 mb-3"><strong className="text-white">Execution Layer:</strong> Runs transactions and state (Arbitrum, Optimism, StarkNet)</p>
          <p className="text-gray-300 mb-3"><strong className="text-white">Settlement Layer:</strong> Finalizes and resolves disputes (Ethereum)</p>
          <p className="text-gray-300"><strong className="text-white">Consensus:</strong> Separate mechanism for settlement layer</p>
        </div>
      ...
      <section id="data-availability" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Data Availability Layers</h2>
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Celestia: Specializing in Data Availability</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">EigenDA: Restaking-Based DA</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">DA Sampling</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="execution-settlement" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Execution and Settlement Layers</h2>

        <h3 className="text-xl font-semibold text-white mb-3">Execution Layers</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Optimistic vs ZK Execution</h3>
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-4">
          <p className="text-gray-300 mb-3"><strong className="text-white">Optimistic Rollups (Arbitrum, Optimism):</strong> Assume transactions are valid; fraud provers can challenge incorrect state within a dispute window</p>
          <p className="text-gray-300"><strong className="text-white">ZK Rollups (StarkNet, zkSync):</strong> Prove computation is correct cryptographically; no dispute window needed</p>
        </div>

        <h3 className="text-xl font-semibold text-white mb-3">Settlement Layers</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="key-projects" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Key Modular Blockchain Projects</h2>

        <h3 className="text-xl font-semibold text-white mb-3">Celestia (TIA)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Arbitrum (ARB)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Optimism (OP)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">StarkNet (STRK)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Avail (AVL)</h3>
        <p className="text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Eigenlayer (EigenDA)</h3>
        <p className="text-gray-300 mb-4">
      ...
      <section id="tradeoffs" className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Modular Tradeoffs & Challenges</h2>

        <h3 className="text-xl font-semibold text-white mb-3">Advantages of Modularity</h3>
        ...
        <h3 className="text-xl font-semibold text-white mb-3">Challenges & Concerns</h3>
        <ul className="space-y-3 text-gray-300 mb-6">
        ...
        <h3 className="text-xl font-semibold text-white mb-3">The Blockchain Trilemma Still Applies</h3>
        <p className="text-gray-300 mb-4">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mt-12">
        <h3 className="text-white font-bold mb-3">Explore Modular Chain Tools</h3>
        <ul className="space-y-2 text-blue-400">
