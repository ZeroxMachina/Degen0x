...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${SITE_URL}/og-ethereum-pectra-upgrade-guide.png`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`${SITE_URL}/og-ethereum-pectra-upgrade-guide.png`],
  },
  alternates: {
...
const articleSchema = generateArticleSchema({
  ...
  author: "degen0x Team",
  image: `${SITE_URL}/og-ethereum-pectra-upgrade-guide.png`,
  wordCount: 2900,
});
