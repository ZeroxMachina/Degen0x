...
export const metadata: Metadata = {
  ...
  description: "Story is a Layer 1 blockchain for tokenizing intellectual property. Learn about IP Assets, Programmable IP Licenses, IP Vault for AI data, $IP token, and why",
  keywords: [
    "story protocol",
    "ip tokenization",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Story Protocol Ip Tokenization Guide', },
  ],
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Story Protocol Ip Tokenization Guide",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/story-protocol-ip-tokenization-guide"
            })
          }}
        />
      </article>
