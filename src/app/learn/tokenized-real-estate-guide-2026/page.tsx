...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Tokenized Real Estate Guide 2026', },
  ],
};
    ...
    <article style={{ backgroundColor: '#0d1117', color: '#e6edf3', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <LastUpdated pathKey="/learn/tokenized-real-estate-guide-2026" />
          <ReadingTime />
          <AutoTOC />
      ...
      <BackToTop />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Tokenized Real Estate Guide 2026 \u2014 Invest in Property with", "description": "Complete guide to tokenized real estate in 2026. Learn about fractional property ownership, blockchain-based real estate platforms, and how to invest in", "url": "https://degen0x.com/learn/tokenized-real-estate-guide-2026", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Tokenized Real Estate Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/tokenized-real-estate-guide-2026"
            })
          }}
        />
