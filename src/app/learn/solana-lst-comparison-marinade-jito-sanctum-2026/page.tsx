...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Solana Lst Comparison Marinade Jito Sanctum 2026', },
  ],
};
    ...
    <div style={{ backgroundColor: '#0d1117', color: '#e6edf3', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <LastUpdated pathKey="/learn/solana-lst-comparison-marinade-jito-sanctum-2026" />
          <ReadingTime />
          <AutoTOC />
...
<AuthoritySources url="/learn/solana-lst-comparison-marinade-jito-sanctum-2026" />
</div>
  );
}
