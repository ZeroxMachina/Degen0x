...
export default function WorldIDProofOfPersonhoodGuide() {
  return (
    <div id="worldcoin-guide" style={{ backgroundColor: 'var(--color-bg)', color: 'var(--color-text)', minHeight: '100vh', padding: 'clamp(1rem, 3vw, 2rem)' }}>
      <style dangerouslySetInnerHTML={{ __html: `
        #worldcoin-guide a:focus-visible, #worldcoin-guide button:focus-visible, #worldcoin-guide [tabindex]:focus-visible {
          outline: 2px solid var(--color-primary);
          outline-offset: 2px;
          border-radius: 4px;
        }
        #worldcoin-guide .related-card { transition: border-color 0.15s ease; }
        #worldcoin-guide .related-card:hover { border-color: var(--color-primary) !important; }
      ` }} />
      <script
        ...
        <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
          <span
            style={{
              ...
              padding: '0.5rem 1rem',
              backgroundColor: 'var(--color-secondary, #a855f7)',
              color: '#fff',
    ...
    >
        ...
        <h1
          style={{
            ...
            marginBottom: '1rem',
            lineHeight: '1.2',
            background: 'linear-gradient(135deg, var(--color-primary) 0%, var(--color-secondary, #a855f7) 100%)',
    ...
    >
        ...
        {/* editorial-voice */}
        <div style={{ background: 'var(--color-bg-card)', border: '1px solid var(--color-secondary, #2d2254)', borderRadius: 10, padding: '20px 24px', marginTop: 32, marginBottom: 32 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
            <span style={{ fontSize: 18 }}>💡</span>
            <strong style={{ color: 'var(--color-secondary, #a78bfa)', fontSize: 15 }}>Why This Matters</strong>
          </div>
    ...
    >
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div
            style={{
              backgroundColor: 'var(--color-bg-card)',
              border: '2px solid var(--color-secondary, #a855f7)',
              borderRadius: '0.5rem',
              padding: '1.5rem',
            }}
    >
    ...
    >
            ...
            <Link href="/learn/decentralized-identity-did-verifiable-credentials-guide-2026"
              className="related-card"
              style={{
                backgroundColor: 'var(--color-bg-card)',
                border: '1px solid var(--color-border)',
    ...
    >
            ...
            <Link href="/learn/x402-protocol-ai-agent-payments-guide-2026"
              className="related-card"
              style={{
                backgroundColor: 'var(--color-bg-card)',
                border: '1px solid var(--color-border)',
    ...
    >
            ...
            <Link href="/learn/ai-agents-decentralized-ai-crypto-guide-2026"
              className="related-card"
              style={{
                backgroundColor: 'var(--color-bg-card)',
                border: '1px solid var(--color-border)',
    ...
    >
            ...
            <Link href="/learn/ethereum-layer-2-comparison-guide-2026"
              className="related-card"
              style={{
                backgroundColor: 'var(--color-bg-card)',
                border: '1px solid var(--color-border)',
    ...
    >
        ...
        {/* section-footer */}
        <div style={{ background: 'var(--color-bg-card)', border: '1px solid var(--color-secondary, #2d2254)', borderRadius: 8, padding: '16px 20px', marginTop: 40, marginBottom: 20 }}>
          <p style={{ fontSize: 13, color: 'var(--color-text-secondary)', lineHeight: 1.7, margin: 0 }}>
            <strong style={{ color: 'var(--color-secondary, #a78bfa)' }}>Educational disclaimer:</strong> This guide is for informational purposes only and does not constitute financial advice.
            Crypto involves significant risk — do your own research before making any decisions. Learn more about <a href="/about" style={{ color: 'var(--color-secondary, #a78bfa)' }}>our team</a>.
          </p>
        </div>
      </article>
