...
export default function MiningProfitabilityPage() {
  return (
    <main className="min-h-screen" style={{ backgroundColor: 'var(--color-bg)' }}>
      ...
      {/* Breadcrumb */}
      <div style={{ borderBottom: '1px solid var(--color-border)', paddingTop: 24 }}>
      ...
      >
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-6 flex flex-wrap gap-2">
            ...
            <span className="text-xs" style={{ color: 'var(--color-text-secondary)', alignSelf: 'center' }}>
          ...
          <p
            ...
            style={{ color: 'var(--color-text-secondary)', maxWidth: '700px' }}
          >
      ...
      <div className="mx-auto max-w-4xl px-6 py-12 sm:px-8 sm:py-16">
        ...
        >
          ...
          <ul className="space-y-2">
            <li>
              <Link href="#what-is-bitcoin-mining" className="text-base hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded" style={{ color: 'var(--color-primary)' }}>
                1. What Is Bitcoin Mining?
              </Link>
            </li>
            <li>
              <Link href="#post-halving-economics" className="text-base hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded" style={{ color: 'var(--color-primary)' }}>
                2. Post-Halving Economics: The 2024 Impact
              </Link>
            </li>
            <li>
              <Link href="#mining-hardware" className="text-base hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded" style={{ color: 'var(--color-primary)' }}>
                3. Mining Hardware: Best ASICs in 2026
              </Link>
            </li>
            <li>
              <Link href="#electricity-costs" className="text-base hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded" style={{ color: 'var(--color-primary)' }}>
                4. Electricity & Operating Costs
              </Link>
            </li>
            <li>
              <Link href="#profitability-calculator" className="text-base hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded" style={{ color: 'var(--color-primary)' }}>
                5. Mining Profitability Calculator Breakdown
              </Link>
            </li>
            <li>
              <Link href="#mining-pools" className="text-base hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded" style={{ color: 'var(--color-primary)' }}>
                6. Mining Pools vs Solo Mining
              </Link>
            </li>
            <li>
              <Link href="#ai-pivot" className="text-base hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded" style={{ color: 'var(--color-primary)' }}>
                7. The AI Pivot: Miners Diversifying
              </Link>
            </li>
            <li>
              <Link href="#risks-outlook" className="text-base hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded" style={{ color: 'var(--color-primary)' }}>
                8. Risks & Outlook
              </Link>
            </li>
          </ul>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3">
                      <span
                        style={{ backgroundColor: 'rgba(241, 65, 108, 0.1)', color: 'var(--color-danger, #f14170)' }}
                      >
                        C+
                      </span>
                    </td>
        ...
        <section id="electricity-costs" className="mb-12">
          ...
          >
            <h3 className="mb-4 flex items-center gap-2 text-xl font-semibold" style={{ color: 'var(--color-text)' }}>
              <Zap size={20} style={{ color: 'var(--color-accent, #fbbf24)' }} />
        ...
        <section id="profitability-calculator" className="mb-12">
          ...
          <div
            style={{ backgroundColor: 'var(--color-bg-card)', border: '1px solid var(--color-border)' }}
          >
            <h3 className="mb-6 text-lg font-semibold" style={{ color: 'var(--color-text)' }}>
            ...
            <div className="space-y-4">
              <div style={{ color: 'var(--color-text-secondary)' }}>
                <div className="mb-2 flex justify-between">
                  ...
                  <span style={{ color: 'var(--color-primary)' }}>500 TH/s</span>
                </div>
                <div className="mb-2 flex justify-between">
                  <span>Network hashrate:</span>
                  <span style={{ color: 'var(--color-primary)' }}>800 EH/s (800,000,000 TH/s)</span>
                </div>
                <div className="mb-2 flex justify-between">
                  <span>Block reward:</span>
                  <span style={{ color: 'var(--color-primary)' }}>3.125 BTC per block (~10 min)</span>
                </div>
                <div className="mb-4 flex justify-between border-b pb-4" style={{ borderColor: 'var(--color-border)' }}>
                  <span>Bitcoin price:</span>
                  <span style={{ color: 'var(--color-primary)' }}>$65,000</span>
                </div>
              </div>
              ...
              <div style={{ color: 'var(--color-text-secondary)' }}>
                <div className="mb-2 flex justify-between">
                  ...
                  <span style={{ color: 'var(--color-success)' }}>0.00195 BTC/day</span>
                </div>
                <div className="mb-2 flex justify-between">
                  <span>Daily BTC value:</span>
                  <span style={{ color: 'var(--color-success)' }}>$127 USD</span>
                </div>
                <div className="mb-4 flex justify-between border-b pb-4" style={{ borderColor: 'var(--color-border)' }}>
                  <span>Daily operating cost:</span>
                  <span style={{ color: 'var(--color-danger, #f14170)' }}>-$26 (@ $0.12/kWh)</span>
                </div>
              </div>

              <div className="flex justify-between text-lg font-semibold" style={{ color: 'var(--color-success)' }}>
        ...
        <section id="mining-pools" className="mb-12">
          ...
          <div className="mb-8 grid gap-6 sm:grid-cols-2">
            ...
            <div
              ...
              style={{ backgroundColor: 'var(--color-bg-card)', border: '1px solid var(--color-border)' }}
            >
              <h3 className="mb-4 text-lg font-semibold" style={{ color: 'var(--color-primary)' }}>
                Pool Mining
              </h3>
              <ul className="space-y-2 text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                ...
                <li className="flex gap-2">
                  <span style={{ color: 'var(--color-danger, #f14170)' }}>✗</span>
            ...
            <div
              style={{ backgroundColor: 'var(--color-bg-card)', border: '1px solid var(--color-border)' }}
            >
              <h3 className="mb-4 text-lg font-semibold" style={{ color: 'var(--color-secondary, #06b6d4)' }}>
                Solo Mining
              </h3>
              <ul className="space-y-2 text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                <li className="flex gap-2">
        ...
        <section id="ai-pivot" className="mb-12">
          ...
          <div
            style={{
              backgroundColor: 'var(--color-bg-card)',
              borderColor: 'var(--color-secondary, #06b6d4)',
              border: '1px solid var(--color-border)',
              borderLeftWidth: '4px',
            }}
          >
            <div className="flex gap-3">
              <TrendingUp size={24} style={{ color: 'var(--color-secondary, #06b6d4)', flexShrink: 0 }} />
              <div>
                <h3 className="mb-2 font-semibold" style={{ color: 'var(--color-text)' }}>
          ...
          <ul className="mb-6 space-y-2" style={{ color: 'var(--color-text-secondary)' }}>
            <li className="flex gap-3">
              <span style={{ color: 'var(--color-secondary, #06b6d4)' }}>→</span>
              <span>
                <strong style={{ color: 'var(--color-text)' }}>Lower hardware specificity:</strong> GPUs and CPUs are more fungible than ASICs
              </span>
            </li>
            <li className="flex gap-3">
              <span style={{ color: 'var(--color-secondary, #06b6d4)' }}>→</span>
              <span>
                <strong style={{ color: 'var(--color-text)' }}>Diversified revenue:</strong> Multiple income streams reduce Bitcoin-only risk
              </span>
            </li>
            <li className="flex gap-3">
              <span style={{ color: 'var(--color-secondary, #06b6d4)' }}>→</span>
              <span>
                <strong style={{ color: 'var(--color-text)' }}>Scalability:</strong> AI workloads can monetize fractional compute, not just full mining rigs
              </span>
            </li>
            <li className="flex gap-3">
              <span style={{ color: 'var(--color-secondary, #06b6d4)' }}>→</span>
              <span>
                <strong style={{ color: 'var(--color-text)' }}>Higher margins:</strong> Some projects offer premium payouts for specialized hardware
              </span>
            </li>
          </ul>
        ...
        <section id="risks-outlook" className="mb-12">
          ...
          <div
            style={{
              backgroundColor: 'var(--color-bg-card)',
              borderColor: 'var(--color-danger, #f14170)',
              border: '1px solid var(--color-border)',
              borderLeftWidth: '4px',
            }}
          >
            <div className="flex gap-3">
              <AlertCircle size={24} style={{ color: 'var(--color-danger, #f14170)', flexShrink: 0 }} />
              <div>
                <h3 className="mb-3 font-semibold" style={{ color: 'var(--color-text)' }}>
                  Key Risks to Monitor
                </h3>
                <ul className="space-y-2 text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                  <li>
                    <strong style={{ color: 'var(--color-text)' }}>Difficulty adjustments:</strong> Network hashrate growth outpacing hardware efficiency gains
                  </li>
                  <li>
                    <strong style={{ color: 'var(--color-text)' }}>Price volatility:</strong> Bitcoin price crashes compress margins faster than cost reductions
                  </li>
                  <li>
                    <strong style={{ color: 'var(--color-text)' }}>Electricity inflation:</strong> Rising grid costs in mature mining markets (Texas, Upstate NY)
                  </li>
                  <li>
                    <strong style={{ color: 'var(--color-text)' }}>Regulatory pressure:</strong> Potential carbon taxes or grid curtailment policies
                  </li>
                  <li>
                    <strong style={{ color: 'var(--color-text)' }}>Hardware supply:</strong> Chip shortage cycles can create multi-month waits for units
                  </li>
                  <li>
                    <strong style={{ color: 'var(--color-text)' }}>Consolidation:</strong> Publicly-listed miners' balance sheet strength squeeze smaller operators
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link href="/tools/dca-calculator"
              className="group rounded-lg p-4 transition-all hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
              style={{ backgroundColor: 'var(--color-bg-card)', border: '1px solid var(--color-border)' }}
            >
              <div className="flex items-center gap-3">
                ...
                <ArrowRight size={16} style={{ color: 'var(--color-primary)', marginLeft: 'auto' }} />
              </div>
            </Link>
