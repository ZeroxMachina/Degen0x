    ...
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <LastUpdated pathKey="/learn/data-availability-sampling-explained" />
          <ReadingTime />
          <AutoTOC />
...
{/* section-footer */}
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Data Availability Sampling Explained: Light Nodes & DA", "description": "Learn how Data Availability Sampling enables light nodes without full blocks. Explore Celestia, EigenDA, and KZG commitments.", "url": "https://degen0x.com/learn/data-availability-sampling-explained", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
