...
export const metadata: Metadata = {
  title: `What Is TVL (Total Value Locked)? Definition & Guide (${CURRENT_YEAR}) | CryptoDegen`,
...
export default function TvlPage() {
  return (
    <LearnPageLayout title="What Is TVL (Total Value Locked)?" categoryName="Learn Crypto" categorySlug="learn" readTime="5 min read"
      ...
      toc={[{ id: "definition", title: "What Is TVL?", level: 2 }, { id: "how-calculated", title: "How TVL Is Calculated", level: 2 }, { id: "using-tvl", title: "Using TVL for Analysis", level: 2 }, { id: "limitations", title: "Limitations of TVL", level: 2 }]}
