...
export const metadata: Metadata = {
  title: `What Is Restaking? Definition & Guide (${CURRENT_YEAR}) | degen0x`,
  ...
  return (
    <LearnPageLayout title="What Is Restaking?" categoryName="Learn Crypto" categorySlug="learn" readTime="5 min read"
      ...
      toc={[
        ...
        { id: "eigenlayer", title: "eigenlayer", level: 2 },
        { id: "eigenlayer-and-avss", title: "EigenLayer and AVSs", level: 2 },
