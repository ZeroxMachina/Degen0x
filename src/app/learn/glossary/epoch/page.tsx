...
export const metadata: Metadata = {
  title: `What Is an Epoch in Blockchain? Definition & Guide (${CURRENT_YEAR}) | CryptoDegen`,
...
export default function EpochPage() {
  return (
    <LearnPageLayout title="What Is an Epoch?" categoryName="Learn Crypto" categorySlug="learn" readTime="4 min read"
      ...
      toc={[{ id: "definition", title: "What Is an Epoch?", level: 2 }, { id: "epochs-by-chain", title: "Epochs on Different Chains", level: 2 }, { id: "epoch-functions", title: "What Happens During an Epoch", level: 2 }, { id: "importance", title: "Why Epochs Matter", level: 2 }]}
