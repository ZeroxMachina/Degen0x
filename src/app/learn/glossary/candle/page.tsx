...
export const metadata: Metadata = {
  title: `What Is a Candlestick? Definition & Guide (${CURRENT_YEAR}) | CryptoDegen`,
...
export default function CandlePage() {
  return (
    <LearnPageLayout title="What Is a Candlestick?" categoryName="Learn Crypto" categorySlug="learn" readTime="5 min read"
      ...
      toc={[{ id: "definition", title: "What Is a Candlestick?", level: 2 }, { id: "reading-candles", title: "How to Read Candlesticks", level: 2 }, { id: "common-patterns", title: "Common Candlestick Patterns", level: 2 }, { id: "using-candles", title: "Using Candlesticks in Trading", level: 2 }]}
