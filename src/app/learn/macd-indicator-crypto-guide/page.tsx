...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Macd Indicator Crypto Guide', },
  ],
};
...
export default function MACDIndicatorGuide() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="MACD Indicator for Crypto Trading Guide | Bitcoin &"
        description="Master MACD (Moving Average Convergence Divergence) for crypto: 12-26 EMA, signal line, histogram, bullish/bearish crossovers. Real BTC/ETH examples, trading"
        url="https://degen0x.com/learn/macd-indicator-crypto-guide"
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <LastUpdated pathKey="/learn/macd-indicator-crypto-guide" />
          <ReadingTime />
          <AutoTOC />
...
{/* section-footer */}
      ...
      <AuthoritySources url="/learn/macd-indicator-crypto-guide" />
      </article>
  );
}
