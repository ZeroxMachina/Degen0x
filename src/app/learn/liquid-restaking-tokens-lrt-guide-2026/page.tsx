    ...
    <main style={pageStyle}>
      ...
      <div style={containerStyle}>
        ...
        <nav aria-label="Breadcrumb" style={breadcrumbStyle}>
          ...
          <span style={{ margin: '0 6px' }}>›</span>
          <span style={{ color: 'var(--color-text-secondary)' }}>Liquid Restaking Tokens Guide</span>
        </nav>
        ...
        <nav aria-label="Table of Contents" style={tocStyle}>
          <h3 style={{ ...h3Style, marginTop: 0, color: 'var(--color-text-secondary)' }}>Table of Contents</h3>
        ...
        <nav style={{ marginTop: "2rem", padding: "1rem", borderTop: "1px solid var(--color-border)", fontSize: "14px" }}>
          <span style={{ color: "var(--color-text-muted, #8b949e)" }}>Related: </span>
          <a href="/learn/grass-protocol-depin-guide" style={{ color: "var(--color-accent)", marginRight: "1rem" }}>Grass Protocol Depin Guide</a>
        </nav>
</main>
  );
}
