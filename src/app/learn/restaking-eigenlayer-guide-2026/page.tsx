...
/* style objects defined inside the component below */
...
export default function RestakingEigenLayerGuide() {
  ...
  const infoBoxStyle = {
    ...
    border: '1px solid var(--color-border)', borderLeft: '3px solid var(--color-primary)',
    borderRadius: 12,
    padding: 20,
    marginBottom: 24,
    lineHeight: 1.8,
  ...
  const h2Style = {
    ...
    marginTop: 40,
    marginBottom: 16,
    color: 'var(--color-primary)', borderBottom: '2px solid var(--color-border)', paddingBottom: 12,
  };
  ...
  const linkStyle = {
    color: 'var(--color-primary-light, #79c0ff)',
    textDecoration: 'none',
  };
  ...
  return (
    <article id="top" style={{ background: 'var(--color-bg)', color: 'var(--color-text)', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <style dangerouslySetInnerHTML={{ __html: `
        #top a:focus-visible, #top button:focus-visible, #top summary:focus-visible, #top [tabindex]:focus-visible {
          outline: 2px solid var(--color-primary);
          outline-offset: 2px;
          border-radius: 4px;
        }
        #top .related-card { transition: border-color 0.15s ease; }
        #top .related-card:hover { border-color: var(--color-primary) !important; }
      ` }} />
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <nav aria-label="Breadcrumb" style={{ marginBottom: 20, fontSize: 13, color: 'var(--color-text-secondary)' }}>
          ...
          <a href="/learn" style={{ color: 'var(--color-text-secondary)', textDecoration: 'none' }}>Learn</a>
          <span style={{ margin: '0 6px' }}>›</span>
          <span style={{ color: 'var(--color-text)' }}>Restaking &amp; EigenLayer Guide</span>
        </nav>

        {/* Header Section */}
        <div style={{ marginBottom: 32 }}>
          <div>
            <span style={{ ...badgeStyle, background: 'var(--color-primary)', color: 'var(--color-text)' }}>DeFi</span>
            <span style={{ ...badgeStyle, background: 'var(--color-border)', color: 'var(--color-text)' }}>Intermediate</span>
          </div>
        ...
        <nav aria-label="Table of Contents" style={{ ...infoBoxStyle, marginBottom: 32 }}>
          ...
          <ol style={{ marginLeft: 20, color: 'var(--color-primary-light, #79c0ff)' }}>
        ...
        <section id="how-restaking-works" style={{ scrollMarginTop: 24 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Native Restaking</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Liquid Staking Token (LST) Restaking</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Liquid Restaking Token (LRT) Path</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>The Operator Delegation Model</h3>
          <p style={{ marginBottom: 24, lineHeight: 1.8 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: 'var(--color-text)' }}>The Operator Risk Tradeoff</strong>
            <p style={{ marginTop: 12, marginBottom: 0, fontSize: 14 }}>
        ...
        <section id="market-landscape-2026" style={{ scrollMarginTop: 24 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: 'var(--color-text)' }}>Why EigenLayer Dominates</strong>
            <p style={{ marginTop: 12, marginBottom: 0, fontSize: 14 }}>
        ...
        <section id="eigenlayer-deep-dive" style={{ scrollMarginTop: 24 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Native vs LST Restaking</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, margintop: 20, marginBottom: 12, color: 'var(--color-text)' }}>AVS Ecosystem Growth</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>ELIP-12 and the Incentives Committee (Q1 2026)</h3>
          <p style={{ marginBottom: 24, lineHeight: 1.8 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: 'var(--color-text)' }}>Picking Operators and AVSs</strong>
            <p style={{ marginTop: 12, marginBottom: 0, fontSize: 14 }}>
        ...
        <section id="protocol-comparison" style={{ scrollMarginTop: 24 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>EigenLayer: The Incumbent</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Symbiotic: The Permissionless Challenger</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Karak: Multi-Chain Focus</h3>
          <p style={{ marginBottom: 24, lineHeight: 1.8 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: 'var(--color-text)' }}>Platform Selection Strategy</strong>
            <p style={{ marginTop: 12, marginBottom: 0, fontSize: 14 }}>
        ...
        <section id="yield-economics" style={{ scrollMarginTop: 24 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Base Ethereum Staking Yield</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>AVS Fees and Token Emissions</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Operator Commission</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Liquid Restaking Token (LRT) Economics</h3>
          <p style={{ marginBottom: 24, lineHeight: 1.8 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: 'var(--color-text)' }}>Yield Optimization</strong>
            <p style={{ marginTop: 12, marginBottom: 0, fontSize: 14 }}>
        ...
        <section id="risks-challenges" style={{ scrollMarginTop: 24 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Double Slashing</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Operator Risk</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Smart Contract Risk</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Systemic Risk</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Liquidity Risk for LRTs</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Token Emission Risk</h3>
          <p style={{ marginBottom: 24, lineHeight: 1.8 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: 'var(--color-text)' }}>Risk Management Framework</strong>
            <p style={{ marginTop: 12, marginBottom: 0, fontSize: 14 }}>
        ...
        <section id="getting-started" style={{ scrollMarginTop: 24 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Step 1: Choose Your Path</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Step 2: Choose Your Platform</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Step 3: Start Small</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Step 4: Diversify Across Operators and AVSs</h3>
          <p style={{ marginBottom: 16, lineHeight: 1.8 }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 600, marginTop: 20, marginBottom: 12, color: 'var(--color-text)' }}>Step 5: Consider DeFi Composability</h3>
          <p style={{ marginBottom: 24, lineHeight: 1.8 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: 'var(--color-text)' }}>Recommended First Steps</strong>
            <p style={{ marginTop: 12, marginBottom: 0, fontSize: 14 }}>
        ...
        <section id="faq" style={{ scrollMarginTop: 24 }}>
          ...
          <details style={{ marginBottom: 16, background: 'var(--color-bg-card)', border: '1px solid var(--color-border)', borderRadius: 12, padding: '0 20px' }}>
            <summary style={{ padding: '16px 0', cursor: 'pointer', fontWeight: 600, color: 'var(--color-text)', fontSize: 16, listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              What is restaking in crypto?
              <span style={{ fontSize: 20, color: 'var(--color-text-secondary)', transition: 'transform 0.2s' }}>+</span>
            </summary>
            <p style={{ paddingBottom: 16, lineHeight: 1.8, color: 'var(--color-text-secondary)', marginTop: 0 }}>
        ...
        <section style={{ marginTop: 48, paddingTop: 32, borderTop: '1px solid var(--color-border)' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, marginBottom: 32 }}>
            <li className="related-card" style={{ marginBottom: 12, padding: '12px 16px', border: '1px solid var(--color-border)', borderRadius: 8 }}>
        ...
        {/* Disclaimer */}
        <section style={{ marginTop: 32, padding: 20, background: 'var(--color-bg-card)', border: '1px solid var(--color-border)', borderRadius: 12, fontSize: 13, color: 'var(--color-text-secondary)' }}>
