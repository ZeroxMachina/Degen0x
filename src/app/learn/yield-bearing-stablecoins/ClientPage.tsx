...
export default function YieldBearingStablecoinsPage() {
  ...
  return (
    <main style={{ backgroundColor: S.bg, color: S.text, minHeight: "100vh" }}>
      <ArticleSchema
        headline="Traditional Stablecoins"
        description="Traditional Stablecoins"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Article",
              "headline": "Yield Bearing Stablecoins",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/yield-bearing-stablecoins"
            })
          }}
        />
      </article>
