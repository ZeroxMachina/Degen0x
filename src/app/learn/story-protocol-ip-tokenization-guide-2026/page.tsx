...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Story Protocol Ip Tokenization Guide 2026', },
  ],
};
...
export default function StoryProtocolGuide() {
  ...
  return (
    <div style={pageStyle}>
      ...
      <RelatedContent category="learn" currentSlug="/learn/story-protocol-ip-tokenization-guide-2026" />
<AuthoritySources url="/learn/story-protocol-ip-tokenization-guide-2026" />
</div>
  );
}
