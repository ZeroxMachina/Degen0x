...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/learn/smart-contract-security-audit-guide-2026" }};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Smart Contract Security Audit Guide 2026', },
  ],
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Smart Contract Security Audit Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/smart-contract-security-audit-guide-2026"
            })
          }}
        />
            <div style={{
...
<AuthoritySources url="/learn/smart-contract-security-audit-guide-2026" />
</div>
