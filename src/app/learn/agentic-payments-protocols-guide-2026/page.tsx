...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Agentic Payments Protocols Guide 2026', },
  ],
};
    ...
    <>
      ...
      <div className="min-h-screen bg-[#0d1117] text-[#c9d1d9]">
        ...
        <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <LastUpdated pathKey="/learn/agentic-payments-protocols-guide-2026" />
          <ReadingTime />
          <AutoTOC />
          {/* Subtitle */}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Agentic Payments Protocols Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/agentic-payments-protocols-guide-2026"
            })
          }}
        />
