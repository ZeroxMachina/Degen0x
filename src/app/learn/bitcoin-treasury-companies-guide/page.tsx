...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Bitcoin Treasury Companies Guide', },
  ],
};
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 sm:px-6 py-12">
      ...
      <BackToTop />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Bitcoin Treasury Companies 2026: Who", "description": "172+ public companies hold Bitcoin on their balance sheets. How corporate BTC treasury strategies work, who the biggest holders are, and what it means for", "url": "https://degen0x.com/learn/bitcoin-treasury-companies-guide", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
