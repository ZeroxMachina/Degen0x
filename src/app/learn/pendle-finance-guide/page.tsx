...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Pendle Finance Guide', },
  ],
};
...
export default function PendleFinanceGuide() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <LastUpdated pathKey="/learn/pendle-finance-guide" />
      <ReadingTime />
      <AutoTOC />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Pendle Finance Guide",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/pendle-finance-guide"
            })
          }}
        />
...
<AuthoritySources url="/learn/pendle-finance-guide" />
</div>
  );
}
