  ...
  return (
    <article className="mx-auto max-w-3xl px-4 sm:px-6 py-12">
      ...
      <div className="mb-8">
        ...
        <LastUpdated pathKey="/learn/tokenized-treasuries-rwa-yield-guide-2026" />
        <ReadingTime />
        <AutoTOC />
        <p
          className="text-lg"
      ...
      <section className="pt-8 border-t" style={{ borderColor: "var(--color-border)" }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Tokenized Treasuries Guide 2026: RWA Yield, BUIDL, USDY &", "description": "Complete guide to tokenized U.S. Treasuries in 2026. Compare BlackRock BUIDL, Ondo USDY, Circle USYC yields. Learn how to earn 4-5% APY on-chain with", "url": "https://degen0x.com/learn/tokenized-treasuries-rwa-yield-guide-2026", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              "headline": "Tokenized Treasuries Rwa Yield Guide 2026",
              "author": { "@type": "Organization", "name": "degen0x" },
              "publisher": { "@type": "Organization", "name": "degen0x", "url": "https://degen0x.com" },
              "datePublished": "2026-04-01",
              "dateModified": "2026-04-12",
              "mainEntityOfPage": "https://degen0x.com/learn/tokenized-treasuries-rwa-yield-guide-2026"
            })
          }}
        />
