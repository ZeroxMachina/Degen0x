...
export const metadata: Metadata = {
  title: 'Crypto Airdrop Tax Treatment 2026: Ordinary Income, Cost Basis & Reporting | degen0x',
  description: 'Complete crypto airdrop tax guide 2026: ordinary income at FMV receipt, cost basis establishment, Uniswap UNI airdrop example, hard fork IRS Rev. Rul., unclaimed airdrops.',
