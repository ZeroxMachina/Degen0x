...
export const metadata: Metadata = {
  title: 'International Crypto Tax Comparison 2026: US vs Portugal vs Singapore vs UAE | degen0x',
  description: 'Compare crypto tax rates globally. US (37%), Portugal (0%), Singapore (0% gains), Germany (0% after 1 year), UAE (0%). OECD CARF reporting framework and tax residency strategies.',
