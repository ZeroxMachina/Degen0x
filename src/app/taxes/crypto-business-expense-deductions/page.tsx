...
export const metadata: Metadata = {
  title: "Crypto Business Expense Deductions 2026 | Mining Equipment,",
  description: "Deductible crypto business expenses: hardware wallets, mining equipment, electricity, software subscriptions, conference travel, education, Section 179, home",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Crypto Business Expense Deductions', },
  ],
};
...
export default function CryptoBusinessExpenseDeductions() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Crypto Business Expense Deductions 2026 | Mining Equipment,"
        description="Deductible crypto business expenses: hardware wallets, mining equipment, electricity, software subscriptions, conference travel, education, Section 179, home"
        url="https://degen0x.com/taxes/crypto-business-expense-deductions"
      ...
      />
        ...
        <LastUpdated pathKey="/taxes/crypto-business-expense-deductions" />
        <ReadingTime />
      </div>
<AuthoritySources url="/taxes/crypto-business-expense-deductions" />
