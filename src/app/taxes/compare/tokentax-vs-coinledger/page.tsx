...
const items: ComparisonItem[] = [
  { name: "TokenTax", slug: "tokentax", rating: 4.2, affiliateUrl: "https://cryptodegen.com/go/tokentax", features: { "Paid Plans": "From $65/year", "Exchanges": "100+", "DeFi Support": "Excellent", "Full-Service Filing": "Yes (VIP plan)", "Margin/Futures": "Yes", "International": "10+ countries", "TurboTax Integration": "CSV export", "CPA Support": "Yes" } },
  { name: "CoinLedger", slug: "coinledger", rating: 4.2, affiliateUrl: "https://cryptodegen.com/go/coinledger", features: { "Paid Plans": "From $49/year", "Exchanges": "400+", "DeFi Support": "Good", "Full-Service Filing": "No", "Margin/Futures": "Basic", "International": "US focused", "TurboTax Integration": "Direct integration", "CPA Support": "No" } },
];
...
export default function TokenTaxVsCoinLedgerPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-white mb-4">TokenTax vs CoinLedger: Full Comparison ({CURRENT_YEAR})</h1>
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
          <strong className="text-white">The short answer:</strong> TokenTax is better for advanced traders, margin and futures traders, and those wanting full-service CPA filing. CoinLedger is better for beginners and straightforward portfolios who want an easy filing process with TurboTax integration.
        </p>
      </div>
      ...
      <section className="mb-12 prose prose-invert max-w-none">
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Advanced Trading Support</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Full-Service Filing</h3>
