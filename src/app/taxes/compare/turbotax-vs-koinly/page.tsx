...
export default function TurboTaxVsKoinlyPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        headline="TurboTax vs Koinly 2026: Built-In Crypto vs Dedicated Tax Software"
        description="Compare TurboTax"
        url="https://degen0x.com/taxes/compare/turbotax-vs-koinly"
...
<AuthoritySources url="/taxes/compare/turbotax-vs-koinly" />
    </div>
  );
}
