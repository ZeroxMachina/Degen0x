...
const items: ComparisonItem[] = [
  { name: "CoinTracker", slug: "cointracker", rating: 4.3, affiliateUrl: "https://cryptodegen.com/go/cointracker", features: { "Free Tier": "Up to 25 transactions", "Paid Plans": "From $59/year", "Exchanges": "500+", "DeFi Support": "Good", "TurboTax Integration": "Direct one-click", "Portfolio Tracking": "Excellent real-time", "Tax Forms": "8949, Schedule D", "CPA Access": "No" } },
  { name: "ZenLedger", slug: "zenledger", rating: 4.0, affiliateUrl: "https://cryptodegen.com/go/zenledger", features: { "Free Tier": "Up to 25 transactions", "Paid Plans": "From $49/year", "Exchanges": "400+", "DeFi Support": "Good", "TurboTax Integration": "CSV export", "Portfolio Tracking": "Basic", "Tax Forms": "8949, Schedule D, FBAR", "CPA Access": "Yes (premium)" } },
];
...
export default function CoinTrackerVsZenLedgerPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-white mb-4">CoinTracker vs ZenLedger: Full Comparison ({CURRENT_YEAR})</h1>
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
          <strong className="text-white">The short answer:</strong> CoinTracker is better for self-filing users who want TurboTax integration and real-time portfolio tracking. ZenLedger is better for users who work with CPAs and need professional collaboration features or FBAR reporting.
        </p>
      </div>
      ...
      <section className="mb-12 prose prose-invert max-w-none">
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Portfolio Tracking</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Professional Features</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Pricing Comparison</h3>
