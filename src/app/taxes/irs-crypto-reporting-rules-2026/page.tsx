...
export const metadata: Metadata = {
  title: 'IRS Crypto Reporting Rules 2026: Form 1099-DA, Form 8949 & Digital Asset Question | degen0x',
  description: 'Complete guide to IRS crypto reporting 2026: Form 1099-DA (new), broker reporting, Form 1040 digital asset question, Form 8949, Schedule D, FBAR/FATCA requirements.',
