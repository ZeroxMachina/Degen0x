...
export const metadata: Metadata = {
  title: 'Crypto Staking Tax Guide: IRS Reporting, Cost Basis, Deductions | degen0x',
  description: 'Master crypto staking taxes: IRS guidance on ordinary income at FMV, cost basis establishment, validator vs delegation rewards. Jarrett v. IRS case, liquid staking events, foreign income.',
  keywords: [
