...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Crypto Staking Tax Guide', },
  ],
};
...
export default function CryptoStakingTaxGuide() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Crypto Staking Tax Guide: IRS Reporting, Cost Basis,"
        description="Master crypto staking taxes: IRS guidance on ordinary income at FMV, cost basis establishment, validator vs delegation rewards. Jarrett v. IRS case, liquid"
        url="https://degen0x.com/taxes/crypto-staking-tax-guide"
      ...
      />
        ...
        <LastUpdated pathKey="/taxes/crypto-staking-tax-guide" />
        <ReadingTime />
      </div>
<AuthoritySources url="/taxes/crypto-staking-tax-guide" />
