    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <article>
        <header className="mb-8">
          ...
          <div className="mt-4">
            <a
              href="https://cryptodegen.com/go/koinly"
              target="_blank"
        ...
        <section id="supported-integrations" className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">Supported Integrations</h2>
          <p className="text-[var(--color-text-secondary)] mb-4">
        ...
        <section id="tax-reports" className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">Tax Reports & Forms</h2>
          <p className="text-[var(--color-text-secondary)] mb-4">
        ...
        <section id="who-is-it-for" className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">Who Is Koinly Best For?</h2>
          <p className="text-[var(--color-text-secondary)] mb-4">
        ...
        <section id="verdict" className="mb-10">
          ...
          <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6">
            <div className="flex items-center gap-4 mb-4">
              <StarRating rating={4.8} size="lg" />
              <span className="text-lg font-semibold text-white">4.8 / 5.0</span>
            </div>
            <p className="text-[var(--color-text-secondary)] mb-4">
