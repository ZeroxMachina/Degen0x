...
export const metadata: Metadata = {
  title: 'Crypto Mining Tax Implications 2026: ASIC Depreciation & Deductions | degen0x',
  description: 'Complete guide to mining tax. Hobby vs business mining classification, self-employment tax, equipment depreciation (Section 179), electricity deductions, pool mining income timing, and home mining deductions.',
