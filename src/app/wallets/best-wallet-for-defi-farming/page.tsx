...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Best Wallet For Defi Farming', },
  ],
};
...
export default function BestWalletForDefiFarming() {
  ...
  return (
    <article id="top" style={{ background: "#0d1117", color: "#e6edf3", minHeight: "100vh", padding: "40px 20px", scrollBehavior: "smooth" }}>
      <ArticleSchema
        headline="Best wallet for DeFi farming | degen0x"
        description="MetaMask, Rabby, Phantom, Trust Wallet, Ledger for DeFi farming. Multi-chain, transaction simulation, approval management. 2026 DeFi wallet guide."
        url="https://degen0x.com/wallets/best-wallet-for-defi-farming"
      ...
      />
        ...
        <LastUpdated pathKey="/wallets/best-wallet-for-defi-farming" />
        <ReadingTime />
      </div>
<AuthoritySources url="/wallets/best-wallet-for-defi-farming" />
