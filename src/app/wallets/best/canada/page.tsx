  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        headline="Wallets"
        description="Wallets"
        url="/wallets/best/canada"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Wallets"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/best/canada" />
        <ReadingTime />
      </div>
<AuthoritySources url="/wallets/best/canada" />
      ...
      <RelatedContent category="tools" currentSlug="/wallets/best/canada" />
    </div>
  );
}
