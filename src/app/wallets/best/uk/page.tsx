...
export const metadata: Metadata = {
  title: `Best Crypto Wallets in the UK (2026)`,
  ...
  alternates: { canonical: "/wallets/best/uk" },
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      />
        ...
        <LastUpdated pathKey="/wallets/best/uk" />
        <ReadingTime />
      </div>
<AuthoritySources url="/wallets/best/uk" />
      ...
      <FAQSection faqs={faqs} />
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Wallets/best/uk", "description": "Crypto content on degen0x", "url": "https://degen0x.com/wallets/best/uk", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
          <div style={{
        marginTop: "32px",
        padding: "24px",
