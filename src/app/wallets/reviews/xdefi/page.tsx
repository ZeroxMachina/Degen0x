...
export default function XdefiReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="XDEFI Wallet Review (2026)"
        url="https://degen0x.com/wallets/reviews/xdefi"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="XDEFI Wallet Review (2026) | degen0x"
        description="XDEFI wallet review covering multi-chain DeFi support, cross-chain swaps, NFT management, and browser extension features."
        url="https://degen0x.com/wallets/reviews/xdefi"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/reviews/xdefi" />
        <ReadingTime />
      </div>
