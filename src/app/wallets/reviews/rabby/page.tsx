...
export default function RabbyReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="Rabby Wallet Review (2026) - Security-First EVM Wallet"
        url="https://degen0x.com/wallets/reviews/rabby"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Rabby Wallet Review (2026) - Security-First EVM Wallet | degen0x"
        description="Complete Rabby wallet review for ${CURRENT_YEAR}. Covers transaction simulation, auto chain detection, multi-chain EVM support, and DeFi security features."
        url="https://degen0x.com/wallets/reviews/rabby"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/reviews/rabby" />
        <ReadingTime />
      </div>
