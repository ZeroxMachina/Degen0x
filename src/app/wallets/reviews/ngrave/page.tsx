...
export const metadata: Metadata = {
  title: `NGRAVE Review (2026) | degen0x`,
...
export default function NgraveReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="NGRAVE Review (2026)"
        url="https://degen0x.com/wallets/reviews/ngrave"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="NGRAVE Review (2026) | degen0x"
        description="NGRAVE ZERO hardware wallet review covering EAL7 security certification, air-gapped QR signing, biometric authentication, and premium build quality."
        url="https://degen0x.com/wallets/reviews/ngrave"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/reviews/ngrave" />
        <ReadingTime />
      </div>
