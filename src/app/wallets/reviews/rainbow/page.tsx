...
export default function RainbowReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="Rainbow Wallet Review (2026) - Best Ethereum Mobile Wallet?"
        url="https://degen0x.com/wallets/reviews/rainbow"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Rainbow Wallet Review (2026) - Best Ethereum Mobile Wallet? | degen0x"
        description="Detailed Rainbow wallet review for ${CURRENT_YEAR}. Covers Ethereum and L2 support, NFT experience, swap features, and mobile-first design."
        url="https://degen0x.com/wallets/reviews/rainbow"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/reviews/rainbow" />
        <ReadingTime />
      </div>
