...
export default function SparrowReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="Sparrow Wallet Review (2026)"
        url="https://degen0x.com/wallets/reviews/sparrow"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Sparrow Wallet Review (2026) | degen0x"
        description="Sparrow Wallet review covering Bitcoin transaction analysis, PSBT support, hardware wallet integration, and privacy features for power users."
        url="https://degen0x.com/wallets/reviews/sparrow"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/reviews/sparrow" />
        <ReadingTime />
      </div>
