...
export default function TangemReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="Tangem Wallet Review (2026) - NFC Card Hardware Wallet"
        url="https://degen0x.com/wallets/reviews/tangem"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Tangem Wallet Review (2026) - NFC Card Hardware Wallet | degen0x"
        description="Tangem is a card-shaped hardware wallet using NFC technology and a secure chip (EAL6+). No batteries, no cables - just tap your phone to sign transactions."
        url="https://degen0x.com/wallets/reviews/tangem"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/reviews/tangem" />
        <ReadingTime />
      </div>
