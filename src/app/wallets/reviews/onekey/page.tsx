...
export default function OneKeyReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="OneKey Wallet Review (2026) - Open-Source Hardware Wallet"
        url="https://degen0x.com/wallets/reviews/onekey"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="OneKey Wallet Review (2026) - Open-Source Hardware Wallet | degen0x"
        description="OneKey is a fully open-source hardware wallet ecosystem offering multiple form factors (Classic, Mini, Pro, Touch) with broad chain support, competitive"
        url="https://degen0x.com/wallets/reviews/onekey"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/reviews/onekey" />
        <ReadingTime />
      </div>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbData) }} />
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Hardware Model Lineup", "description": "OneKey is a fully open-source hardware wallet ecosystem offering multiple form factors (Classic, Mini, Pro, Touch) with broad chain support, competitive", "url": "https://degen0x.com/wallets/reviews/onekey", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
