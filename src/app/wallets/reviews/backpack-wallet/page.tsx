...
export default function BackpackWalletReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="Backpack Wallet Review (2026)"
        url="https://degen0x.com/wallets/reviews/backpack-wallet"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Backpack Wallet Review (2026) | degen0x"
        description="Backpack Wallet review covering xNFT app platform, Solana and Ethereum support, built-in exchange features, and developer ecosystem."
        url="https://degen0x.com/wallets/reviews/backpack-wallet"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/reviews/backpack-wallet" />
        <ReadingTime />
      </div>
