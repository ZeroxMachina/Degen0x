...
export default function BestMultiChainWallet() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Best Multi-Chain Wallet 2026: Rabby (50+ Chains), MetaMask,"
        description="Multi-chain wallets: Rabby (50+ chains, auto-detect), MetaMask (custom RPCs), Zerion (15+ chains), Trust Wallet (100+)."
        url="https://degen0x.com/wallets/best-multi-chain-wallet"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Wallets"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/wallets/best-multi-chain-wallet" />
        <ReadingTime />
      </div>
<AuthoritySources url="/wallets/best-multi-chain-wallet" />
...
{/* section-footer */}
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Best Multi-Chain Wallet 2026: Rabby (50+ Chains), MetaMask,", "description": "Multi-chain wallets: Rabby (50+ chains, auto-detect), MetaMask (custom RPCs), Zerion (15+ chains), Trust Wallet (100+).", "url": "https://degen0x.com/wallets/best-multi-chain-wallet", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
