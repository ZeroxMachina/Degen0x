...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Rabby Wallet Review Guide', },
  ],
};
...
export default function RabbyWalletReview() {
  ...
  return (
    <article style={styles.article}>
      <ArticleSchema
        headline="Rabby Wallet Review: Safe Multi-Chain Signing"
        description="Complete Rabby wallet review: 9/10 rating by DeBank team. Transaction simulation, approval management, multi-chain auto-detection. Desktop only. Free forever."
        url="https://degen0x.com/wallets/rabby-wallet-review-guide"
      ...
      />
        ...
        <LastUpdated pathKey="/wallets/rabby-wallet-review-guide" />
        <ReadingTime />
      </div>
<AuthoritySources url="/wallets/rabby-wallet-review-guide" />
