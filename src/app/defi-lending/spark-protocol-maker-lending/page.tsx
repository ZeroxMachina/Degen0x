...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Spark Protocol Maker Lending', },
  ],
};
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      ...
      />
        ...
        <LastUpdated pathKey="/defi-lending/spark-protocol-maker-lending" />
        <ReadingTime />
      </div>
<AuthoritySources url="/defi-lending/spark-protocol-maker-lending" />
