...
export default function DriftReview() {
  return (
    <>
      <ReviewSchema
        itemName="Drift Protocol Review 2026: Perps, Lending & Pros/Cons"
        url="https://degen0x.com/defi-lending/reviews/drift"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Drift Protocol Review 2026: Perps, Lending & Pros/Cons"
        description="Complete Drift Protocol review covering perpetual futures, spot lending, insurance fund, and how this Solana trading platform compares to competitors."
        url="https://degen0x.com/defi-lending/reviews/drift"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Reviews"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/drift" />
        <ReadingTime />
      </div>
