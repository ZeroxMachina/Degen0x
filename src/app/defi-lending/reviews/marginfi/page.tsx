...
export default function MarginfiReview() {
  return (
    <>
      <ReviewSchema
        itemName="MarginFi Review 2026: Yield, Fees & Pros/Cons"
        url="https://degen0x.com/defi-lending/reviews/marginfi"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="MarginFi Review 2026: Yield, Fees & Pros/Cons"
        description="Comprehensive MarginFi review covering lending rates, borrowing features, points system, and whether this Solana lending protocol fits your DeFi strategy."
        url="https://degen0x.com/defi-lending/reviews/marginfi"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Reviews"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/marginfi" />
        <ReadingTime />
      </div>
