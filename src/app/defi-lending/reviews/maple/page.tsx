...
export default function MapleReview() {
  return (
    <>
      <ReviewSchema
        itemName="Maple Finance Review (2026)"
        url="https://degen0x.com/defi-lending/reviews/maple"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Maple Finance Review (2026) | degen0x"
        description="Maple Finance is an institutional lending protocol that connects corporate borrowers with DeFi lenders through managed lending pools run by professional credit"
        url="https://degen0x.com/defi-lending/reviews/maple"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/maple" />
        <ReadingTime />
      </div>
