...
export default function CentrifugeReview() {
  return (
    <>
      <ReviewSchema
        itemName="Centrifuge Review (2026): Real-World Asset DeFi Lending"
        url="https://degen0x.com/defi-lending/reviews/centrifuge"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Centrifuge Review (2026): Real-World Asset DeFi Lending | degen0x"
        description="In-depth Centrifuge review covering real-world asset tokenization, Tinlake pools, CFG token, and bridging traditional finance with DeFi lending."
        url="https://degen0x.com/defi-lending/reviews/centrifuge"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/centrifuge" />
        <ReadingTime />
      </div>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbData) }} />
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Tinlake Lending Pools", "description": "In-depth Centrifuge review covering real-world asset tokenization, Tinlake pools, CFG token, and bridging traditional finance with DeFi lending.", "url": "https://degen0x.com/defi-lending/reviews/centrifuge", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
