...
export default function PacFinanceReview() {
  return (
    <>
      <ReviewSchema
        itemName="Pac Finance Review 2026: Blast L2 Lending & Points"
        url="https://degen0x.com/defi-lending/reviews/pac-finance"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Pac Finance Review 2026: Blast L2 Lending & Points"
        description="In-depth Pac Finance review covering lending on Blast, points farming, yield strategies, and risk analysis for this Blast-native lending protocol."
        url="https://degen0x.com/defi-lending/reviews/pac-finance"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/pac-finance" />
        <ReadingTime />
      </div>
