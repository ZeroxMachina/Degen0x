...
export default function BastionReview() {
  return (
    <>
      <ReviewSchema
        itemName="Bastion Protocol Review 2026: NEAR Lending & Borrowing"
        url="https://degen0x.com/defi-lending/reviews/bastion"
        rating={4.0}
      ...
      sections={[
        { id: "lending-markets", title: "Lending & Borrowing Markets — Defi-Lending (defi-lending / reviews / bastion)", content: "Bastion operates pool-based lending markets where users supply assets to earn interest and borrow against their collateral. The protocol supports major Aurora assets including ETH, NEAR, USDC, USDT, and wNEAR. Interest rates adjust algorithmically based on utilization, following models similar to Compound. The protocol segments assets into different realms with isolated risk parameters, allowing support for both blue-chip and higher-risk assets without exposing the entire protocol. The main realm supports established assets with conservative parameters, while additional realms cater to stablecoins and ecosystem-specific tokens with tailored risk settings." },
    ...
    />
      <ArticleSchema
        headline="Bastion Protocol Review 2026: NEAR Lending & Borrowing"
        description="In-depth Bastion Protocol review covering lending markets on Aurora/NEAR, yield rates, stableswap features, and protocol risk analysis."
        url="https://degen0x.com/defi-lending/reviews/bastion"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Reviews"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/bastion" />
        <ReadingTime />
      </div>
