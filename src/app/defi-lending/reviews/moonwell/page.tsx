...
export default function MoonwellReview() {
  return (
    <>
      <ReviewSchema
        itemName="Moonwell Review 2026: Base & Moonbeam Lending Protocol"
        url="https://degen0x.com/defi-lending/reviews/moonwell"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Moonwell Review 2026: Base & Moonbeam Lending Protocol"
        description="Complete Moonwell review covering lending markets on Base and Moonbeam, yield rates, governance, safety features, and how it compares to alternatives."
        url="https://degen0x.com/defi-lending/reviews/moonwell"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Reviews"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/moonwell" />
        <ReadingTime />
      </div>
