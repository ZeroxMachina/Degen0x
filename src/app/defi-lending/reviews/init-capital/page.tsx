...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Init Capital', },
  ],
};
...
export default function InitCapitalReview() {
  return (
    <>
      <ReviewSchema
        itemName="Init Capital Review 2026: Composable Lending on Mantle"
        url="https://degen0x.com/defi-lending/reviews/init-capital"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Init Capital Review 2026: Composable Lending on Mantle"
        description="In-depth Init Capital review covering composable lending hooks, position management, yield strategies, and protocol design on Mantle network."
        url="https://degen0x.com/defi-lending/reviews/init-capital"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Reviews"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/init-capital" />
        <ReadingTime />
      </div>
