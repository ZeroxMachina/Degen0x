...
export default function SonneReview() {
  return (
    <>
      <ReviewSchema
        itemName="Sonne Finance Review 2026: Optimism & Base Lending"
        url="https://degen0x.com/defi-lending/reviews/sonne"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Sonne Finance Review 2026: Optimism & Base Lending"
        description="Complete Sonne Finance review covering Compound-style lending on Optimism and Base, yield rates, SONNE token incentives, and protocol risk analysis."
        url="https://degen0x.com/defi-lending/reviews/sonne"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/sonne" />
        <ReadingTime />
      </div>
