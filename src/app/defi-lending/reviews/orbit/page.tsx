...
export default function OrbitReview() {
  return (
    <>
      <ReviewSchema
        itemName="Orbit Protocol Review 2026: Blast Lending Platform"
        url="https://degen0x.com/defi-lending/reviews/orbit"
        rating={4.0}
      ...
      sections={[
        { id: "blast-integration", title: "Blast Native Yield Integration — Defi-Lending (defi-lending / reviews / orbit)", content: "Orbit Protocol deeply integrates with Blast L2's native yield mechanism, where ETH deposits earn staking yield and stablecoins earn T-bill yield at the network level. Orbit's lending pools capture this native yield and pass it through to depositors, creating a base yield floor that does not depend on borrowing demand. This means that even in low-utilization periods, depositors earn returns from the Blast native yield. On top of this base yield, standard lending interest from borrowers provides additional returns. This dual-yield structure is unique to Blast-based lending protocols and creates a compelling value proposition for yield seekers." },
    ...
    />
      <ArticleSchema
        headline="Orbit Protocol Review 2026: Blast Lending Platform"
        description="Detailed Orbit Protocol review covering lending on Blast L2, native yield integration, borrowing markets, and risk assessment for this Blast-native protocol."
        url="https://degen0x.com/defi-lending/reviews/orbit"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/defi-lending/reviews/orbit" />
        <ReadingTime />
      </div>
