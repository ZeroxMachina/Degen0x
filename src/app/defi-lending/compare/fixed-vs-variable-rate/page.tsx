...
const items: ComparisonItem[] = [
  { name: "Variable Rate", slug: "defi-lending", rating: 4.5, affiliateUrl: "https://cryptodegen.com/go/aave", features: { "Rate Predictability": "Low (changes every block)", "Average Rates": "Often lower than fixed", "Liquidity": "Instant entry/exit", "Protocols": "Aave, Compound, Morpho", "Lock-up Required": "None", "Best Market": "Stable or declining rates", "Complexity": "Simple", "Risk": "Rate volatility" } },
  { name: "Fixed Rate", slug: "defi-lending", rating: 4.2, affiliateUrl: "https://cryptodegen.com/go/notional", features: { "Rate Predictability": "High (locked for term)", "Average Rates": "Includes certainty premium", "Liquidity": "Term-based (limited early exit)", "Protocols": "Notional, Pendle, Term", "Lock-up Required": "Yes (term maturity)", "Best Market": "Rising rate environment", "Complexity": "Moderate", "Risk": "Opportunity cost, liquidity" } },
];
...
export default function FixedVsVariableRatePage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-white mb-4">Fixed vs Variable Rate DeFi Lending ({CURRENT_YEAR})</h1>
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
          <strong className="text-white">The short answer:</strong> Variable rates are better for short-term, flexible positions. Fixed rates are better for long-term planning and protection against rate increases. Most users benefit from a mix of both based on their time horizon and risk tolerance.
        </p>
      </div>
      ...
      <section className="mb-12 prose prose-invert max-w-none">
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Rate Behavior</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Protocol Availability</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Strategy Implications</h3>
