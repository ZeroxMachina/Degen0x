...
const items: ComparisonItem[] = [
  { name: "Ethereum DeFi", slug: "defi-lending", rating: 4.7, affiliateUrl: "https://cryptodegen.com/go/aave", features: { "Total DeFi TVL": "$50B+", "Top Protocols": "Aave, Compound, Morpho", "Transaction Fees": "$1-50+", "Block Time": "12 seconds", "Composability": "Deepest ecosystem", "Security Track Record": "Longest in DeFi", "L2 Options": "Arbitrum, Optimism, Base", "Unique Advantage": "Maximum liquidity and composability" } },
  { name: "Solana DeFi", slug: "crypto-loans", rating: 4.3, affiliateUrl: "https://cryptodegen.com/go/solana", features: { "Total DeFi TVL": "$8B+", "Top Protocols": "Kamino, Marginfi, Solend", "Transaction Fees": "<$0.01", "Block Time": "400ms", "Composability": "Growing ecosystem", "Security Track Record": "Shorter, some incidents", "L2 Options": "None needed", "Unique Advantage": "Speed and minimal fees" } },
];
...
export default function EthereumVsSolanaDefiPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-white mb-4">Ethereum vs Solana DeFi Lending ({CURRENT_YEAR})</h1>
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
          <strong className="text-white">The short answer:</strong> Ethereum (including L2s) is better for large positions, maximum composability, and battle-tested security. Solana is better for smaller positions, frequent transactions, and users who value speed and minimal fees above all else.
        </p>
      </div>
      ...
      <section className="mb-12 prose prose-invert max-w-none">
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Cost of Participation</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Protocol Maturity</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Available Strategies</h3>
