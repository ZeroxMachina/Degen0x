...
const items: ComparisonItem[] = [
  { name: "Overcollateralized", slug: "defi-lending", rating: 4.6, affiliateUrl: "https://cryptodegen.com/go/aave", features: { "Collateral Required": "100-150%+ of loan", "Default Risk": "Near zero (auto-liquidation)", "KYC Required": "No", "Typical Yields": "3-8% stablecoins", "Access": "Permissionless", "Protocols": "Aave, Compound, Maker", "Capital Efficiency": "Low", "Best For": "Trustless, permissionless lending" } },
  { name: "Undercollateralized", slug: "defi-lending", rating: 3.9, affiliateUrl: "https://cryptodegen.com/go/maple", features: { "Collateral Required": "0-100% of loan", "Default Risk": "Material (credit risk)", "KYC Required": "Usually yes", "Typical Yields": "5-15%", "Access": "Often permissioned", "Protocols": "Maple, Goldfinch, TrueFi", "Capital Efficiency": "High", "Best For": "Higher yield with credit exposure" } },
];
...
export default function OverVsUndercollateralizedPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-white mb-4">Overcollateralized vs Undercollateralized Lending ({CURRENT_YEAR})</h1>
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
          <strong className="text-white">The short answer:</strong> Overcollateralized lending is safer with lower yields and is suitable for most DeFi users. Undercollateralized lending offers higher yields but introduces credit risk and is better suited for experienced investors who can evaluate borrower quality.
        </p>
      </div>
      ...
      <section className="mb-12 prose prose-invert max-w-none">
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Yield Comparison</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">The Future of DeFi Credit</h3>
