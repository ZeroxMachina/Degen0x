...
export default function OverVsUndercollateralizedPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        headline="Overcollateralized vs Undercollateralized DeFi Lending 2026"
        description="Compare overcollateralized and undercollateralized DeFi lending in ${CURRENT_YEAR}. Understand risk profiles, yields, use cases, and protocol examples."
        url="https://degen0x.com/defi-lending/compare/overcollateralized-vs-undercollateralized"
...
<AuthoritySources url="/defi-lending/compare/overcollateralized-vs-undercollateralized" />
    </div>
  );
}
