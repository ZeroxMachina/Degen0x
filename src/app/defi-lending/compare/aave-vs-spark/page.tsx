...
export const metadata: Metadata = {
  title: `Aave vs Spark 2026: Which DeFi Lending Protocol Is Better?`,
...
export default function AaveVsSparkPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        headline="Aave vs Spark 2026: Which DeFi Lending Protocol Is Better?"
        description="Detailed comparison of Aave vs Spark in ${CURRENT_YEAR}. Compare yields, features, DAI integration, multi-chain support, and risk management approaches."
        url="https://degen0x.com/defi-lending/compare/aave-vs-spark"
      ...
      <LastUpdated pathKey="/defi-lending/compare/aave-vs-spark" />
      ...
      <CompareSchema
        title="Aave vs Spark — degen0x"
        url="/defi-lending/compare/aave-vs-spark"
        description="A head-to-head look at Aave and Spark: product, fees, risk, and who each one is built for."
        items={["Aave", "Spark"]}
      />
...
<AuthoritySources url="/defi-lending/compare/aave-vs-spark" />
    </div>
  );
}
