...
export default function MapleVsGoldfinchPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-white mb-4">Maple vs Goldfinch: Full Comparison ({CURRENT_YEAR})</h1>
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
          <strong className="text-white">The short answer:</strong> Choose Maple for institutional credit exposure with crypto-native borrowers and more liquid positions. Choose Goldfinch for real-world asset yield diversification with emerging market exposure and potentially higher returns.
        </p>
      </div>
      ...
      <section className="mb-12 prose prose-invert max-w-none">
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Credit Risk Profiles</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Default History</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Liquidity Considerations</h3>
