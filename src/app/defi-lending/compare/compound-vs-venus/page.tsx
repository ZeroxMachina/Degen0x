...
const items: ComparisonItem[] = [
  { name: "Compound", slug: "compound", rating: 4.6, affiliateUrl: "https://cryptodegen.com/go/compound", features: { "TVL": "$3B+", "Primary Chain": "Ethereum", "Chains": "3", "Architecture": "Isolated markets V3", "Governance Token": "COMP", "Supported Assets": "20+", "Rate Model": "Variable only", "Unique Feature": "Single-asset risk isolation" } },
  { name: "Venus", slug: "venus", rating: 4.2, affiliateUrl: "https://cryptodegen.com/go/venus", features: { "TVL": "$2B+", "Primary Chain": "BNB Chain", "Chains": "1", "Architecture": "Pool-based V4", "Governance Token": "XVS", "Supported Assets": "30+", "Rate Model": "Variable", "Unique Feature": "VAI stablecoin, low fees" } },
];
...
export default function CompoundVsVenusPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-white mb-4">Compound vs Venus: Full Comparison ({CURRENT_YEAR})</h1>
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
          <strong className="text-white">The short answer:</strong> Compound is better for Ethereum users who prioritize security track record and the broader Ethereum DeFi ecosystem. Venus is better for BNB Chain users who want low fees and access to BNB-native assets.
        </p>
      </div>
      ...
      <section className="mb-12 prose prose-invert max-w-none">
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Fee Environment</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Architecture Differences</h3>
        ...
        <h3 className="text-xl font-bold text-white mt-6 mb-3">Ecosystem and Composability</h3>
