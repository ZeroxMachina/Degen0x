...
export default function CurveVsUniswapPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        headline="Curve vs Uniswap 2026: Which DEX Is Better?"
        description="Detailed comparison of Curve vs Uniswap in ${CURRENT_YEAR}. Compare liquidity, fees, stablecoin trading, concentrated liquidity, and which DEX is right for your needs."
        url="https://degen0x.com/defi-lending/compare/curve-vs-uniswap"
      ...
      <LastUpdated pathKey="/defi-lending/compare/curve-vs-uniswap" />
...
<AuthoritySources url="/defi-lending/compare/curve-vs-uniswap" />
    </div>
  );
}
