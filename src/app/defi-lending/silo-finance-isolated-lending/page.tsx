...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Silo Finance Isolated Lending', },
  ],
};
...
export default function SiloFinanceIsolatedLending() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Silo Finance Isolated Lending | degen0x"
        description="Silo Finance Isolated Lending guide for 2026. Compare options, understand risks, and get started with actionable strategies. Updated April 2026."
        url="https://degen0x.com/defi-lending/silo-finance-isolated-lending"
      ...
      />
        ...
        <LastUpdated pathKey="/defi-lending/silo-finance-isolated-lending" />
        <ReadingTime />
      </div>
<AuthoritySources url="/defi-lending/silo-finance-isolated-lending" />
...
{/* section-footer */}
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Silo Finance Isolated Lending | degen0x", "description": "Silo Finance Isolated Lending guide for 2026. Compare options, understand risks, and get started with actionable strategies. Updated April 2026.", "url": "https://degen0x.com/defi-lending/silo-finance-isolated-lending", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
      <nav style={{ marginTop: "2rem", padding: "1rem", borderTop: "1px solid #30363d", fontSize: "14px" }}>
  <span style={{ color: "#8b949e" }}>Related: </span>
  <a href="/defi-lending/reviews/lido" style={{ color: "#fb923c", marginRight: "1rem" }}>Lido</a>
  <a href="/defi-lending/reviews/notional" style={{ color: "#fb923c", marginRight: "1rem" }}>Notional</a>
  <a href="/defi-lending/reviews/morpho" style={{ color: "#fb923c", marginRight: "1rem" }}>Morpho</a>
  <a href="/defi-lending/reviews/zerolend" style={{ color: "#fb923c", marginRight: "1rem" }}>Zerolend</a>
  <a href="/defi-lending/reviews/tender" style={{ color: "#fb923c", marginRight: "1rem" }}>Tender</a>
</nav>
      </article>
  );
}
