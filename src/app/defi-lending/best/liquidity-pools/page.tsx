    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-[var(--color-text)] mb-4">Best Liquidity Pools ({CURRENT_YEAR})</h1>
        ...
        <p style={{ color: "#9CA3AF", lineHeight: "1.7", marginBottom: "1.5rem" }}>
          Liquidity pools on Curve, Uniswap, and Balancer generate yields through trading fees and governance rewards, averaging 5–20% APY. LP positions carry impermanent loss risk, making pool selection critical for net returns.
