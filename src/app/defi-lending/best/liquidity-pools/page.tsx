...
const products: Product[] = [
  {
    ...
    slug: "curve",
    rating: 4.7,
    description: "Curve Finance dominates stablecoin and pegged-asset liquidity pools with its specialized AMM design that minimizes slippage. LPs earn trading fees plus CRV gauge incentives, and pools can be boosted through veCRV voting for significantly enhanced yields.",
  ...
  },
  {
    ...
    affiliateUrl: "https://cryptodegen.com/go/uniswap",
    category: "defi-lending",
  },
  {
    name: "Balancer",
    ...
    affiliateUrl: "https://cryptodegen.com/go/balancer",
    category: "defi-lending",
  },
  {
    name: "Aerodrome",
    ...
    affiliateUrl: "https://cryptodegen.com/go/aerodrome",
    category: "defi-lending",
  },
];
...
export default function LiquidityPoolsPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <AffiliateDisclosure />
      <h1 className="text-4xl font-bold text-white mb-4">Best Liquidity Pools ({CURRENT_YEAR})</h1>
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
          For stablecoin LPs, <strong className="text-white">Curve Finance</strong> remains the clear leader with its purpose-built AMM. Active LPs should consider <strong className="text-white">Uniswap V3</strong> concentrated liquidity for superior capital efficiency. On Base L2, <strong className="text-white">Aerodrome</strong> offers some of the highest LP yields available anywhere.
        </p>
      </div>
