...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Morpho Protocol Lending Guide', },
  ],
};
...
export default function MorphoProtocolLendingGuide() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Morpho Protocol Lending Guide 2026: Blue, Optimizer & $1B"
        description="Complete guide to Morpho Protocol lending. Learn about Morpho Blue peer-to-peer matching, optimized rates, $1B+ TVL, and curated vaults for DeFi yield."
        url="https://degen0x.com/defi-lending/morpho-protocol-lending-guide"
      ...
      />
        ...
        <LastUpdated pathKey="/defi-lending/morpho-protocol-lending-guide" />
        <ReadingTime />
      </div>
<AuthoritySources url="/defi-lending/morpho-protocol-lending-guide" />
