...
const items: ComparisonItem[] = [
  { name: "OKX", slug: "okx", rating: 4.6, affiliateUrl: "https://cryptodegen.com/go/okx", features: { "Trading Fees": "0.08% maker / 0.1% taker", "Coins Listed": "350+", "Futures": "Up to 125x leverage", "Web3 Wallet": "Yes (80+ chains)", "Options": "Yes", "Margin": "Yes (up to 10x)", "Headquarters": "Seychelles / Dubai", "US Available": "No" } },
  { name: "Coinbase", slug: "coinbase", rating: 4.6, affiliateUrl: "https://cryptodegen.com/go/coinbase", features: { "Trading Fees": "0.4%–0.6% (varies)", "Coins Listed": "250+", "Futures": "Limited (US derivatives)", "Web3 Wallet": "Yes (Coinbase Wallet)", "Options": "No", "Margin": "No (discontinued)", "Headquarters": "San Francisco, USA", "US Available": "Yes" } },
];
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose-crypto mt-12">
        <h2 className="text-2xl font-bold text-white mb-4">The Regulatory Difference</h2>
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Cryptocurrency Selection</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Advanced Trading Features</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Web3 & Self-Custody Integration</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">User Experience & Interface</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Mobile Apps</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Security & Custody</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Staking & Earn Products</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 mb-8">
          <p className="text-[var(--color-text-secondary)] leading-relaxed">
            <strong className="text-white">Choose Coinbase if</strong> you are in the United States, are relatively new to crypto, value regulatory clarity and transparency, prioritize a simple, intuitive interface, and primarily want to buy and hold cryptocurrencies. Coinbase is the best exchange for beginners and long-term investors who want maximum safety and compliance.
          </p>
          <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
            <strong className="text-white">Choose OKX if</strong> you are outside the US or a more experienced trader, want the lowest fees, need derivatives access (futures, options, leverage), want integrated Web3 and DeFi capabilities, and trade frequently. OKX is essential for professional traders, derivatives specialists, and anyone bridging CeFi and DeFi ecosystems.
          </p>
          <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4">
