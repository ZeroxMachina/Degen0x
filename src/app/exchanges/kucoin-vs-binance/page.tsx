...
const items: ComparisonItem[] = [
  { name: "KuCoin", slug: "kucoin", rating: 4.5, affiliateUrl: "https://cryptodegen.com/go/kucoin", features: { "Trading Fees": "0.1% spot (0.08% with KCS)", "Coins Listed": "800+", "Futures": "Up to 100x leverage", "Trading Bots": "Yes (built-in)", "Token Variety": "Best in class", "Daily Volume": "$2B+", "Founded": "2017", "Headquarters": "Seychelles / Hong Kong" } },
  { name: "Binance", slug: "binance", rating: 4.7, affiliateUrl: "https://cryptodegen.com/go/binance", features: { "Trading Fees": "0.1% spot (0.075% with BNB)", "Coins Listed": "600+", "Futures": "Up to 125x leverage", "Trading Bots": "Yes (grid, DCA, copy)", "Token Variety": "Broad but selective", "Daily Volume": "$15B+", "Founded": "2017", "Headquarters": "Global / UAE" } },
];
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose-crypto mt-12">
        <h2 className="text-2xl font-bold text-white mb-4">Altcoin Selection & Token Listings</h2>
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Trading Bots & Automation</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Liquidity & Trading Volume</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Futures & Leverage</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Ecosystem & Native Tokens</h2>
        <p className="text-[var(--color-text-secondary)] mb-4 leading-relaxed">
