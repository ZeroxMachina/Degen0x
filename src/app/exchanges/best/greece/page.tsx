...
export const metadata: Metadata = {
  title: `Best Crypto Exchanges in Greece (${CURRENT_YEAR}) | CryptoDegen`,
...
export default function BestExchangesGreece() {
  return (
    <LearnPageLayout
      ...
      toc={[
        { id: "top-exchanges", title: "Top Exchanges for Greece", level: 2 },
        { id: "regulation", title: "Crypto Regulation in Greece", level: 2 },
