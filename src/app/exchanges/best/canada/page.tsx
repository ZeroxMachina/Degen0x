...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/exchanges/best/canada" },
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        ...
        url="/exchanges/best/canada"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Exchanges"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/exchanges/best/canada" />
        <ReadingTime />
      </div>
<AuthoritySources url="/exchanges/best/canada" />
      ...
      <FAQSection faqs={faqs} />
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Exchanges/best/canada", "description": "Crypto content on degen0x", "url": "https://degen0x.com/exchanges/best/canada", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
          <div style={{
        marginTop: "32px",
        padding: "24px",
