...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Us', },
  ],
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        ...
        url="/exchanges/best/us"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Exchanges"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/exchanges/best/us" />
        <ReadingTime />
      </div>
<AuthoritySources url="/exchanges/best/us" />
      ...
      <FAQSection faqs={faqs} />
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Exchanges/best/us", "description": "Crypto content on degen0x", "url": "https://degen0x.com/exchanges/best/us", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
          <div style={{
        marginTop: "32px",
        padding: "24px",
      ...
      <RelatedContent category="tools" currentSlug="/exchanges/best/us" />
    </div>
  );
}
