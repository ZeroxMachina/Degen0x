  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <FAQSection faqs={faqs} />
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Exchanges/best/altcoins", "description": "Crypto content on degen0x", "url": "https://degen0x.com/exchanges/best/altcoins"}) }} />
          <div style={{
        marginTop: "32px",
        padding: "24px",
