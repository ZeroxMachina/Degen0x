...
export default function CexFeesComparisonPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="Crypto Exchange Fees Compared: Complete Guide (2026) | degen0x"
        description="Compare trading fees across all major crypto exchanges. Side-by-side fee tables for Binance, Coinbase, Kraken, Bybit, OKX, and more."
        url="https://degen0x.com/exchanges/compare/cex-fees-comparison"
...
<AuthoritySources url="/exchanges/compare/cex-fees-comparison" />
    </div>
  );
}
