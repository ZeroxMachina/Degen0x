...
export default function CoinbaseVsCashAppPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="Coinbase vs Cash App: Which Is Better for Bitcoin? (2026) | degen0x"
        description="Detailed comparison of Coinbase vs Cash App for buying Bitcoin. Compare fees, features, and capabilities to find the right platform for you."
        url="https://degen0x.com/exchanges/compare/coinbase-vs-cash-app"
...
<AuthoritySources url="/exchanges/compare/coinbase-vs-cash-app" />
    </div>
  );
}
