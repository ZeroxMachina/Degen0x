...
export default function CoinbaseVsPayPalPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="Coinbase vs PayPal: Which Is Better for Crypto? (2026) | degen0x"
        description="Detailed comparison of Coinbase vs PayPal for crypto. Compare fees, coin selection, features, and which platform is best for buying cryptocurrency."
        url="https://degen0x.com/exchanges/compare/coinbase-vs-paypal"
...
<AuthoritySources url="/exchanges/compare/coinbase-vs-paypal" />
    </div>
  );
}
