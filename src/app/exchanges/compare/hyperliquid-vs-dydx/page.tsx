...
export default function HyperliquidVsDydxPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="Hyperliquid vs dYdX: Best Decentralized Perps? (2026) | degen0x"
        description="Detailed comparison of Hyperliquid vs dYdX for decentralized perpetual futures trading. Compare fees, speed, liquidity, and features."
        url="https://degen0x.com/exchanges/compare/hyperliquid-vs-dydx"
      ...
      <CompareSchema
        title="Hyperliquid vs Dydx — degen0x"
        url="/exchanges/compare/hyperliquid-vs-dydx"
        description="A head-to-head look at Hyperliquid and Dydx: product, fees, risk, and who each one is built for."
        items={["Hyperliquid", "Dydx"]}
      />
...
<AuthoritySources url="/exchanges/compare/hyperliquid-vs-dydx" />
    </div>
  );
}
