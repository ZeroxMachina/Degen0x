...
export default function CentralizedVsDecentralizedPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <AffiliateDisclosure />
      <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Centralized vs Decentralized Exchanges: Which Should You Use in {CURRENT_YEAR}?</h1>
      ...
      <div className="prose-crypto">
        <h2 className="text-2xl font-bold text-white mb-4">Custody and Security</h2>
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Fees and Cost Structure</h2>
        ...
        <h2 className="text-2xl font-bold text-white mb-4">Features and Accessibility</h2>
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 mb-8">
          <p className="text-[var(--color-text-secondary)] leading-relaxed"><strong className="text-white">Choose a CEX if</strong> you want fiat on-ramps, customer support, regulatory protection, and a simple interface. Best for beginners, fiat-to-crypto conversion, and high-frequency trading on major pairs.</p>
          <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4"><strong className="text-white">Choose a DEX if</strong> you want self-custody, access to any token, no KYC requirements, and composability with DeFi protocols. Best for experienced users who prioritize control and want access to the full token universe.</p>
          <p className="text-[var(--color-text-secondary)] leading-relaxed mt-4"><strong className="text-white">Best approach:</strong> Use both. Buy crypto with fiat on a CEX, then transfer to your wallet for DEX trading and DeFi participation.</p>
        </div>
      </div>
