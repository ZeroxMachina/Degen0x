...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Centralized Vs Decentralized', },
  ],
};
...
export default function CentralizedVsDecentralizedPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="Centralized vs Decentralized Exchanges: Full Comparison (2026) | degen0x"
        description="Complete comparison of centralized (CEX) vs decentralized (DEX) crypto exchanges. Understand fees, security, custody, and which type is right for you."
        url="https://degen0x.com/exchanges/compare/centralized-vs-decentralized"
      ...
      <LastUpdated pathKey="/exchanges/compare/centralized-vs-decentralized" />
...
<AuthoritySources url="/exchanges/compare/centralized-vs-decentralized" />
    </div>
  );
}
