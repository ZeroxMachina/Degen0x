...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Kraken Vs Coinbase', },
  ],
};
...
export default function KrakenVsCoinbasePage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="Kraken vs Coinbase (2026): Fees, Security & Features Compared | degen0x"
        description="Kraken vs Coinbase in-depth comparison for ${CURRENT_YEAR}. We compare fees, staking, security, and pro trading tools from Kraken"
        url="https://degen0x.com/exchanges/compare/kraken-vs-coinbase"
      ...
      />
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Exchanges/compare/kraken Vs Coinbase", "description": "Crypto content on degen0x", "url": "https://degen0x.com/exchanges/compare/kraken-vs-coinbase", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
          <div style={{
        marginTop: "32px",
        padding: "24px",
