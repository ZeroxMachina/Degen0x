...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Bitstamp', },
  ],
};
...
export default function BitstampReview() {
  return (
    <div className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
      <ArticleSchema
        headline="Bitstamp Review 2026: Legacy Exchange, Security, Trading"
        description="In-depth Bitstamp review covering one of the oldest crypto exchanges, security track record, regulatory compliance, and trading features. Updated March 2026."
        url="/exchanges/bitstamp"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Exchanges"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/exchanges/bitstamp" />
        <ReadingTime />
      </div>
<AuthoritySources url="/exchanges/bitstamp" />
