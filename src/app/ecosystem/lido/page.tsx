...
<div style={{padding:"16px 24px"}}><Breadcrumb items={[{label:"Home",href:"/"},{label:"Ecosystem",href:"/ecosystem"},{label:"Lido"}]} /></div>
<article style={{maxWidth:860,margin:"0 auto",padding:"48px 24px 80px"}}>
<div style={{display:"flex",alignItems:"center",gap:20,marginBottom:32,flexWrap:"wrap"}}>
<div role="img" aria-label="Lido Finance liquid staking icon" style={{width:64,height:64,background:`${C}20`,borderRadius:16,display:"flex",alignItems:"center",justifyContent:"center",fontSize:36,border:`1px solid ${C}40`}}>🌊</div>
<div>
...
<a href="https://stake.lido.fi" target="_blank" rel="noopener noreferrer" aria-label="Open Lido staking app (opens in new tab)" style={{padding:"12px 20px",minHeight:44,display:"inline-flex",alignItems:"center",background:C,color:"#fff",borderRadius:8,fontWeight:700,fontSize:13,textDecoration:"none"}}>Open Lido ↗</a>
<Link href="/quiz" aria-label="Take the Lido quiz and earn 150 XP" style={{padding:"12px 20px",minHeight:44,display:"inline-flex",alignItems:"center",background:`${S.purple}20`,color:S.purple,border:`1px solid ${S.purple}40`,borderRadius:8,fontWeight:700,fontSize:13,textDecoration:"none"}}>Take Quiz +150 XP</Link>
</div>
</div>
