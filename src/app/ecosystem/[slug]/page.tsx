    ...
    <div className="min-h-screen bg-[#000000] text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        />
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "dApp Not Found | degen0x", "description": "Crypto content on degen0x", "url": "https://degen0x.com/ecosystem/[slug]", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
          <div style={{
        marginTop: "32px",
        padding: "24px",
