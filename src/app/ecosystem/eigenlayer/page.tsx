...
const C="#6366f1";
export default function EigenLayerGuidePage(){return(<main style={{backgroundColor:S.bg,color:S.text,minHeight:"100vh",fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>
<div style={{borderBottom:`1px solid ${S.border}`,padding:"16px 24px",display:"flex",gap:8,fontSize:13,color:S.text2}}><Link href="/" style={{color:C,textDecoration:"none"}}>Home</Link><span>/</span><Link href="/ecosystem" style={{color:C,textDecoration:"none"}}>Ecosystem</Link><span>/</span><span style={{color:S.text}}>EigenLayer</span></div>
...
{["AVS","Category","What it Does"].map(h=><th key={h} style={{padding:"10px 12px",textAlign:"left",color:S.text2,fontWeight:600,fontSize:11}}>{h}</th>)}
</tr></thead>
<tbody>
...
<a href="https://app.eigenlayer.xyz" target="_blank" rel="noopener noreferrer" style={{padding:"10px 20px",background:C,color:"#fff",borderRadius:8,fontWeight:700,fontSize:13,textDecoration:"none"}}>Open EigenLayer ↗</a>
<Link href="/quiz" style={{padding:"10px 20px",background:`${S.purple}20`,color:S.purple,border:`1px solid ${S.purple}40`,borderRadius:8,fontWeight:700,fontSize:13,textDecoration:"none"}}>Take Quiz +200 XP</Link>
</div>
</div>
