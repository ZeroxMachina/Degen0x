...
export default function OdosGuidePage() {
  return (
    <main style={{ backgroundColor: S.bg, color: S.text, minHeight: "100vh", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      <div style={{ borderBottom: `1px solid ${S.border}`, padding: "16px 24px", display: "flex", gap: 8, fontSize: 13, color: S.text2 }}>
        ...
        <span>/</span>
        <span style={{ color: S.text }}>Odos</span>
      </div>
      ...
      <article style={{ maxWidth: 860, margin: "0 auto", padding: "48px 24px 80px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 32 }}>
          ...
          <div>
            ...
            <h1 style={{ fontSize: "2rem", fontWeight: 900, lineHeight: 1.2, margin: 0 }}>Odos: Multi-Input DEX Aggregator</h1>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <p style={{ color: S.text2, lineHeight: 1.8 }} dangerouslySetInnerHTML={{ __html: "Odos is the first DEX aggregator to support multi-input, multi-output token swaps. Instead of making three separate swaps to rebalance a portfolio, Odos lets you swap [USDC + WETH + ARB] → [ETH + USDT] in a single transaction, saving gas and getting better rates through its Smart Order Router (SOR) that evaluates 1000+ routing paths." }} />
        </section>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <div style={{ display: "flex", gap: 16, marginBottom: 20 }}>
            <div style={{ width: 32, height: 32, borderRadius: "50%", background: `#06b6d420`, border: `1px solid #06b6d440`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 800, color: "#06b6d4", flexShrink: 0 }}>1</div>
            <div>
              <div style={{ fontWeight: 700, marginBottom: 4 }}>Single Token Swaps</div>
              <div style={{ color: "#8b949e", lineHeight: 1.7, fontSize: 14 }}>Like any DEX aggregator — enter a token pair and Odos routes across all DEXes on the selected chain for the best rate.</div>
            </div>
          </div>
          <div style={{ display: "flex", gap: 16, marginBottom: 20 }}>
            <div style={{ width: 32, height: 32, borderRadius: "50%", background: `#06b6d420`, border: `1px solid #06b6d440`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 800, color: "#06b6d4", flexShrink: 0 }}>2</div>
            <div>
              <div style={{ fontWeight: 700, marginBottom: 4 }}>Multi-Input Swaps</div>
              <div style={{ color: "#8b949e", lineHeight: 1.7, fontSize: 14 }}>The killer feature: input up to 6 tokens simultaneously in one transaction. Ideal for portfolio rebalancing without chaining swaps.</div>
            </div>
          </div>
          <div style={{ display: "flex", gap: 16, marginBottom: 20 }}>
            <div style={{ width: 32, height: 32, borderRadius: "50%", background: `#06b6d420`, border: `1px solid #06b6d440`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 800, color: "#06b6d4", flexShrink: 0 }}>3</div>
            <div>
              <div style={{ fontWeight: 700, marginBottom: 4 }}>Smart Order Router</div>
              <div style={{ color: "#8b949e", lineHeight: 1.7, fontSize: 14 }}>Odos evaluates 1000+ possible routing combinations simultaneously using integer linear programming, maximizing output.</div>
            </div>
          </div>
          <div style={{ display: "flex", gap: 16, marginBottom: 20 }}>
            <div style={{ width: 32, height: 32, borderRadius: "50%", background: `#06b6d420`, border: `1px solid #06b6d440`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 800, color: "#06b6d4", flexShrink: 0 }}>4</div>
            <div>
              <div style={{ fontWeight: 700, marginBottom: 4 }}>Referral System</div>
              <div style={{ color: "#8b949e", lineHeight: 1.7, fontSize: 14 }}>Integrate Odos into your dApp via the Odos API and earn a referral fee from positive slippage on every swap you route.</div>
            </div>
          </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: 36 }}>
          ...
          <div style={{ background: `#f8514920`, border: "1px solid #f8514940", borderRadius: 12, padding: "20px 24px" }}>
            ...
            <li style={{ marginBottom: 8, paddingLeft: 8 }}>MEV risk on large swaps</li>
            </ul>
          </div>
        </section>
