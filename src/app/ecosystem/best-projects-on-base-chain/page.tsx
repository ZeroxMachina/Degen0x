...
export default function BestProjectsBase() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Best Projects on Base Chain 2026: Aerodrome, Morpho,"
        description="Top Base projects: Aerodrome (DEX), Friend.tech/Farcaster (social), Morpho (lending), Extra Finance, Moonwell, BaseSwap. Base TVL, Coinbase integration,"
        url="https://degen0x.com/ecosystem/best-projects-on-base-chain"
      ...
      />
        ...
        <LastUpdated pathKey="/ecosystem/best-projects-on-base-chain" />
        <ReadingTime />
      </div>
<AuthoritySources url="/ecosystem/best-projects-on-base-chain" />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Best Projects on Base Chain 2026: Aerodrome, Morpho,", "description": "Top Base projects: Aerodrome (DEX), Friend.tech/Farcaster (social), Morpho (lending), Extra Finance, Moonwell, BaseSwap. Base TVL, Coinbase integration,", "url": "https://degen0x.com/ecosystem/best-projects-on-base-chain", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
        {/* related-guides */}
