...
export default function TONEcosystemGuideExpanded() {
  ...
  return (
    <article id="top" style={{ background: "#0d1117", color: "#e6edf3", minHeight: "100vh", padding: "40px 20px", scrollBehavior: "smooth" }}>
      <ArticleSchema
        headline="TON Blockchain Ecosystem Guide 2026: STON.fi, DeDust, Evaa,"
        description="Complete TON ecosystem guide: STON.fi DEX ($120M TVL), DeDust ($60M TVL), Evaa lending ($40M TVL). Telegram Mini Apps: Notcoin (35M users), Hamster Kombat"
        url="/ecosystem/ton-blockchain-ecosystem-guide"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Ecosystem"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/ecosystem/ton-blockchain-ecosystem-guide" />
        <ReadingTime />
      </div>
<AuthoritySources url="/ecosystem/ton-blockchain-ecosystem-guide" />
