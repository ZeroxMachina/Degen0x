...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Defi Vs Cefi Lending Rates', },
  ],
};
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      ...
      />
        ...
        <LastUpdated pathKey="/crypto-loans/defi-vs-cefi-lending-rates" />
        <ReadingTime />
      </div>
<AuthoritySources url="/crypto-loans/defi-vs-cefi-lending-rates" />
  ...
  <a href="/crypto-loans/reviews/benqi-loans" style={{ color: "#fb923c", marginRight: "1rem" }}>Benqi Loans</a>
</nav>
    </article>
  );
}
