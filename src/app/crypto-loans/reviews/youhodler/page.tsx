...
export default function YouHodlerReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="YouHodler Review (2026)"
        url="https://degen0x.com/crypto-loans/reviews/youhodler"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="YouHodler Review (2026) | degen0x"
        description="In-depth YouHodler review covering crypto loans, Multi HODL feature, turbocharge loans, rates, and whether YouHodler is right for your needs."
        url="https://degen0x.com/crypto-loans/reviews/youhodler"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/crypto-loans/reviews/youhodler" />
        <ReadingTime />
      </div>
