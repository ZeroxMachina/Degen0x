...
export default function CelsiusSuccessorReview() {
  return (
    <>
      <ReviewSchema
        itemName="Celsius Successor Analysis (2026): What Happened & Lessons"
        url="https://degen0x.com/crypto-loans/reviews/celsius-successor"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Celsius Successor Analysis (2026): What Happened & Lessons | degen0x"
        description="Analysis of what emerged from Celsius Network"
        url="https://degen0x.com/crypto-loans/reviews/celsius-successor"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Reviews"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/crypto-loans/reviews/celsius-successor" />
        <ReadingTime />
      </div>
