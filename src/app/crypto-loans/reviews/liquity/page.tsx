...
export default function LiquityReview() {
  return (
    <>
      <ReviewSchema
        itemName="Liquity Review (2026): 0% Interest ETH Loans"
        url="https://degen0x.com/crypto-loans/reviews/liquity"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Liquity Review (2026): 0% Interest ETH Loans | degen0x"
        description="Liquity offers 0% interest ETH-backed loans with its LUSD stablecoin through an immutable, governance-free protocol."
        url="https://degen0x.com/crypto-loans/reviews/liquity"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/crypto-loans/reviews/liquity" />
        <ReadingTime />
      </div>
