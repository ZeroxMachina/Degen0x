...
export default function BitcoinLoansPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <AffiliateDisclosure />
      <h1 className="text-4xl font-bold text-white mb-4">Best Bitcoin-Backed Loans ({CURRENT_YEAR})</h1>
