  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        ...
        description="Nexo offers instant Bitcoin-backed loans with rates starting at 0% APR for Platinum-tier users. Borrow up to 90% LTV against your BTC with no monthly"
        url="/crypto-loans/best/bitcoin-loans"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Crypto Loans"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/crypto-loans/best/bitcoin-loans" />
        <ReadingTime />
      </div>
<AuthoritySources url="/crypto-loans/best/bitcoin-loans" />
