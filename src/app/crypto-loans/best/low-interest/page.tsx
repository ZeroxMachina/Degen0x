...
export default function LowInterestPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <AffiliateDisclosure />
      <h1 className="text-4xl font-bold text-white mb-4">Cheapest Crypto Loans ({CURRENT_YEAR})</h1>
