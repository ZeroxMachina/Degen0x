...
const products: Product[] = [
  { name: "Aave", slug: "aave-loans", rating: 4.8, description: "Aave offers stablecoin borrowing across USDC, USDT, DAI, and other stablecoins on 10+ chains. Multi-chain availability means you can find the best rates for stablecoin borrowing depending on demand conditions on each network.", pros: ["Multiple stablecoin options", "Multi-chain rate shopping", "Deep stablecoin liquidity", "No KYC"], cons: ["Variable rates fluctuate", "Gas costs on mainnet", "DeFi knowledge required"], fees: "Variable borrow rates", bestFor: "Multi-stablecoin borrowers", affiliateUrl: "https://degen0x.com/go/aave", category: "crypto-loans", featured: true },
