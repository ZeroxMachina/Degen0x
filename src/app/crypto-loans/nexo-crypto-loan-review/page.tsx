...
export default function NexoReview() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Nexo Crypto Loan Review 2026 | 0% with NEXO, 13.9% Standard"
        description="Nexo crypto loans: 0% APR with NEXO token, 5.9-13.9% standard, 15-50% LTV, 40+ collateral assets, instant credit line. Lloyds insured."
        url="https://degen0x.com/crypto-loans/nexo-crypto-loan-review"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Crypto Loans"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/crypto-loans/nexo-crypto-loan-review" />
        <ReadingTime />
      </div>
<AuthoritySources url="/crypto-loans/nexo-crypto-loan-review" />
