...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Nft Gaming Play To Earn 2026', },
  ],
};
...
export default function NFTGamingPlayToEarn2026() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="NFT Gaming & Play-to-Earn 2026: Axie, Illuvium, Gods"
        description="NFT gaming & play-to-earn 2026: Axie Infinity, Illuvium, Gods Unchained, Big Time, Star Atlas. P2E models, gaming guilds, sustainability analysis."
        url="https://degen0x.com/nfts/nft-gaming-play-to-earn-2026"
      ...
      />
        ...
        <LastUpdated pathKey="/nfts/nft-gaming-play-to-earn-2026" />
        <ReadingTime />
      </div>
<AuthoritySources url="/nfts/nft-gaming-play-to-earn-2026" />
