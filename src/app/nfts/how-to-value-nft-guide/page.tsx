...
export default function HowToValueNftGuide() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="How To Value NFT Guide | degen0x"
        description="How To Value NFT Guide guide for 2026. Compare options, understand risks, and get started with actionable strategies. Updated April 2026."
        url="https://degen0x.com/nfts/how-to-value-nft-guide"
      ...
      />
        ...
        <LastUpdated pathKey="/nfts/how-to-value-nft-guide" />
        <ReadingTime />
      </div>
<AuthoritySources url="/nfts/how-to-value-nft-guide" />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "How To Value NFT Guide | degen0x", "description": "How To Value NFT Guide guide for 2026. Compare options, understand risks, and get started with actionable strategies. Updated April 2026.", "url": "https://degen0x.com/nfts/how-to-value-nft-guide", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</div>
        {/* related-guides */}
