...
export const metadata: Metadata = {
  title: `Best Ethereum NFT Marketplaces in ${CURRENT_YEAR} | CryptoDegen`,
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-6">Best Ethereum NFT Platforms</h2>
        ...
        <section className="mb-12 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-8">
          <h2 className="text-2xl font-bold text-white mb-4">Ethereum NFT Marketplace Landscape</h2>
