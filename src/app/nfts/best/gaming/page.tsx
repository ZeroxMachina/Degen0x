...
export default function BestForGamingPage() {
  ...
  return (
    <>
      <ArticleSchema
        headline="Chain Compatibility"
        description="Chain Compatibility"
        url="/nfts/best/gaming"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="NFTs"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/nfts/best/gaming" />
        <ReadingTime />
      </div>
<AuthoritySources url="/nfts/best/gaming" />
