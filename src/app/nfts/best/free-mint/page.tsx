...
export default function BestForFreeMintPage() {
  ...
  return (
    <>
      <ArticleSchema
        headline="Lazy Minting (OpenSea)"
        description="Lazy Minting (OpenSea)"
        url="/nfts/best/free-mint"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="NFTs"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/nfts/best/free-mint" />
        <ReadingTime />
      </div>
<AuthoritySources url="/nfts/best/free-mint" />
    ...
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Lazy Minting (OpenSea)", "description": "Find the best NFT marketplaces with free minting in ${CURRENT_YEAR}. Create and list NFTs without upfront gas costs using lazy minting and low-cost chains.", "url": "https://degen0x.com/nfts/best/free-mint", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
</>
  );
}
