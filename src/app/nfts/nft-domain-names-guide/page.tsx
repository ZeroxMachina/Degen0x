...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Nft Domain Names Guide', },
  ],
};
...
export default function NFTDomainNamesGuide() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="NFT Domain Names 2026: ENS, Unstoppable Domains, .sol Guide"
        description="Complete NFT domain guide: ENS .eth domains ($5-50K annual), Unstoppable Domains .crypto ($6-10K one-time), Solana .sol ($1-5). Pricing, investment potential,"
        url="https://degen0x.com/nfts/nft-domain-names-guide"
      ...
      />
        ...
        <LastUpdated pathKey="/nfts/nft-domain-names-guide" />
        <ReadingTime />
      </div>
<AuthoritySources url="/nfts/nft-domain-names-guide" />
