...
export const metadata: Metadata = {
  title: "Crypto Quyền Chọn Giao Dịch: Hướng Dẫn Chi Tiết Tiếng Việt 2026 | Degen0x",
  description: "Mọi thứ bạn cần biết về Crypto Quyền Chọn Giao Dịch. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng dẫn chi tiết bằng tiếng Việt.",
  openGraph: {
    type: "article",
    title: "Crypto Quyền Chọn Giao Dịch: Hướng Dẫn Chi Tiết Tiếng Việt 2026",
    description: "Mọi thứ bạn cần biết về Crypto Quyền Chọn Giao Dịch. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng d",
    url: "https://degen0x.com/vi/learn/crypto-options-trading-guide",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto Quyền Chọn Giao Dịch: Hướng Dẫn Chi Tiết Tiếng Việt 2026", description: "Mọi thứ bạn cần biết về Crypto Quyền Chọn Giao Dịch. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng d" },
  alternates: {
    canonical: "/vi/learn/crypto-options-trading-guide",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto Quyền Chọn Giao Dịch: Hướng Dẫn Chi Tiết Tiếng Việt 2" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "Crypto Quyền Chọn Giao Dịch" }
          ]} />
