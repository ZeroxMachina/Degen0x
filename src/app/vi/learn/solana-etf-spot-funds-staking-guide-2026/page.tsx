...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "article",
    title: "Solana ETF Spot Funds Staking: Hướng Dẫn Chi Tiết Tiếng Việt 2026",
    description: "Mọi thứ bạn cần biết về Solana ETF Spot Funds Staking. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng",
    url: "https://degen0x.com/vi/learn/solana-etf-spot-funds-staking-guide-2026",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Solana ETF Spot Funds Staking: Hướng Dẫn Chi Tiết Tiếng Việt 2026", description: "Mọi thứ bạn cần biết về Solana ETF Spot Funds Staking. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng" },
  alternates: {
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Solana ETF Spot Funds Staking: Hướng Dẫn Chi Tiết Tiếng Việt" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Solana ETF Spot Funds Staking: Hướng Dẫn Chi Tiết Tiếng Việt 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Mọi thứ bạn cần biết về Solana ETF Spot Funds Staking. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng dẫn chi tiết bằng tiếng Việt.</p>
