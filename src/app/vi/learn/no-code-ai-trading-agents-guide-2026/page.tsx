...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "article",
    title: "No-Code AI Giao Dịch Agents: Hướng Dẫn Chi Tiết Tiếng Việt 2026",
    description: "Mọi thứ bạn cần biết về No-Code AI Giao Dịch Agents. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng d",
    url: "https://degen0x.com/vi/learn/no-code-ai-trading-agents-guide-2026",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "No-Code AI Giao Dịch Agents: Hướng Dẫn Chi Tiết Tiếng Việt 2026", description: "Mọi thứ bạn cần biết về No-Code AI Giao Dịch Agents. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng d" },
  alternates: {
    canonical: "/vi/learn/no-code-ai-trading-agents-guide-2026",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "No-Code AI Giao Dịch Agents: Hướng Dẫn Chi Tiết Tiếng Việt 2" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "No-Code AI Giao Dịch Agents" }
          ]} />
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">No-Code AI Giao Dịch Agents: Hướng Dẫn Chi Tiết Tiếng Việt 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Mọi thứ bạn cần biết về No-Code AI Giao Dịch Agents. Khái niệm cơ bản, cách hoạt động, rủi ro và cập nhật 2026 — hướng dẫn chi tiết bằng tiếng Việt.</p>
