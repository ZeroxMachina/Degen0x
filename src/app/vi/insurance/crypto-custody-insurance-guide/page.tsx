...
export const metadata: Metadata = {
  title: "Crypto Custody Bảo Hiểm — Hướng Dẫn Bảo Hiểm DeFi 2026 | Degen0x",
  description: "Crypto Custody Bảo Hiểm: giao thức bảo hiểm DeFi, so sánh phạm vi bảo hiểm và đánh giá rủi ro hợp đồng thông minh.",
  openGraph: {
    type: "article",
    title: "Crypto Custody Bảo Hiểm — Hướng Dẫn Bảo Hiểm DeFi 2026",
    description: "Crypto Custody Bảo Hiểm: giao thức bảo hiểm DeFi, so sánh phạm vi bảo hiểm và đánh giá rủi ro hợp đồng thông minh.",
    url: "https://degen0x.com/vi/insurance/crypto-custody-insurance-guide",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto Custody Bảo Hiểm — Hướng Dẫn Bảo Hiểm DeFi 2026", description: "Crypto Custody Bảo Hiểm: giao thức bảo hiểm DeFi, so sánh phạm vi bảo hiểm và đánh giá rủi ro hợp đồng thông minh." },
  alternates: {
    canonical: "/vi/insurance/crypto-custody-insurance-guide",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto Custody Bảo Hiểm — Hướng Dẫn Bảo Hiểm DeFi 2026" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Crypto Custody Bảo Hiểm — Hướng Dẫn Bảo Hiểm DeFi 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Crypto Custody Bảo Hiểm: giao thức bảo hiểm DeFi, so sánh phạm vi bảo hiểm và đánh giá rủi ro hợp đồng thông minh.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Bảo Hiểm DeFi Là Gì?</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Hướng dẫn bảo hiểm DeFi về Crypto Custody Bảo Hiểm: giao thức bảo hiểm phi tập trung bảo vệ chống lại exploit hợp đồng thông minh, hack và sự cố giao thức.</p>
            </section>
