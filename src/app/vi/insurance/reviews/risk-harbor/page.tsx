...
export const metadata: Metadata = {
  title: "Risk Harbor Review (2026) — Hướng Dẫn Bảo Hiểm DeFi 2026 | Degen0x",
  description: "Risk Harbor Review (2026): giao thức bảo hiểm DeFi, so sánh phạm vi bảo hiểm và đánh giá rủi ro hợp đồng thông minh.",
  openGraph: {
    type: "article",
    title: "Risk Harbor Review (2026) — Hướng Dẫn Bảo Hiểm DeFi 2026",
    description: "Risk Harbor Review (2026): giao thức bảo hiểm DeFi, so sánh phạm vi bảo hiểm và đánh giá rủi ro hợp đồng thông minh.",
    url: "https://degen0x.com/vi/insurance/reviews/risk-harbor",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Risk Harbor Review (2026) — Hướng Dẫn Bảo Hiểm DeFi 2026", description: "Risk Harbor Review (2026): giao thức bảo hiểm DeFi, so sánh phạm vi bảo hiểm và đánh giá rủi ro hợp đồng thông minh." },
  alternates: {
    canonical: "/vi/insurance/reviews/risk-harbor",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Risk Harbor Review (2026) — Hướng Dẫn Bảo Hiểm DeFi 2026" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Risk Harbor Review (2026) — Hướng Dẫn Bảo Hiểm DeFi 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Risk Harbor Review (2026): giao thức bảo hiểm DeFi, so sánh phạm vi bảo hiểm và đánh giá rủi ro hợp đồng thông minh.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Bảo Hiểm DeFi Là Gì?</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Hướng dẫn bảo hiểm DeFi về Risk Harbor Review (2026): giao thức bảo hiểm phi tập trung bảo vệ chống lại exploit hợp đồng thông minh, hack và sự cố giao thức.</p>
            </section>
