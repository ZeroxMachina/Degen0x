...
export const metadata: Metadata = {
  title: "Crypto Merchant Acceptance — Hướng Dẫn Thanh Toán Bằng Crypto | Degen0x",
  description: "Crypto Merchant Acceptance: phương thức thanh toán bằng crypto, nền tảng hỗ trợ và hướng dẫn sử dụng crypto hàng ngày.",
  openGraph: {
    type: "article",
    title: "Crypto Merchant Acceptance — Hướng Dẫn Thanh Toán Bằng Crypto",
    description: "Crypto Merchant Acceptance: phương thức thanh toán bằng crypto, nền tảng hỗ trợ và hướng dẫn sử dụng crypto hàng ngày.",
    url: "https://degen0x.com/vi/spending/crypto-merchant-acceptance-guide",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto Merchant Acceptance — Hướng Dẫn Thanh Toán Bằng Crypto", description: "Crypto Merchant Acceptance: phương thức thanh toán bằng crypto, nền tảng hỗ trợ và hướng dẫn sử dụng crypto hàng ngày." },
  alternates: {
    canonical: "/vi/spending/crypto-merchant-acceptance-guide",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto Merchant Acceptance — Hướng Dẫn Thanh Toán Bằng Crypt" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Crypto Merchant Acceptance — Hướng Dẫn Thanh Toán Bằng Crypto</h1>
            <p className="text-lg text-[#8b949e] mb-10">Crypto Merchant Acceptance: phương thức thanh toán bằng crypto, nền tảng hỗ trợ và hướng dẫn sử dụng crypto hàng ngày.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Phương Thức Thanh Toán Crypto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Hướng dẫn thanh toán bằng crypto cho Crypto Merchant Acceptance: thanh toán Lightning Network, thẻ ghi nợ crypto, chuyển khoản P2P và tích hợp thương mại điện tử.</p>
            </section>
