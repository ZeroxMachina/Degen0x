...
export const metadata: Metadata = {
  title: "NFT Tax — Hướng Dẫn Thuế Crypto và Công Cụ | Degen0x",
  description: "NFT Tax: nghĩa vụ thuế crypto, chuẩn bị tờ khai và công cụ tối ưu thuế. Chính sách thuế crypto tại Việt Nam đang trong quá trình hoàn thiện — theo dõi quy định ",
  openGraph: {
    type: "article",
    title: "NFT Tax — Hướng Dẫn Thuế Crypto và Công Cụ",
    description: "NFT Tax: nghĩa vụ thuế crypto, chuẩn bị tờ khai và công cụ tối ưu thuế. Chính sách thuế crypto tại Việt Nam đang trong q",
    url: "https://degen0x.com/vi/taxes/nft-tax-guide-2026",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "NFT Tax — Hướng Dẫn Thuế Crypto và Công Cụ", description: "NFT Tax: nghĩa vụ thuế crypto, chuẩn bị tờ khai và công cụ tối ưu thuế. Chính sách thuế crypto tại Việt Nam đang trong q" },
  alternates: {
    canonical: "/vi/taxes/nft-tax-guide-2026",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "NFT Tax — Hướng Dẫn Thuế Crypto và Công Cụ" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">NFT Tax — Hướng Dẫn Thuế Crypto và Công Cụ</h1>
            <p className="text-lg text-[#8b949e] mb-10">NFT Tax: nghĩa vụ thuế crypto, chuẩn bị tờ khai và công cụ tối ưu thuế. Chính sách thuế crypto tại Việt Nam đang trong quá trình hoàn thiện — theo dõi quy định mới nhất từ Bộ Tài chính.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Nghĩa Vụ Thuế Crypto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Nghĩa vụ thuế crypto trong phạm vi NFT Tax: Chính sách thuế crypto tại Việt Nam đang trong quá trình hoàn thiện — theo dõi quy định mới nhất từ Bộ Tài chính. Các giao dịch chịu thuế: mua bán, thu nhập staking, airdrop, mining và lợi nhuận DeFi.</p>
            </section>
