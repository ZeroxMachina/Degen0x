...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "article",
    title: "Wash Sale Rule & Crypto — Hướng Dẫn Thuế Crypto và Công Cụ",
    description: "Wash Sale Rule & Crypto: nghĩa vụ thuế crypto, chuẩn bị tờ khai và công cụ tối ưu thuế. Chính sách thuế crypto tại Việt ",
    url: "https://degen0x.com/vi/taxes/wash-sale-rule-crypto-explained",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Wash Sale Rule & Crypto — Hướng Dẫn Thuế Crypto và Công Cụ", description: "Wash Sale Rule & Crypto: nghĩa vụ thuế crypto, chuẩn bị tờ khai và công cụ tối ưu thuế. Chính sách thuế crypto tại Việt " },
  alternates: {
    canonical: "/vi/taxes/wash-sale-rule-crypto-explained",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Wash Sale Rule & Crypto — Hướng Dẫn Thuế Crypto và Công Cụ" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Wash Sale Rule & Crypto — Hướng Dẫn Thuế Crypto và Công Cụ</h1>
            <p className="text-lg text-[#8b949e] mb-10">Wash Sale Rule & Crypto: nghĩa vụ thuế crypto, chuẩn bị tờ khai và công cụ tối ưu thuế. Chính sách thuế crypto tại Việt Nam đang trong quá trình hoàn thiện — theo dõi quy định mới nhất từ Bộ Tài chính.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Nghĩa Vụ Thuế Crypto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Nghĩa vụ thuế crypto trong phạm vi Wash Sale Rule & Crypto: Chính sách thuế crypto tại Việt Nam đang trong quá trình hoàn thiện — theo dõi quy định mới nhất từ Bộ Tài chính. Các giao dịch chịu thuế: mua bán, thu nhập staking, airdrop, mining và lợi nhuận DeFi.</p>
            </section>
