...
export const metadata: Metadata = {
  title: "Aave Vay — So Sánh Nền Tảng Vay Crypto | Degen0x",
  description: "So sánh Aave Vay: lãi suất, yêu cầu tài sản thế chấp, rủi ro thanh lý và độ tin cậy nền tảng.",
  openGraph: {
    type: "article",
    title: "Aave Vay — So Sánh Nền Tảng Vay Crypto",
    description: "So sánh Aave Vay: lãi suất, yêu cầu tài sản thế chấp, rủi ro thanh lý và độ tin cậy nền tảng.",
    url: "https://degen0x.com/vi/crypto-loans/reviews/aave-loans",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Aave Vay — So Sánh Nền Tảng Vay Crypto", description: "So sánh Aave Vay: lãi suất, yêu cầu tài sản thế chấp, rủi ro thanh lý và độ tin cậy nền tảng." },
  alternates: {
    canonical: "/vi/crypto-loans/reviews/aave-loans",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Aave Vay — So Sánh Nền Tảng Vay Crypto" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Aave Vay — So Sánh Nền Tảng Vay Crypto</h1>
            <p className="text-lg text-[#8b949e] mb-10">So sánh Aave Vay: lãi suất, yêu cầu tài sản thế chấp, rủi ro thanh lý và độ tin cậy nền tảng.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Nền Tảng Vay Crypto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">So sánh nền tảng vay Aave Vay: lãi suất (APR/APY), tài sản thế chấp hỗ trợ, tỷ lệ thế chấp tối thiểu (LTV) và rủi ro thanh khoản.</p>
            </section>
