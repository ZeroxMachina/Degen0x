...
export const metadata: Metadata = {
  title: "Crypto.com Visa Card — So Sánh và Đánh Giá Thẻ Crypto | Degen0x",
  description: "So sánh Crypto.com Visa Card: phí hàng năm, tỷ lệ hoàn tiền, quốc gia hỗ trợ và trải nghiệm sử dụng tại Việt Nam.",
  openGraph: {
    type: "article",
    title: "Crypto.com Visa Card — So Sánh và Đánh Giá Thẻ Crypto",
    description: "So sánh Crypto.com Visa Card: phí hàng năm, tỷ lệ hoàn tiền, quốc gia hỗ trợ và trải nghiệm sử dụng tại Việt Nam.",
    url: "https://degen0x.com/vi/crypto-cards/reviews/crypto-com-card",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto.com Visa Card — So Sánh và Đánh Giá Thẻ Crypto", description: "So sánh Crypto.com Visa Card: phí hàng năm, tỷ lệ hoàn tiền, quốc gia hỗ trợ và trải nghiệm sử dụng tại Việt Nam." },
  alternates: {
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto.com Visa Card — So Sánh và Đánh Giá Thẻ Crypto" }
  ],
};
...
const faqSchema = generateFAQSchema([
  { "question": "Phí thẻ Crypto.com Visa Card là bao nhiêu?", "answer": "Cấu trúc phí: phí phát hành, phí hàng tháng/năm, phí rút ATM, chênh lệch tỷ giá và spread chuyển đổi crypto-fiat. Chú ý phí ẩn." },
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Crypto.com Visa Card — So Sánh và Đánh Giá Thẻ Crypto</h1>
            <p className="text-lg text-[#8b949e] mb-10">So sánh Crypto.com Visa Card: phí hàng năm, tỷ lệ hoàn tiền, quốc gia hỗ trợ và trải nghiệm sử dụng tại Việt Nam.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Đánh Giá Tổng Quan Thẻ Crypto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Đánh giá toàn diện thẻ Crypto.com Visa Card: loại thẻ (trả trước/ghi nợ/tín dụng), mạng thanh toán (Visa/Mastercard) và khả năng sử dụng toàn cầu. Thẻ crypto chưa phổ biến rộng rãi tại Việt Nam; nhiều người dùng chuyển đổi crypto sang VND qua P2P trước khi chi tiêu.</p>
            </section>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Phí và So Sánh Hoàn Tiền</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Phí hàng tháng/năm, hạn mức rút ATM, chênh lệch tỷ giá, yêu cầu staking và tỷ lệ cashback/thưởng của thẻ Crypto.com Visa Card. Chú ý các phí ẩn.</p>
            </section>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Crypto Hỗ Trợ và Chuyển Đổi</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Các crypto có thể chi tiêu qua thẻ Crypto.com Visa Card, cơ chế chuyển đổi tự động (crypto-to-fiat), tỷ lệ spread và tiền tệ fiat hỗ trợ.</p>
            </section>
