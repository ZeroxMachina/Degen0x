...
export const metadata: Metadata = {
  title: "Giao Dịch Khóa Học Online — Khóa Học Crypto | Degen0x",
  description: "Hướng dẫn toàn diện về Giao Dịch Khóa Học Online bằng tiếng Việt. Ngân hàng Nhà nước Việt Nam chưa chính thức công nhận tiền điện tử nhưng không cấm giao dịch c",
  openGraph: {
    type: "article",
    title: "Giao Dịch Khóa Học Online — Khóa Học Crypto",
    description: "Hướng dẫn toàn diện về Giao Dịch Khóa Học Online bằng tiếng Việt. Ngân hàng Nhà nước Việt Nam chưa chính thức công nhận ",
    url: "https://degen0x.com/vi/courses/best-crypto-trading-course-online",
    locale: "vi_VN",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Giao Dịch Khóa Học Online — Khóa Học Crypto", description: "Hướng dẫn toàn diện về Giao Dịch Khóa Học Online bằng tiếng Việt. Ngân hàng Nhà nước Việt Nam chưa chính thức công nhận " },
  alternates: {
    canonical: "/vi/courses/best-crypto-trading-course-online",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Giao Dịch Khóa Học Online — Khóa Học Crypto" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "Giao Dịch Khóa Học Online" }
          ]} />
          <article className="mt-8" lang="vi">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Giao Dịch Khóa Học Online — Khóa Học Crypto</h1>
            <p className="text-lg text-[#8b949e] mb-10">Hướng dẫn toàn diện về Giao Dịch Khóa Học Online bằng tiếng Việt. Ngân hàng Nhà nước Việt Nam chưa chính thức công nhận tiền điện tử nhưng không cấm giao dịch cá nhân.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Nội Dung Khóa Học</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Khóa học crypto Giao Dịch Khóa Học Online: chương trình toàn diện từ khái niệm cơ bản đến chiến lược nâng cao. Được hỗ trợ bằng ví dụ thực hành và kịch bản thị trường thực tế.</p>
            </section>
