...
export const metadata: Metadata = {
  title: "Alım Satım Kurslar Online — Kripto Eğitim Kursu | Degen0x",
  description: "Alım Satım Kurslar Online hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bilinçli kararlar almanız için ihtiyacınız ",
  openGraph: {
    type: "article",
    title: "Alım Satım Kurslar Online — Kripto Eğitim Kursu",
    description: "Alım Satım Kurslar Online hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bil",
    url: "https://degen0x.com/tr/courses/best-crypto-trading-course-online",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Alım Satım Kurslar Online — Kripto Eğitim Kursu", description: "Alım Satım Kurslar Online hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bil" },
  alternates: {
    canonical: "/tr/courses/best-crypto-trading-course-online",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Alım Satım Kurslar Online — Kripto Eğitim Kursu" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "Alım Satım Kurslar Online" }
          ]} />
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Alım Satım Kurslar Online — Kripto Eğitim Kursu</h1>
            <p className="text-lg text-[#8b949e] mb-10">Alım Satım Kurslar Online hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bilinçli kararlar almanız için ihtiyacınız olan bilgiler.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kurs İçeriği</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Alım Satım Kurslar Online kripto eğitim kursu: temel kavramlardan ileri düzey stratejilere kadar kapsamlı müfredat. Uygulamalı örnekler ve gerçek piyasa senaryoları ile desteklenmiştir.</p>
            </section>
