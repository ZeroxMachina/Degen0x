...
export const metadata: Metadata = {
  title: "Blockchain Geliştirici Kurslar bies, Alchemy — Kripto Eğitim Kursu | Degen0x",
  description: "Blockchain Geliştirici Kurslar bies, Alchemy hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bilinçli kararlar almanı",
  openGraph: {
    type: "article",
    title: "Blockchain Geliştirici Kurslar bies, Alchemy — Kripto Eğitim Kursu",
    description: "Blockchain Geliştirici Kurslar bies, Alchemy hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kr",
    url: "https://degen0x.com/tr/courses/blockchain-developer-course-free",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Blockchain Geliştirici Kurslar bies, Alchemy — Kripto Eğitim Kursu", description: "Blockchain Geliştirici Kurslar bies, Alchemy hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kr" },
  alternates: {
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Blockchain Geliştirici Kurslar bies, Alchemy — Kripto Eğitim" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "Blockchain Geliştirici Kurslar bies, Alchemy" }
          ]} />
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Blockchain Geliştirici Kurslar bies, Alchemy — Kripto Eğitim Kursu</h1>
            <p className="text-lg text-[#8b949e] mb-10">Blockchain Geliştirici Kurslar bies, Alchemy hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bilinçli kararlar almanız için ihtiyacınız olan bilgiler.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kurs İçeriği</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Blockchain Geliştirici Kurslar bies, Alchemy kripto eğitim kursu: temel kavramlardan ileri düzey stratejilere kadar kapsamlı müfredat. Uygulamalı örnekler ve gerçek piyasa senaryoları ile desteklenmiştir.</p>
            </section>
