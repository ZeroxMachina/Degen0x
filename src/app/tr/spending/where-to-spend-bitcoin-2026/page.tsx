...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "article",
    title: "Where to Spend Bitcoin — Kripto ile Ödeme Rehberi",
    description: "Where to Spend Bitcoin: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehb",
    url: "https://degen0x.com/tr/spending/where-to-spend-bitcoin-2026",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Where to Spend Bitcoin — Kripto ile Ödeme Rehberi", description: "Where to Spend Bitcoin: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehb" },
  alternates: {
    canonical: "/tr/spending/where-to-spend-bitcoin-2026",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Where to Spend Bitcoin — Kripto ile Ödeme Rehberi" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Where to Spend Bitcoin — Kripto ile Ödeme Rehberi</h1>
            <p className="text-lg text-[#8b949e] mb-10">Where to Spend Bitcoin: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehberi.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kripto ile Ödeme Yöntemleri</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Where to Spend Bitcoin kapsamında kripto ile ödeme yapma rehberi: Lightning Network ödemeleri, kripto banka kartları, P2P transferler ve e-ticaret entegrasyonları.</p>
            </section>
