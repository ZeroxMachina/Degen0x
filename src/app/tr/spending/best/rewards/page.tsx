...
export const metadata: Metadata = {
  title: "Rewards Kartlar — Kripto ile Ödeme Rehberi | Degen0x",
  description: "Rewards Kartlar: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehberi.",
  openGraph: {
    type: "article",
    title: "Rewards Kartlar — Kripto ile Ödeme Rehberi",
    description: "Rewards Kartlar: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehberi.",
    url: "https://degen0x.com/tr/spending/best/rewards",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Rewards Kartlar — Kripto ile Ödeme Rehberi", description: "Rewards Kartlar: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehberi." },
  alternates: {
    canonical: "/tr/spending/best/rewards",
    languages: { "en": "/spending/best/rewards", "tr": "/tr/spending/best/rewards", "vi": "/vi/spending/best/rewards", "pt-BR": "/pt-br/spending/best/rewards", "x-default": "/spending/best/rewards" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Rewards Kartlar — Kripto ile Ödeme Rehberi" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Rewards Kartlar — Kripto ile Ödeme Rehberi</h1>
            <p className="text-lg text-[#8b949e] mb-10">Rewards Kartlar: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehberi.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kripto ile Ödeme Yöntemleri</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Rewards Kartlar kapsamında kripto ile ödeme yapma rehberi: Lightning Network ödemeleri, kripto banka kartları, P2P transferler ve e-ticaret entegrasyonları.</p>
            </section>
