...
export const metadata: Metadata = {
  title: "Bitcoin Lightning Network Payments — Kripto ile Ödeme Rehberi | Degen0x",
  description: "Bitcoin Lightning Network Payments: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehberi.",
  openGraph: {
    type: "article",
    title: "Bitcoin Lightning Network Payments — Kripto ile Ödeme Rehberi",
    description: "Bitcoin Lightning Network Payments: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto k",
    url: "https://degen0x.com/tr/spending/bitcoin-lightning-payments-guide",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Bitcoin Lightning Network Payments — Kripto ile Ödeme Rehberi", description: "Bitcoin Lightning Network Payments: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto k" },
  alternates: {
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Bitcoin Lightning Network Payments — Kripto ile Ödeme Rehber" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Bitcoin Lightning Network Payments — Kripto ile Ödeme Rehberi</h1>
            <p className="text-lg text-[#8b949e] mb-10">Bitcoin Lightning Network Payments: kripto ile ödeme yöntemleri, desteklenen platformlar ve günlük harcamalarda kripto kullanma rehberi.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kripto ile Ödeme Yöntemleri</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Bitcoin Lightning Network Payments kapsamında kripto ile ödeme yapma rehberi: Lightning Network ödemeleri, kripto banka kartları, P2P transferler ve e-ticaret entegrasyonları.</p>
            </section>
