...
export const metadata: Metadata = {
  title: "Crypto Day Alım Satım Tax Implications — Kripto Vergi Rehberi ve Araçları | Degen0x",
  description: "Crypto Day Alım Satım Tax Implications: kripto vergi yükümlülükleri, beyanname hazırlığı ve vergi optimizasyon araçları. Türkiye\'de kripto gelirleri gelir vergi",
  openGraph: {
    type: "article",
    title: "Crypto Day Alım Satım Tax Implications — Kripto Vergi Rehberi ve Araçları",
    description: "Crypto Day Alım Satım Tax Implications: kripto vergi yükümlülükleri, beyanname hazırlığı ve vergi optimizasyon araçları.",
    url: "https://degen0x.com/tr/taxes/crypto-day-trading-tax-implications",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto Day Alım Satım Tax Implications — Kripto Vergi Rehberi ve Araçları", description: "Crypto Day Alım Satım Tax Implications: kripto vergi yükümlülükleri, beyanname hazırlığı ve vergi optimizasyon araçları." },
  alternates: {
    canonical: "/tr/taxes/crypto-day-trading-tax-implications",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto Day Alım Satım Tax Implications — Kripto Vergi Rehber" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "Crypto Day Alım Satım Tax Implications" }
          ]} />
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Crypto Day Alım Satım Tax Implications — Kripto Vergi Rehberi ve Araçları</h1>
            <p className="text-lg text-[#8b949e] mb-10">Crypto Day Alım Satım Tax Implications: kripto vergi yükümlülükleri, beyanname hazırlığı ve vergi optimizasyon araçları. Türkiye\'de kripto gelirleri gelir vergisine tabidir — detaylar için mali müşavirinize danışın.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kripto Vergi Yükümlülükleri</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Crypto Day Alım Satım Tax Implications kapsamında kripto vergi yükümlülükleri: Türkiye\'de kripto gelirleri gelir vergisine tabidir — detaylar için mali müşavirinize danışın. Vergilendirme kapsamına giren işlemler: alım-satım, staking gelirleri, airdrop\'lar, mining ve DeFi kazançları.</p>
            </section>
