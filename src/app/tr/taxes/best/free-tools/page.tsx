...
export const metadata: Metadata = {
  title: "Araçlar — Kripto Vergi Rehberi ve Araçları | Degen0x",
  description: "Araçlar: kripto vergi yükümlülükleri, beyanname hazırlığı ve vergi optimizasyon araçları. Türkiye\'de kripto gelirleri gelir vergisine tabidir — detaylar için ma",
  openGraph: {
    type: "article",
    title: "Araçlar — Kripto Vergi Rehberi ve Araçları",
    description: "Araçlar: kripto vergi yükümlülükleri, beyanname hazırlığı ve vergi optimizasyon araçları. Türkiye\'de kripto gelirleri ge",
    url: "https://degen0x.com/tr/taxes/best/free-tools",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Araçlar — Kripto Vergi Rehberi ve Araçları", description: "Araçlar: kripto vergi yükümlülükleri, beyanname hazırlığı ve vergi optimizasyon araçları. Türkiye\'de kripto gelirleri ge" },
  alternates: {
    canonical: "/tr/taxes/best/free-tools",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Araçlar — Kripto Vergi Rehberi ve Araçları" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Araçlar — Kripto Vergi Rehberi ve Araçları</h1>
            <p className="text-lg text-[#8b949e] mb-10">Araçlar: kripto vergi yükümlülükleri, beyanname hazırlığı ve vergi optimizasyon araçları. Türkiye\'de kripto gelirleri gelir vergisine tabidir — detaylar için mali müşavirinize danışın.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kripto Vergi Yükümlülükleri</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Araçlar kapsamında kripto vergi yükümlülükleri: Türkiye\'de kripto gelirleri gelir vergisine tabidir — detaylar için mali müşavirinize danışın. Vergilendirme kapsamına giren işlemler: alım-satım, staking gelirleri, airdrop\'lar, mining ve DeFi kazançları.</p>
            </section>
