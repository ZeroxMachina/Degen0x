...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://degen0x.com/tr/taxes/compare/crypto-tax-software-comparison",
    locale: "tr_TR",
  ...
  alternates: {
    canonical: "/tr/taxes/compare/crypto-tax-software-comparison",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Tax Software — Kripto Vergi Rehberi ve Araçları" }
  ],
};
