...
export const metadata: Metadata = {
  title: "AMM & Liquidity Pools: 2026 Kapsamlı Türkçe Rehber | Degen0x",
  description: "AMM & Liquidity Pools hakkında bilmeniz gereken her şey. Temel kavramlar, nasıl çalışır, riskler ve 2026 güncellemeleri — Türkçe kapsamlı rehber.",
  openGraph: {
    type: "article",
    title: "AMM & Liquidity Pools: 2026 Kapsamlı Türkçe Rehber",
    description: "AMM & Liquidity Pools hakkında bilmeniz gereken her şey. Temel kavramlar, nasıl çalışır, riskler ve 2026 güncellemeleri ",
    url: "https://degen0x.com/tr/learn/amm-liquidity-pools-guide-2026",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "AMM & Liquidity Pools: 2026 Kapsamlı Türkçe Rehber", description: "AMM & Liquidity Pools hakkında bilmeniz gereken her şey. Temel kavramlar, nasıl çalışır, riskler ve 2026 güncellemeleri " },
  alternates: {
    canonical: "/tr/learn/amm-liquidity-pools-guide-2026",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "AMM & Liquidity Pools: 2026 Kapsamlı Türkçe Rehber" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">AMM & Liquidity Pools: 2026 Kapsamlı Türkçe Rehber</h1>
            <p className="text-lg text-[#8b949e] mb-10">AMM & Liquidity Pools hakkında bilmeniz gereken her şey. Temel kavramlar, nasıl çalışır, riskler ve 2026 güncellemeleri — Türkçe kapsamlı rehber.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">AMM & Liquidity Pools Nedir?</h2>
              <p className="text-[#c9d1d9] leading-relaxed">AMM & Liquidity Pools, kripto ve blokzincir alanının temel yapı taşlarından biridir. Bu teknoloji, merkezi olmayan mimarisi sayesinde kullanıcılara aracısız ve şeffaf işlem yapma imkanı sunar. 2026 yılı itibarıyla AMM & Liquidity Pools alanında TVL, kullanıcı sayısı ve geliştirici aktivitesi gibi metriklerde belirgin artışlar gözlemlenmiştir. DeFi protokollerinin toplam TVL\'si 2026\'da \$200 milyarı aşmıştır. Aave v4, Uniswap v4 hooks ve Pendle gibi yield tokenizasyon platformları yeni nesil finansal ürünler sunmaktadır.</p>
            </section>
