...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "article",
    title: "No-Code AI Alım Satım Agents: 2026 Kapsamlı Türkçe Rehber",
    description: "No-Code AI Alım Satım Agents hakkında bilmeniz gereken her şey. Temel kavramlar, nasıl çalışır, riskler ve 2026 güncelle",
    url: "https://degen0x.com/tr/learn/no-code-ai-trading-agents-guide-2026",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "No-Code AI Alım Satım Agents: 2026 Kapsamlı Türkçe Rehber", description: "No-Code AI Alım Satım Agents hakkında bilmeniz gereken her şey. Temel kavramlar, nasıl çalışır, riskler ve 2026 güncelle" },
  alternates: {
    canonical: "/tr/learn/no-code-ai-trading-agents-guide-2026",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "No-Code AI Alım Satım Agents: 2026 Kapsamlı Türkçe Rehber" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "No-Code AI Alım Satım Agents" }
          ]} />
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">No-Code AI Alım Satım Agents: 2026 Kapsamlı Türkçe Rehber</h1>
            <p className="text-lg text-[#8b949e] mb-10">No-Code AI Alım Satım Agents hakkında bilmeniz gereken her şey. Temel kavramlar, nasıl çalışır, riskler ve 2026 güncellemeleri — Türkçe kapsamlı rehber.</p>
