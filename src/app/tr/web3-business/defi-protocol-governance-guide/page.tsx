...
export const metadata: Metadata = {
  title: "DeFi Protokol Yönetişim — Web3 İş Fırsatları ve Stratejiler | Degen0x",
  description: "DeFi Protokol Yönetişim: Web3 iş modelleri, token ekonomileri ve merkeziyetsiz organizasyon yapıları — girişimciler için rehber.",
  openGraph: {
    type: "article",
    title: "DeFi Protokol Yönetişim — Web3 İş Fırsatları ve Stratejiler",
    description: "DeFi Protokol Yönetişim: Web3 iş modelleri, token ekonomileri ve merkeziyetsiz organizasyon yapıları — girişimciler için",
    url: "https://degen0x.com/tr/web3-business/defi-protocol-governance-guide",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "DeFi Protokol Yönetişim — Web3 İş Fırsatları ve Stratejiler", description: "DeFi Protokol Yönetişim: Web3 iş modelleri, token ekonomileri ve merkeziyetsiz organizasyon yapıları — girişimciler için" },
  alternates: {
    canonical: "/tr/web3-business/defi-protocol-governance-guide",
    languages: { "en": "/web3-business/defi-protocol-governance-guide", "tr": "/tr/web3-business/defi-protocol-governance-guide", "vi": "/vi/web3-business/defi-protocol-governance-guide", "pt-BR": "/pt-br/web3-business/defi-protocol-governance-guide", "x-default": "/web3-business/defi-protocol-governance-guide" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "DeFi Protokol Yönetişim — Web3 İş Fırsatları ve Stratejiler" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">DeFi Protokol Yönetişim — Web3 İş Fırsatları ve Stratejiler</h1>
            <p className="text-lg text-[#8b949e] mb-10">DeFi Protokol Yönetişim: Web3 iş modelleri, token ekonomileri ve merkeziyetsiz organizasyon yapıları — girişimciler için rehber.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Web3 İş Modelleri</h2>
              <p className="text-[#c9d1d9] leading-relaxed">DeFi Protokol Yönetişim kapsamında Web3 iş modelleri: DAO yapıları, token ekonomileri, merkeziyetsiz pazaryerleri ve creator ekonomisi. Türk geliştirici ekosistemi blockchain alanında hızla büyümekte olup İstanbul önemli bir Web3 merkezi haline gelmiştir.</p>
            </section>
