...
export const metadata: Metadata = {
  title: "Real-World Asset Tokenization Business Guide 2026: RWA — Web3 İş Fırsatları ve Stratejiler | Degen0x",
  description: "Real-World Asset Tokenization Business Guide 2026: RWA: Web3 iş modelleri, token ekonomileri ve merkeziyetsiz organizasyon yapıları — girişimciler için rehber.",
  openGraph: {
    type: "article",
    title: "Real-World Asset Tokenization Business Guide 2026: RWA — Web3 İş Fırsatları ve Stratejiler",
    description: "Real-World Asset Tokenization Business Guide 2026: RWA: Web3 iş modelleri, token ekonomileri ve merkeziyetsiz organizasy",
    url: "https://degen0x.com/tr/web3-business/tokenization-business-guide",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Real-World Asset Tokenization Business Guide 2026: RWA — Web3 İş Fırsatları ve Stratejiler", description: "Real-World Asset Tokenization Business Guide 2026: RWA: Web3 iş modelleri, token ekonomileri ve merkeziyetsiz organizasy" },
  alternates: {
    canonical: "/tr/web3-business/tokenization-business-guide",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Real-World Asset Tokenization Business Guide 2026: RWA — Web" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Real-World Asset Tokenization Business Guide 2026: RWA — Web3 İş Fırsatları ve Stratejiler</h1>
            <p className="text-lg text-[#8b949e] mb-10">Real-World Asset Tokenization Business Guide 2026: RWA: Web3 iş modelleri, token ekonomileri ve merkeziyetsiz organizasyon yapıları — girişimciler için rehber.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Web3 İş Modelleri</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Real-World Asset Tokenization Business Guide 2026: RWA kapsamında Web3 iş modelleri: DAO yapıları, token ekonomileri, merkeziyetsiz pazaryerleri ve creator ekonomisi. Türk geliştirici ekosistemi blockchain alanında hızla büyümekte olup İstanbul önemli bir Web3 merkezi haline gelmiştir.</p>
            </section>
