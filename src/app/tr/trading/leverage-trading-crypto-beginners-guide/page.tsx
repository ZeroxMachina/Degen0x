...
export const metadata: Metadata = {
  title: "Crypto Leverage Alım Satım — Kapsamlı Kripto Rehberi 2026 | Degen0x",
  description: "Crypto Leverage Alım Satım hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bilinçli kararlar almanız için ihtiyacınız",
  openGraph: {
    type: "article",
    title: "Crypto Leverage Alım Satım — Kapsamlı Kripto Rehberi 2026",
    description: "Crypto Leverage Alım Satım hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bi",
    url: "https://degen0x.com/tr/trading/leverage-trading-crypto-beginners-guide",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto Leverage Alım Satım — Kapsamlı Kripto Rehberi 2026", description: "Crypto Leverage Alım Satım hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bi" },
  alternates: {
    canonical: "/tr/trading/leverage-trading-crypto-beginners-guide",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto Leverage Alım Satım — Kapsamlı Kripto Rehberi 2026" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Crypto Leverage Alım Satım — Kapsamlı Kripto Rehberi 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Crypto Leverage Alım Satım hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bilinçli kararlar almanız için ihtiyacınız olan bilgiler.</p>
