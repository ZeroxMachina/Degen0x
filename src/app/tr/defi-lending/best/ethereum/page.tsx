...
export const metadata: Metadata = {
  title: "Ethereum DeFi Kredi Protokoller — Kapsamlı Kripto Rehberi 2026 | Degen0x",
  description: "Ethereum DeFi Kredi Protokoller hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasında bilinçli kararlar almanız için ihtiya",
  openGraph: {
    type: "article",
    title: "Ethereum DeFi Kredi Protokoller — Kapsamlı Kripto Rehberi 2026",
    description: "Ethereum DeFi Kredi Protokoller hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasın",
    url: "https://degen0x.com/tr/defi-lending/best/ethereum",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Ethereum DeFi Kredi Protokoller — Kapsamlı Kripto Rehberi 2026", description: "Ethereum DeFi Kredi Protokoller hakkında kapsamlı Türkçe rehber. SPK ve MASAK düzenlemeleri çerçevesinde kripto dünyasın" },
  alternates: {
    canonical: "/tr/defi-lending/best/ethereum",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Ethereum DeFi Kredi Protokoller — Kapsamlı Kripto Rehberi 20" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "Ethereum DeFi Kredi Protokoller" }
          ]} />
