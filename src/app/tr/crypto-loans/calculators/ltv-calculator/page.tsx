...
export const metadata: Metadata = {
  title: "Ltv — Kripto Kredi Platformları Karşılaştırması | Degen0x",
  description: "Ltv karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirliği.",
  openGraph: {
    type: "article",
    title: "Ltv — Kripto Kredi Platformları Karşılaştırması",
    description: "Ltv karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirliği.",
    url: "https://degen0x.com/tr/crypto-loans/calculators/ltv-calculator",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Ltv — Kripto Kredi Platformları Karşılaştırması", description: "Ltv karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirliği." },
  alternates: {
    canonical: "/tr/crypto-loans/calculators/ltv-calculator",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Ltv — Kripto Kredi Platformları Karşılaştırması" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Ltv — Kripto Kredi Platformları Karşılaştırması</h1>
            <p className="text-lg text-[#8b949e] mb-10">Ltv karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirliği.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kripto Kredi Platformları</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Ltv kredi platformları karşılaştırması: faiz oranları (APR/APY), desteklenen teminat varlıkları, minimum teminat oranları (LTV) ve likidite riskleri.</p>
            </section>
