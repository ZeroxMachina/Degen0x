...
export const metadata: Metadata = {
  title: "Best Institutional Crypto Lending — Kripto Kredi Platformları Karşılaştırması | Degen0x",
  description: "Best Institutional Crypto Lending karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirliği.",
  openGraph: {
    type: "article",
    title: "Best Institutional Crypto Lending — Kripto Kredi Platformları Karşılaştırması",
    description: "Best Institutional Crypto Lending karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform ",
    url: "https://degen0x.com/tr/crypto-loans/best/institutional",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Best Institutional Crypto Lending — Kripto Kredi Platformları Karşılaştırması", description: "Best Institutional Crypto Lending karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform " },
  alternates: {
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Best Institutional Crypto Lending — Kripto Kredi Platformlar" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Best Institutional Crypto Lending — Kripto Kredi Platformları Karşılaştırması</h1>
            <p className="text-lg text-[#8b949e] mb-10">Best Institutional Crypto Lending karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirliği.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kripto Kredi Platformları</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Best Institutional Crypto Lending kredi platformları karşılaştırması: faiz oranları (APR/APY), desteklenen teminat varlıkları, minimum teminat oranları (LTV) ve likidite riskleri.</p>
            </section>
