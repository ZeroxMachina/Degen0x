...
export const metadata: Metadata = {
  title: "NFT-Collateral Krediler — Kripto Kredi Platformları Karşılaştırması | Degen0x",
  description: "NFT-Collateral Krediler karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirliği.",
  openGraph: {
    type: "article",
    title: "NFT-Collateral Krediler — Kripto Kredi Platformları Karşılaştırması",
    description: "NFT-Collateral Krediler karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirl",
    url: "https://degen0x.com/tr/crypto-loans/best/nft-collateral",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "NFT-Collateral Krediler — Kripto Kredi Platformları Karşılaştırması", description: "NFT-Collateral Krediler karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirl" },
  alternates: {
    canonical: "/tr/crypto-loans/best/nft-collateral",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "NFT-Collateral Krediler — Kripto Kredi Platformları Karşılaş" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">NFT-Collateral Krediler — Kripto Kredi Platformları Karşılaştırması</h1>
            <p className="text-lg text-[#8b949e] mb-10">NFT-Collateral Krediler karşılaştırması: faiz oranları, teminat gereksinimleri, likidite riskleri ve platform güvenilirliği.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Kripto Kredi Platformları</h2>
              <p className="text-[#c9d1d9] leading-relaxed">NFT-Collateral Krediler kredi platformları karşılaştırması: faiz oranları (APR/APY), desteklenen teminat varlıkları, minimum teminat oranları (LTV) ve likidite riskleri.</p>
            </section>
