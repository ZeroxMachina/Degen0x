...
export const metadata: Metadata = {
  title: "Bitcoin Tasarruf Plan — Uzun Vadeli Kripto Stratejisi | Degen0x",
  description: "Bitcoin Tasarruf Plan: uzun vadeli kripto yatırım stratejileri, portföy çeşitlendirme ve hodl yaklaşımı.",
  openGraph: {
    type: "article",
    title: "Bitcoin Tasarruf Plan — Uzun Vadeli Kripto Stratejisi",
    description: "Bitcoin Tasarruf Plan: uzun vadeli kripto yatırım stratejileri, portföy çeşitlendirme ve hodl yaklaşımı.",
    url: "https://degen0x.com/tr/long-term/bitcoin-savings-plan-guide",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Bitcoin Tasarruf Plan — Uzun Vadeli Kripto Stratejisi", description: "Bitcoin Tasarruf Plan: uzun vadeli kripto yatırım stratejileri, portföy çeşitlendirme ve hodl yaklaşımı." },
  alternates: {
    canonical: "/tr/long-term/bitcoin-savings-plan-guide",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Bitcoin Tasarruf Plan — Uzun Vadeli Kripto Stratejisi" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Bitcoin Tasarruf Plan — Uzun Vadeli Kripto Stratejisi</h1>
            <p className="text-lg text-[#8b949e] mb-10">Bitcoin Tasarruf Plan: uzun vadeli kripto yatırım stratejileri, portföy çeşitlendirme ve hodl yaklaşımı.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Uzun Vadeli Yatırım Stratejisi</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Bitcoin Tasarruf Plan kapsamında uzun vadeli kripto yatırım stratejisi: hodl yaklaşımı, DCA (düzenli alım), value investing ve makroekonomik analiz.</p>
            </section>
