...
export const metadata: Metadata = {
  title: "Coinbase vs Kraken vs Gemini — Detaylı Karşılaştırma ve Analiz | Degen0x",
  description: "Coinbase vs Kraken vs Gemini: özellik karşılaştırması, performans analizi ve hangisini seçmelisiniz — detaylı rehber.",
  openGraph: {
    type: "article",
    title: "Coinbase vs Kraken vs Gemini — Detaylı Karşılaştırma ve Analiz",
    description: "Coinbase vs Kraken vs Gemini: özellik karşılaştırması, performans analizi ve hangisini seçmelisiniz — detaylı rehber.",
    url: "https://degen0x.com/tr/compare/coinbase-vs-kraken-vs-gemini",
    locale: "tr_TR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Coinbase vs Kraken vs Gemini — Detaylı Karşılaştırma ve Analiz", description: "Coinbase vs Kraken vs Gemini: özellik karşılaştırması, performans analizi ve hangisini seçmelisiniz — detaylı rehber." },
  alternates: {
    canonical: "/tr/compare/coinbase-vs-kraken-vs-gemini",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Coinbase vs Kraken vs Gemini — Detaylı Karşılaştırma ve Anal" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="tr">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Coinbase vs Kraken vs Gemini — Detaylı Karşılaştırma ve Analiz</h1>
            <p className="text-lg text-[#8b949e] mb-10">Coinbase vs Kraken vs Gemini: özellik karşılaştırması, performans analizi ve hangisini seçmelisiniz — detaylı rehber.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Karşılaştırma Kriterleri</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Coinbase vs Kraken vs Gemini karşılaştırması: performans, güvenlik, ücret yapısı, kullanıcı deneyimi ve ekosistem büyüklüğü gibi temel kriterlere göre detaylı analiz.</p>
            </section>
