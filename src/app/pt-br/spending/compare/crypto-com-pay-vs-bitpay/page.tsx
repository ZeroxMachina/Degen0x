...
export const metadata: Metadata = {
  title: "Crypto.com Pay vs BitPay — Guia de Pagamentos com Cripto | Degen0x",
  description: "Crypto.com Pay vs BitPay: métodos de pagamento com cripto, plataformas suportadas e guia de uso diário.",
  openGraph: {
    type: "article",
    title: "Crypto.com Pay vs BitPay — Guia de Pagamentos com Cripto",
    description: "Crypto.com Pay vs BitPay: métodos de pagamento com cripto, plataformas suportadas e guia de uso diário.",
    url: "https://degen0x.com/pt-br/spending/compare/crypto-com-pay-vs-bitpay",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto.com Pay vs BitPay — Guia de Pagamentos com Cripto", description: "Crypto.com Pay vs BitPay: métodos de pagamento com cripto, plataformas suportadas e guia de uso diário." },
  alternates: {
    canonical: "/pt-br/spending/compare/crypto-com-pay-vs-bitpay",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto.com Pay vs BitPay — Guia de Pagamentos com Cripto" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Crypto.com Pay vs BitPay — Guia de Pagamentos com Cripto</h1>
            <p className="text-lg text-[#8b949e] mb-10">Crypto.com Pay vs BitPay: métodos de pagamento com cripto, plataformas suportadas e guia de uso diário.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Métodos de Pagamento com Cripto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Guia de pagamento crypto para Crypto.com Pay vs BitPay: pagamentos Lightning Network, cartões de débito cripto, transferências P2P e integrações e-commerce.</p>
            </section>
