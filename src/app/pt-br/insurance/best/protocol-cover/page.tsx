...
export const metadata: Metadata = {
  title: "Protocolo Cover Seguro — Guia de Seguros DeFi 2026 | Degen0x",
  description: "Protocolo Cover Seguro: protocolos de seguro DeFi, comparação de cobertura e avaliação de risco de contratos inteligentes.",
  openGraph: {
    type: "article",
    title: "Protocolo Cover Seguro — Guia de Seguros DeFi 2026",
    description: "Protocolo Cover Seguro: protocolos de seguro DeFi, comparação de cobertura e avaliação de risco de contratos inteligente",
    url: "https://degen0x.com/pt-br/insurance/best/protocol-cover",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Protocolo Cover Seguro — Guia de Seguros DeFi 2026", description: "Protocolo Cover Seguro: protocolos de seguro DeFi, comparação de cobertura e avaliação de risco de contratos inteligente" },
  alternates: {
    canonical: "/pt-br/insurance/best/protocol-cover",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Protocolo Cover Seguro — Guia de Seguros DeFi 2026" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Protocolo Cover Seguro — Guia de Seguros DeFi 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Protocolo Cover Seguro: protocolos de seguro DeFi, comparação de cobertura e avaliação de risco de contratos inteligentes.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">O Que É Seguro DeFi?</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Guia de seguro DeFi sobre Protocolo Cover Seguro: protocolos de seguro descentralizado que protegem contra exploits de contratos inteligentes, hacks e falhas de protocolo.</p>
            </section>
