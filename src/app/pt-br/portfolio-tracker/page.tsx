...
export const metadata: Metadata = {
  title: "Portfolio Tracker — Multi-Chain Crypto Portfolio — Análise de Rastreador de Portfólio | Degen0x",
  description: "Guia completo sobre Portfolio Tracker — Multi-Chain Crypto Portfolio em português. A CVM e o Banco Central regulamentam ativos digitais no Brasil sob o Marco Le",
  openGraph: {
    type: "article",
    title: "Portfolio Tracker — Multi-Chain Crypto Portfolio — Análise de Rastreador de Portfólio",
    description: "Guia completo sobre Portfolio Tracker — Multi-Chain Crypto Portfolio em português. A CVM e o Banco Central regulamentam ",
    url: "https://degen0x.com/pt-br/portfolio-tracker",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Portfolio Tracker — Multi-Chain Crypto Portfolio — Análise de Rastreador de Portfólio", description: "Guia completo sobre Portfolio Tracker — Multi-Chain Crypto Portfolio em português. A CVM e o Banco Central regulamentam " },
  alternates: {
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Portfolio Tracker — Multi-Chain Crypto Portfolio — Análise de Rastreador de Portfólio</h1>
            <p className="text-lg text-[#8b949e] mb-10">Guia completo sobre Portfolio Tracker — Multi-Chain Crypto Portfolio em português. A CVM e o Banco Central regulamentam ativos digitais no Brasil sob o Marco Legal das Criptomoedas (Lei 14.478/2022).</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Análise do Rastreador</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Rastreador de portfólio Portfolio Tracker — Multi-Chain Crypto Portfolio: exchanges suportadas, integrações de carteira, rastreamento de preço em tempo real e relatórios de performance.</p>
            </section>
