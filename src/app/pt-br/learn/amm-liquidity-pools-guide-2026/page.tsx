...
export const metadata: Metadata = {
  title: "AMM & Liquidity Pools: Guia Completo em Português 2026 | Degen0x",
  description: "Tudo o que você precisa saber sobre AMM & Liquidity Pools. Conceitos básicos, como funciona, riscos e atualizações de 2026 — guia completo em português.",
  openGraph: {
    type: "article",
    title: "AMM & Liquidity Pools: Guia Completo em Português 2026",
    description: "Tudo o que você precisa saber sobre AMM & Liquidity Pools. Conceitos básicos, como funciona, riscos e atualizações de 20",
    url: "https://degen0x.com/pt-br/learn/amm-liquidity-pools-guide-2026",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "AMM & Liquidity Pools: Guia Completo em Português 2026", description: "Tudo o que você precisa saber sobre AMM & Liquidity Pools. Conceitos básicos, como funciona, riscos e atualizações de 20" },
  alternates: {
    canonical: "/pt-br/learn/amm-liquidity-pools-guide-2026",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "AMM & Liquidity Pools: Guia Completo em Português 2026" }
  ],
};
