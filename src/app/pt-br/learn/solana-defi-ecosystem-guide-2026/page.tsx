...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "article",
    title: "Solana DeFi Ecossistema: Guia Completo em Português 2026",
    description: "Tudo o que você precisa saber sobre Solana DeFi Ecossistema. Conceitos básicos, como funciona, riscos e atualizações de ",
    url: "https://degen0x.com/pt-br/learn/solana-defi-ecosystem-guide-2026",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Solana DeFi Ecossistema: Guia Completo em Português 2026", description: "Tudo o que você precisa saber sobre Solana DeFi Ecossistema. Conceitos básicos, como funciona, riscos e atualizações de " },
  alternates: {
    canonical: "/pt-br/learn/solana-defi-ecosystem-guide-2026",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Solana DeFi Ecossistema: Guia Completo em Português 2026" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Solana DeFi Ecossistema: Guia Completo em Português 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Tudo o que você precisa saber sobre Solana DeFi Ecossistema. Conceitos básicos, como funciona, riscos e atualizações de 2026 — guia completo em português.</p>
