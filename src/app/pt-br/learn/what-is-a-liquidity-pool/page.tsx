...
export const metadata: Metadata = {
  title: "Liquidity Pools: Guia Completo em Português 2026 | Degen0x",
  description: "Tudo o que você precisa saber sobre Liquidity Pools. Conceitos básicos, como funciona, riscos e atualizações de 2026 — guia completo em português.",
  openGraph: {
    type: "article",
    title: "Liquidity Pools: Guia Completo em Português 2026",
    description: "Tudo o que você precisa saber sobre Liquidity Pools. Conceitos básicos, como funciona, riscos e atualizações de 2026 — g",
    url: "https://degen0x.com/pt-br/learn/what-is-a-liquidity-pool",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Liquidity Pools: Guia Completo em Português 2026", description: "Tudo o que você precisa saber sobre Liquidity Pools. Conceitos básicos, como funciona, riscos e atualizações de 2026 — g" },
  alternates: {
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Liquidity Pools: Guia Completo em Português 2026" }
  ],
};
...
const faqSchema = generateFAQSchema([
  { "question": "O que é Liquidity Pools e como funciona?", "answer": "Liquidity Pools é um sistema descentralizado construído sobre tecnologia blockchain. Permite transações sem intermediários através de contratos inteligentes e desempenha um papel importante no ecossistema cripto. TVL DeFi ultrapassou \$200 bilhões em 2026. Aave v4, Uniswap v4 hooks e Pendle oferecem produtos financeiros de nova geração com DeFi institucional crescendo." },
  { "question": "Quais são os riscos de investir em Liquidity Pools?", "answer": "Principais riscos: vulnerabilidades de contratos inteligentes, volatilidade de mercado (oscilações de 20%+ ao dia são comuns), incertezas regulatórias e riscos de liquidez. Diversificação e uso de stop-loss são recomendados." },
  { "question": "O que mudou em Liquidity Pools em 2026?", "answer": "Em 2026: regulamento MiCA da UE entrou em vigor, Bitcoin spot ETFs se popularizaram globalmente, Ethereum completou upgrade Pectra e DeFi institucional cresceu significativamente. Liquidity Pools é diretamente afetado." },
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Liquidity Pools: Guia Completo em Português 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Tudo o que você precisa saber sobre Liquidity Pools. Conceitos básicos, como funciona, riscos e atualizações de 2026 — guia completo em português.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">O Que É Liquidity Pools?</h2>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Usando Liquidity Pools no Brasil</h2>
