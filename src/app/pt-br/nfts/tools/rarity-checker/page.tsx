...
export const metadata: Metadata = {
  title: "Rarity Checker — Guia de NFTs e Análise de Mercado 2026 | Degen0x",
  description: "Rarity Checker: análise de coleções, tendências de mercado, guia de minting e ecossistema NFT 2026.",
  openGraph: {
    type: "article",
    title: "Rarity Checker — Guia de NFTs e Análise de Mercado 2026",
    description: "Rarity Checker: análise de coleções, tendências de mercado, guia de minting e ecossistema NFT 2026.",
    url: "https://degen0x.com/pt-br/nfts/tools/rarity-checker",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Rarity Checker — Guia de NFTs e Análise de Mercado 2026", description: "Rarity Checker: análise de coleções, tendências de mercado, guia de minting e ecossistema NFT 2026." },
  alternates: {
    canonical: "/pt-br/nfts/tools/rarity-checker",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Rarity Checker — Guia de NFTs e Análise de Mercado 2026" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Rarity Checker — Guia de NFTs e Análise de Mercado 2026</h1>
            <p className="text-lg text-[#8b949e] mb-10">Rarity Checker: análise de coleções, tendências de mercado, guia de minting e ecossistema NFT 2026.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Análise do Mercado NFT</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Análise do mercado NFT 2026 para Rarity Checker: volume total de transações, usuários ativos, coleções populares e tendências de preço. O mercado de NFTs no Brasil tem crescido com artistas e colecionadores brasileiros ganhando destaque em plataformas globais.</p>
            </section>
            ...
            <section className="mb-10">
              ...
              <p className="text-[#c9d1d9] leading-relaxed">Estratégias de negociação NFT relacionadas a Rarity Checker: timing de mint, análise de floor price, ferramentas de raridade, otimização de gas e dinâmicas do mercado secundário.</p>
            </section>
