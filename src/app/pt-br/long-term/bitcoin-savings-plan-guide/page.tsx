...
export const metadata: Metadata = {
  title: "Bitcoin Poupança Plan — Estratégia Cripto de Longo Prazo | Degen0x",
  description: "Bitcoin Poupança Plan: estratégias de investimento cripto de longo prazo, diversificação de portfólio e abordagem hodl.",
  openGraph: {
    type: "article",
    title: "Bitcoin Poupança Plan — Estratégia Cripto de Longo Prazo",
    description: "Bitcoin Poupança Plan: estratégias de investimento cripto de longo prazo, diversificação de portfólio e abordagem hodl.",
    url: "https://degen0x.com/pt-br/long-term/bitcoin-savings-plan-guide",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Bitcoin Poupança Plan — Estratégia Cripto de Longo Prazo", description: "Bitcoin Poupança Plan: estratégias de investimento cripto de longo prazo, diversificação de portfólio e abordagem hodl." },
  alternates: {
    canonical: "/pt-br/long-term/bitcoin-savings-plan-guide",
    languages: { "en": "/long-term/bitcoin-savings-plan-guide", "tr": "/tr/long-term/bitcoin-savings-plan-guide", "vi": "/vi/long-term/bitcoin-savings-plan-guide", "pt-BR": "/pt-br/long-term/bitcoin-savings-plan-guide", "x-default": "/long-term/bitcoin-savings-plan-guide" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Bitcoin Poupança Plan — Estratégia Cripto de Longo Prazo" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Bitcoin Poupança Plan — Estratégia Cripto de Longo Prazo</h1>
            <p className="text-lg text-[#8b949e] mb-10">Bitcoin Poupança Plan: estratégias de investimento cripto de longo prazo, diversificação de portfólio e abordagem hodl.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Estratégia de Investimento de Longo Prazo</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Estratégia de investimento cripto de longo prazo para Bitcoin Poupança Plan: método hodl, DCA (compras regulares), value investing e análise macro.</p>
            </section>
