...
export const metadata: Metadata = {
  title: "Crypto Cursos — Curso de Criptomoedas | Degen0x",
  description: "Guia completo sobre Crypto Cursos em português. A CVM e o Banco Central regulamentam ativos digitais no Brasil sob o Marco Legal das Criptomoedas (Lei 14.478/20",
  openGraph: {
    type: "article",
    title: "Crypto Cursos — Curso de Criptomoedas",
    description: "Guia completo sobre Crypto Cursos em português. A CVM e o Banco Central regulamentam ativos digitais no Brasil sob o Mar",
    url: "https://degen0x.com/pt-br/courses",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto Cursos — Curso de Criptomoedas", description: "Guia completo sobre Crypto Cursos em português. A CVM e o Banco Central regulamentam ativos digitais no Brasil sob o Mar" },
  alternates: {
    canonical: "/pt-br/courses",
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Crypto Cursos — Curso de Criptomoedas</h1>
            <p className="text-lg text-[#8b949e] mb-10">Guia completo sobre Crypto Cursos em português. A CVM e o Banco Central regulamentam ativos digitais no Brasil sob o Marco Legal das Criptomoedas (Lei 14.478/2022).</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Conteúdo do Curso</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Curso cripto Crypto Cursos: currículo abrangente dos conceitos básicos às estratégias avançadas. Exemplos práticos e cenários reais de mercado.</p>
            </section>
