...
export const metadata: Metadata = {
  title: "NFT-Collateral Empréstimos — Comparação de Plataformas de Empréstimo Cripto | Degen0x",
  description: "Comparação NFT-Collateral Empréstimos: taxas de juros, requisitos de garantia, riscos de liquidação e confiabilidade da plataforma.",
  openGraph: {
    type: "article",
    title: "NFT-Collateral Empréstimos — Comparação de Plataformas de Empréstimo Cripto",
    description: "Comparação NFT-Collateral Empréstimos: taxas de juros, requisitos de garantia, riscos de liquidação e confiabilidade da ",
    url: "https://degen0x.com/pt-br/crypto-loans/best/nft-collateral",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "NFT-Collateral Empréstimos — Comparação de Plataformas de Empréstimo Cripto", description: "Comparação NFT-Collateral Empréstimos: taxas de juros, requisitos de garantia, riscos de liquidação e confiabilidade da " },
  alternates: {
    canonical: "/pt-br/crypto-loans/best/nft-collateral",
    languages: { "en": "/crypto-loans/best/nft-collateral", "tr": "/tr/crypto-loans/best/nft-collateral", "vi": "/vi/crypto-loans/best/nft-collateral", "pt-BR": "/pt-br/crypto-loans/best/nft-collateral", "x-default": "/crypto-loans/best/nft-collateral" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "NFT-Collateral Empréstimos — Comparação de Plataformas de Em" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <Breadcrumb items={[
              ...
              { label: "NFT-Collateral Empréstimos" }
          ]} />
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">NFT-Collateral Empréstimos — Comparação de Plataformas de Empréstimo Cripto</h1>
            <p className="text-lg text-[#8b949e] mb-10">Comparação NFT-Collateral Empréstimos: taxas de juros, requisitos de garantia, riscos de liquidação e confiabilidade da plataforma.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Plataformas de Empréstimo Cripto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Comparação de plataformas de empréstimo NFT-Collateral Empréstimos: taxas de juros (APR/APY), ativos de garantia suportados, requisitos mínimos de colateral (LTV) e riscos de liquidez.</p>
            </section>
