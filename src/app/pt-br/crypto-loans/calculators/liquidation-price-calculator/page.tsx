...
export const metadata: Metadata = {
  title: "Liquidation Price — Comparação de Plataformas de Empréstimo Cripto | Degen0x",
  description: "Comparação Liquidation Price: taxas de juros, requisitos de garantia, riscos de liquidação e confiabilidade da plataforma.",
  openGraph: {
    type: "article",
    title: "Liquidation Price — Comparação de Plataformas de Empréstimo Cripto",
    description: "Comparação Liquidation Price: taxas de juros, requisitos de garantia, riscos de liquidação e confiabilidade da plataform",
    url: "https://degen0x.com/pt-br/crypto-loans/calculators/liquidation-price-calculator",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Liquidation Price — Comparação de Plataformas de Empréstimo Cripto", description: "Comparação Liquidation Price: taxas de juros, requisitos de garantia, riscos de liquidação e confiabilidade da plataform" },
  alternates: {
    canonical: "/pt-br/crypto-loans/calculators/liquidation-price-calculator",
    languages: { "en": "/crypto-loans/calculators/liquidation-price-calculator", "tr": "/tr/crypto-loans/calculators/liquidation-price-calculator", "vi": "/vi/crypto-loans/calculators/liquidation-price-calculator", "pt-BR": "/pt-br/crypto-loans/calculators/liquidation-price-calculator", "x-default": "/crypto-loans/calculators/liquidation-price-calculator" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Liquidation Price — Comparação de Plataformas de Empréstimo " }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Liquidation Price — Comparação de Plataformas de Empréstimo Cripto</h1>
            <p className="text-lg text-[#8b949e] mb-10">Comparação Liquidation Price: taxas de juros, requisitos de garantia, riscos de liquidação e confiabilidade da plataforma.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Plataformas de Empréstimo Cripto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Comparação de plataformas de empréstimo Liquidation Price: taxas de juros (APR/APY), ativos de garantia suportados, requisitos mínimos de colateral (LTV) e riscos de liquidez.</p>
            </section>
