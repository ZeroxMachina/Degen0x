...
export const metadata: Metadata = {
  title: "NFT Tax — Guia de Impostos Cripto e Ferramentas | Degen0x",
  description: "NFT Tax: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser",
  openGraph: {
    type: "article",
    title: "NFT Tax — Guia de Impostos Cripto e Ferramentas",
    description: "NFT Tax: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto a",
    url: "https://degen0x.com/pt-br/taxes/nft-tax-guide-2026",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "NFT Tax — Guia de Impostos Cripto e Ferramentas", description: "NFT Tax: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto a" },
  alternates: {
    canonical: "/pt-br/taxes/nft-tax-guide-2026",
    languages: { "en": "/taxes/nft-tax-guide-2026", "tr": "/tr/taxes/nft-tax-guide-2026", "vi": "/vi/taxes/nft-tax-guide-2026", "pt-BR": "/pt-br/taxes/nft-tax-guide-2026", "x-default": "/taxes/nft-tax-guide-2026" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "NFT Tax — Guia de Impostos Cripto e Ferramentas" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">NFT Tax — Guia de Impostos Cripto e Ferramentas</h1>
            <p className="text-lg text-[#8b949e] mb-10">NFT Tax: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Obrigações Fiscais Cripto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Obrigações fiscais no escopo de NFT Tax: No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal. Transações tributáveis: compra/venda, rendimentos de staking, airdrops, mineração e ganhos DeFi.</p>
            </section>
