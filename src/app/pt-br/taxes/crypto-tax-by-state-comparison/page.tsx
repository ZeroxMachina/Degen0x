...
export const metadata: Metadata = {
  title: "Crypto Tax by State — Guia de Impostos Cripto e Ferramentas | Degen0x",
  description: "Crypto Tax by State: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em vend",
  openGraph: {
    type: "article",
    title: "Crypto Tax by State — Guia de Impostos Cripto e Ferramentas",
    description: "Crypto Tax by State: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos ",
    url: "https://degen0x.com/pt-br/taxes/crypto-tax-by-state-comparison",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Crypto Tax by State — Guia de Impostos Cripto e Ferramentas", description: "Crypto Tax by State: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos " },
  alternates: {
    canonical: "/pt-br/taxes/crypto-tax-by-state-comparison",
    languages: { "en": "/taxes/crypto-tax-by-state-comparison", "tr": "/tr/taxes/crypto-tax-by-state-comparison", "vi": "/vi/taxes/crypto-tax-by-state-comparison", "pt-BR": "/pt-br/taxes/crypto-tax-by-state-comparison", "x-default": "/taxes/crypto-tax-by-state-comparison" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto Tax by State — Guia de Impostos Cripto e Ferramentas" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Crypto Tax by State — Guia de Impostos Cripto e Ferramentas</h1>
            <p className="text-lg text-[#8b949e] mb-10">Crypto Tax by State: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Obrigações Fiscais Cripto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Obrigações fiscais no escopo de Crypto Tax by State: No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal. Transações tributáveis: compra/venda, rendimentos de staking, airdrops, mineração e ganhos DeFi.</p>
            </section>
