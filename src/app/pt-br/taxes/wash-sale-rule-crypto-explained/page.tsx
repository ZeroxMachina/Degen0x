...
export const metadata: Metadata = {
  title: "Wash Sale Rule & Crypto — Guia de Impostos Cripto e Ferramentas | Degen0x",
  description: "Wash Sale Rule & Crypto: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em ",
  openGraph: {
    type: "article",
    title: "Wash Sale Rule & Crypto — Guia de Impostos Cripto e Ferramentas",
    description: "Wash Sale Rule & Crypto: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, gan",
    url: "https://degen0x.com/pt-br/taxes/wash-sale-rule-crypto-explained",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Wash Sale Rule & Crypto — Guia de Impostos Cripto e Ferramentas", description: "Wash Sale Rule & Crypto: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, gan" },
  alternates: {
    canonical: "/pt-br/taxes/wash-sale-rule-crypto-explained",
    languages: { "en": "/taxes/wash-sale-rule-crypto-explained", "tr": "/tr/taxes/wash-sale-rule-crypto-explained", "vi": "/vi/taxes/wash-sale-rule-crypto-explained", "pt-BR": "/pt-br/taxes/wash-sale-rule-crypto-explained", "x-default": "/taxes/wash-sale-rule-crypto-explained" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Wash Sale Rule & Crypto — Guia de Impostos Cripto e Ferramen" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Wash Sale Rule & Crypto — Guia de Impostos Cripto e Ferramentas</h1>
            <p className="text-lg text-[#8b949e] mb-10">Wash Sale Rule & Crypto: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Obrigações Fiscais Cripto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Obrigações fiscais no escopo de Wash Sale Rule & Crypto: No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal. Transações tributáveis: compra/venda, rendimentos de staking, airdrops, mineração e ganhos DeFi.</p>
            </section>
