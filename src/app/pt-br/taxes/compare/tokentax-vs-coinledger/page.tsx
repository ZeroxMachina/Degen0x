...
export const metadata: Metadata = {
  title: "TokenTax vs CoinLedger — Guia de Impostos Cripto e Ferramentas | Degen0x",
  description: "TokenTax vs CoinLedger: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em v",
  openGraph: {
    type: "article",
    title: "TokenTax vs CoinLedger — Guia de Impostos Cripto e Ferramentas",
    description: "TokenTax vs CoinLedger: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganh",
    url: "https://degen0x.com/pt-br/taxes/compare/tokentax-vs-coinledger",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "TokenTax vs CoinLedger — Guia de Impostos Cripto e Ferramentas", description: "TokenTax vs CoinLedger: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganh" },
  alternates: {
    canonical: "/pt-br/taxes/compare/tokentax-vs-coinledger",
    languages: { "en": "/taxes/compare/tokentax-vs-coinledger", "tr": "/tr/taxes/compare/tokentax-vs-coinledger", "vi": "/vi/taxes/compare/tokentax-vs-coinledger", "pt-BR": "/pt-br/taxes/compare/tokentax-vs-coinledger", "x-default": "/taxes/compare/tokentax-vs-coinledger" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "TokenTax vs CoinLedger — Guia de Impostos Cripto e Ferrament" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">TokenTax vs CoinLedger — Guia de Impostos Cripto e Ferramentas</h1>
            <p className="text-lg text-[#8b949e] mb-10">TokenTax vs CoinLedger: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Obrigações Fiscais Cripto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Obrigações fiscais no escopo de TokenTax vs CoinLedger: No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal. Transações tributáveis: compra/venda, rendimentos de staking, airdrops, mineração e ganhos DeFi.</p>
            </section>
