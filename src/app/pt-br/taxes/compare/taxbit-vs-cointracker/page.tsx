...
export const metadata: Metadata = {
  title: "TaxBit vs CoinTracker — Guia de Impostos Cripto e Ferramentas | Degen0x",
  description: "TaxBit vs CoinTracker: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em ve",
  openGraph: {
    type: "article",
    title: "TaxBit vs CoinTracker — Guia de Impostos Cripto e Ferramentas",
    description: "TaxBit vs CoinTracker: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganho",
    url: "https://degen0x.com/pt-br/taxes/compare/taxbit-vs-cointracker",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "TaxBit vs CoinTracker — Guia de Impostos Cripto e Ferramentas", description: "TaxBit vs CoinTracker: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganho" },
  alternates: {
    canonical: "/pt-br/taxes/compare/taxbit-vs-cointracker",
    languages: { "en": "/taxes/compare/taxbit-vs-cointracker", "tr": "/tr/taxes/compare/taxbit-vs-cointracker", "vi": "/vi/taxes/compare/taxbit-vs-cointracker", "pt-BR": "/pt-br/taxes/compare/taxbit-vs-cointracker", "x-default": "/taxes/compare/taxbit-vs-cointracker" },
  },
};
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "TaxBit vs CoinTracker — Guia de Impostos Cripto e Ferramenta" }
  ],
};
      ...
      <main className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <article className="mt-8" lang="pt-BR">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">TaxBit vs CoinTracker — Guia de Impostos Cripto e Ferramentas</h1>
            <p className="text-lg text-[#8b949e] mb-10">TaxBit vs CoinTracker: obrigações fiscais cripto, preparação de declaração e ferramentas de otimização. No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal.</p>

            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-white mb-4">Obrigações Fiscais Cripto</h2>
              <p className="text-[#c9d1d9] leading-relaxed">Obrigações fiscais no escopo de TaxBit vs CoinTracker: No Brasil, ganhos com cripto acima de R\$35.000/mês em vendas devem ser declarados à Receita Federal. Transações tributáveis: compra/venda, rendimentos de staking, airdrops, mineração e ganhos DeFi.</p>
            </section>
