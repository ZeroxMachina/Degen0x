...
export const metadata: Metadata = {
  title: "Altcoin Season Index — Ferramenta Cripto Gratuita | Degen0x",
  description: "Use a ferramenta Altcoin Season Index gratuitamente. Analise o mercado cripto, faça cálculos e tome decisões informadas. Sem necessidade de cadastro.",
  openGraph: {
    type: "article",
    title: "Altcoin Season Index — Ferramenta Cripto Gratuita",
    description: "Use a ferramenta Altcoin Season Index gratuitamente. Analise o mercado cripto, faça cálculos e tome decisões informadas.",
    url: "https://degen0x.com/pt-br/tools/altcoin-season-index",
    locale: "pt_BR",
    images: [{ url: "https://degen0x.com/og-default.svg", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image", title: "Altcoin Season Index — Ferramenta Cripto Gratuita", description: "Use a ferramenta Altcoin Season Index gratuitamente. Analise o mercado cripto, faça cálculos e tome decisões informadas." },
  alternates: {
    canonical: "/pt-br/tools/altcoin-season-index",
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Altcoin Season Index — Ferramenta Cripto Gratuita" }
  ],
};
