...
export const metadata: Metadata = {
  title: 'Real-World Asset Tokenization Business Guide 2026: RWA Platforms, STOs, Compliance | degen0x',
  description: 'Complete guide to RWA tokenization business. Cover Polymath, Securitize, tZERO, RealT ($100M+ tokenized). Learn STOs, Reg D/S/A+, fractional ownership, secondary liquidity.',
