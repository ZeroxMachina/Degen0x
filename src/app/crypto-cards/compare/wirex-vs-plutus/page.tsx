...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Wirex Vs Plutus', },
  ],
};
...
export default function WirexVsPlutusPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="Wirex vs Plutus: Best European Crypto Card (2026) | degen0x"
        description="Wirex Card vs Plutus Card compared for European users. Cashback rates, token staking, subscription plans, perks, and which card is best for UK and EEA"
        url="https://degen0x.com/crypto-cards/compare/wirex-vs-plutus"
...
<AuthoritySources url="/crypto-cards/compare/wirex-vs-plutus" />
    </div>
  );
}
