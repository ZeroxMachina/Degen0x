...
export const metadata: Metadata = {
  ...
  description:
    "Crypto.com Visa vs Binance Card compared. Cashback rates, staking requirements, availability, fees, and perks analyzed to find the best crypto debit card for you.",
};
