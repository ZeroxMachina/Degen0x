...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Debit', },
  ],
};
...
export default function BestDebitCardsPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ArticleSchema
        headline="Best Crypto Prepaid Cards"
        description="Best Crypto Prepaid Cards"
        url="/crypto-cards/best/debit"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Crypto Cards"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/crypto-cards/best/debit" />
        <ReadingTime />
      </div>
<AuthoritySources url="/crypto-cards/best/debit" />
