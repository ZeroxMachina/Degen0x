  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-invert max-w-none mb-10">
        ...
        <h2 className="text-xl font-bold text-white mt-8 mb-4">How Staking Tiers Work</h2>
        ...
        <p className="text-[var(--color-text-secondary)] leading-relaxed">
          The <strong className="text-white">Crypto.com Visa</strong> offers the most mature
          staking tier system with five levels from zero staking to $400,000, each unlocking
          progressively better cashback and perks. The <strong className="text-white">Binance Card</strong> delivers
          the highest potential cashback at 8% for major BNB holders. The{" "}
          <strong className="text-white">Plutus Card</strong> stands out with its decentralized PLU token
      ...
      <section className="mb-12 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-8">
        <h2 className="text-2xl font-bold text-white mb-4">Staking Tier Comparison</h2>
        <div className="space-y-6 text-[var(--color-text-secondary)]">
          <div>
            <h3 className="text-white font-semibold mb-2">Crypto.com Visa (CRO Staking)</h3>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-2 text-sm">
              <div className="p-3 rounded-lg bg-[var(--color-bg)]/50">
                <p className="text-white font-medium">Midnight Blue</p>
                <p>$0 stake</p>
                <p>1% cashback</p>
              </div>
              <div className="p-3 rounded-lg bg-[var(--color-bg)]/50">
                <p className="text-white font-medium">Ruby Steel</p>
                <p>$400 stake</p>
                <p>2% cashback</p>
              </div>
              <div className="p-3 rounded-lg bg-[var(--color-bg)]/50">
                <p className="text-white font-medium">Royal Indigo</p>
                <p>$4,000 stake</p>
                <p>3% cashback</p>
              </div>
              <div className="p-3 rounded-lg bg-[var(--color-bg)]/50">
                <p className="text-white font-medium">Icy White</p>
                <p>$40,000 stake</p>
                <p>5% cashback</p>
              </div>
              <div className="p-3 rounded-lg bg-[var(--color-bg)]/50">
                <p className="text-white font-medium">Obsidian</p>
                <p>$400,000 stake</p>
                <p>5% cashback</p>
              </div>
            </div>
          ...
          <div>
            <h3 className="text-white font-semibold mb-2">Binance Card (BNB Staking)</h3>
          ...
          <div>
            <h3 className="text-white font-semibold mb-2">Plutus Card (PLU Staking)</h3>
