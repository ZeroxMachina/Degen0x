...
const buildSearchIndex = (): SearchResult[] => {
  ...
  const specialPages = [
    ...
    { title: "Contact Us", desc: "Get in touch with the CryptoDegen team.", url: "/contact", cat: "General" },
...
export default function SearchPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-[var(--color-text)] mb-3">Search CryptoDegen</h1>
