...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Protocol Cover', },
  ],
};
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      <ArticleSchema
        headline="Insurance"
        description="Compare the best DeFi protocol cover insurance. Protect against governance attacks, oracle manipulation, and protocol-level failures across major DeFi"
        url="/insurance/best/protocol-cover"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Insurance"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/insurance/best/protocol-cover" />
        <ReadingTime />
      </div>
<AuthoritySources url="/insurance/best/protocol-cover" />
