...
export default function UnslashedReviewPage() {
  return (
    <>
      <ReviewSchema
        itemName="Unslashed Finance Review (2026)"
        url="https://degen0x.com/insurance/reviews/unslashed"
        rating={4.0}
    ...
    />
      <ArticleSchema
        headline="Unslashed Finance Review (2026) | degen0x"
        description="Unslashed Finance is a decentralized insurance protocol offering coverage for DeFi exploits, exchange hacks, stablecoin depegging, and validator slashing with"
        url="https://degen0x.com/insurance/reviews/unslashed"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/insurance/reviews/unslashed" />
        <ReadingTime />
      </div>
