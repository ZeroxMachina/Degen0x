...
export default function SherlockReview() {
  return (
    <>
      <ReviewSchema
        itemName="Sherlock Review 2026: Fees, Features, Pros & Cons"
        url="https://degen0x.com/insurance/reviews/sherlock"
        rating={4.0}
...
Sherlock's staking mechanism allows anyone to provide capital to the coverage pool, earning yield from audit fees and premiums in exchange for accepting claims risk.`}
    ...
    />
      <ArticleSchema
        headline="Sherlock Review 2026: Fees, Features, Pros & Cons"
        description="Sherlock Protocol review: Smart contract security insurance. Coverage, claims, premiums. Compare crypto insurance and smart contract audit services."
        url="https://degen0x.com/insurance/reviews/sherlock"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/insurance/reviews/sherlock" />
        <ReadingTime />
      </div>
