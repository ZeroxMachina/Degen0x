...
export const metadata: Metadata = { title: "DeFi Insurance: How It Works (2026)", description: "Deep dive into how decentralized insurance protocols work, including risk pooling, capital provision, claim assessment, and the economics of DeFi coverage." };

export default function DefiInsuranceHowItWorksPage() {
  return (
