...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Smart Contract Cover Nexus Mutual', },
  ],
};
...
export default function NexusMutualSmartContractCover() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Nexus Mutual Smart Contract Cover 2026 | NXM Staking,"
        description="Complete guide to Nexus Mutual: $500M+ active smart contract cover, NXM staking, member voting claims, pricing models, cover types for DeFi."
        url="https://degen0x.com/insurance/smart-contract-cover-nexus-mutual"
        datePublished="2024-06-01"
        dateModified="2026-04-17"
        section="Insurance"
      />
            <div className="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500 border-b border-gray-100 pb-3">
        <LastUpdated pathKey="/insurance/smart-contract-cover-nexus-mutual" />
        <ReadingTime />
      </div>
<AuthoritySources url="/insurance/smart-contract-cover-nexus-mutual" />
