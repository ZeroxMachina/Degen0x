...
export const metadata: Metadata = {
  title: 'Best Free DeFi Courses 2026: Uniswap, Aave, Yield Farming, Smart Contracts',
  description: 'Free DeFi courses 2026. Master decentralized finance: AMM mechanics, Uniswap V4, Aave lending, MakerDAO stablecoins, yield farming, liquidity pools, risk management.',
