...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Crypto Tax Accounting Course', },
  ],
};
...
export default function CryptoTaxAccountingCourse() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Best Crypto Tax Accounting Courses 2026: Master IRS"
        description="Crypto tax accounting courses 2026: Learn IRS Form 8949, Schedule D, DeFi taxation, NFT reporting. Free resources (IRS Pub 525, CryptoSlate) and paid courses"
        url="https://degen0x.com/courses/crypto-tax-accounting-course"
      ...
      />
        ...
        <LastUpdated pathKey="/courses/crypto-tax-accounting-course" />
        <ReadingTime />
      </div>
<AuthoritySources url="/courses/crypto-tax-accounting-course" />
