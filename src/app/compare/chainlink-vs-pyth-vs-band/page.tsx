...
export default function ChainlinkPythBand() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Chainlink vs Pyth vs Band: Crypto Oracle Comparison"
        description="Compare oracle networks: Chainlink (decentralized node network, $150B TVL), Pyth (first-party data, 350+ feeds), Band (delegated staking). Latency, chains,"
        url="https://degen0x.com/compare/chainlink-vs-pyth-vs-band"
...
{/* section-footer */}
      ...
      <AuthoritySources url="/compare/chainlink-vs-pyth-vs-band" />
      </article>
  );
}
