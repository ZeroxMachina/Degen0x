  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--color-bg)" }}>
      <SoftwareApplicationSchema
        ...
        name="Cautious Crypto Curious"
        description="You dip your toes into crypto but keep your sanity intact. You probably sleep 8 hours and have a diversified portfolio. NPC investors fear you; your financial advisor loves you."
      />
      {/* Header */}
      <section
