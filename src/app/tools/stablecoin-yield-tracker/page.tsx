...
// ── Stablecoin Data (static, updated March 2026) ───────────────────────────────
  ...
  return (
    <div style={{ minHeight: "100vh", background: S.bg, color: S.text }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 16px 80px" }}>
        <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Tools", href: "/tools" }, { label: "Stablecoin Yield Tracker" }]} />
        ...
        <div style={{ paddingBottom: 28, paddingTop: 20 }}>
          ...
          <h1 style={{ fontSize: 32, fontWeight: 900, marginBottom: 10 }}>
            Best Stablecoin Yields — March 2026
          </h1>
