...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Crypto Profit Calculator" },
  ],
};
...
const structuredData = {
  ...
  image: "/api/og?title=Crypto+Profit+Calculator&subtitle=Gains%2C+ROI%2C+Fees+%26+Tax",
...
/* ── Shared styles (CSS-var tokens, zero hardcoded hex) ───── */
...
export default function CryptoProfitCalculatorPage() {
  return (
    ...
    >
      {/* JSON-LD (deduplicated — removed standalone WebPage) */}
      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        {/* Breadcrumb */}
        <nav aria-label="Breadcrumb" style={{ marginBottom: 20, fontSize: 13, color: "var(--color-text-secondary)" }}>
          <Link href="/" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Home</Link>
          <span style={{ margin: "0 6px" }}>&rsaquo;</span>
          <Link href="/tools" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Tools</Link>
          <span style={{ margin: "0 6px" }}>&rsaquo;</span>
          <span style={{ color: "var(--color-text)" }}>Profit Calculator</span>
        </nav>

        {/* Header */}
        <div style={{ marginBottom: 32 }}>
          <div>
            <span style={{ ...badgeStyle, background: "var(--color-success)", color: "#fff" }}>Tools</span>
            <span style={{ ...badgeStyle, background: "var(--color-border)", color: "var(--color-text)" }}>Essential</span>
          </div>
          <h1
            style={{
              fontSize: 36,
          ...
          <div style={{ display: "flex", gap: 24, fontSize: 14, color: "var(--color-text-secondary)", marginBottom: 24 }}>
        ...
        <nav aria-label="Table of Contents" style={{ ...infoBoxStyle, marginBottom: 32 }}>
          <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 16, color: "var(--color-text)" }}>Table of Contents</h3>
          <ol style={{ marginLeft: 20, color: "var(--color-primary-light)" }}>
            {[
              { href: "#how-to-use", label: "How to Use the Crypto Profit Calculator" },
              { href: "#understanding-roi", label: "Understanding Crypto ROI" },
              { href: "#trading-fees", label: "Factoring in Trading Fees" },
              { href: "#tax-implications", label: "Tax Implications of Crypto Profits" },
              { href: "#common-mistakes", label: "Common Profit Calculation Mistakes" },
              { href: "#faq", label: "FAQ" },
            ].map((item) => (
        ...
        <section id="how-to-use" style={{ scrollMarginTop: 24 }}>
          ...
          <p style={{ marginBottom: 16, lineHeight: 1.8, color: "var(--color-text)" }}>
            <strong style={{ color: "var(--color-text)" }}>Optional fields:</strong> If you paid trading fees (typical 0.1-0.5% per exchange), enter the fee percentage. If you owe capital gains taxes (15-37% depending on jurisdiction), enter your tax rate. The calculator will deduct these from your profit. This gives you your true net profit after all costs.
          </p>
          <div style={infoBoxStyle}>
            <strong style={{ color: "var(--color-text)" }}>Example:</strong>
            <p style={{ marginTop: 12, marginBottom: 8, fontSize: 14, color: "var(--color-text)" }}>
        ...
        <section id="understanding-roi" style={{ scrollMarginTop: 24 }}>
          ...
          <p style={{ marginBottom: 16, lineHeight: 1.8, color: "var(--color-text)" }}>
            ROI (Return on Investment) measures how much money you made relative to what you invested. It&apos;s the best metric to compare different trades. ROI = (Profit / Total Cost Basis) &times; 100. If you invest $1,000 and profit $200, ROI = 20%. If you invest $10,000 and profit $200, ROI = 2%. Same absolute profit, very different returns.
          </p>
          <p style={{ marginBottom: 16, lineHeight: 1.8, color: "var(--color-text)" }}>
            <strong style={{ color: "var(--color-text)" }}>Why ROI matters:</strong> It helps you evaluate your trading performance objectively. A 50% ROI on a small trade ($500 &rarr; $750) shows same skill as 50% on a large trade ($100,000 &rarr; $150,000), but the large trade makes more absolute profit ($50k vs $250). Track both ROI (skill) and absolute profit (wealth creation).
          </p>
          <p style={{ marginBottom: 16, lineHeight: 1.8, color: "var(--color-text)" }}>
        ...
        <section id="trading-fees" style={{ scrollMarginTop: 24 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: "var(--color-text)" }}>Fee Impact Example:</strong>
            <ul style={{ marginTop: 12, marginBottom: 0, marginLeft: 20, color: "var(--color-text)", fontSize: 14 }}>
        ...
        <section id="tax-implications" style={{ scrollMarginTop: 24 }}>
          ...
          <p style={{ marginBottom: 16, lineHeight: 1.8, color: "var(--color-text)" }}>
            Cryptocurrency profits are taxable events in most jurisdictions. The US IRS taxes crypto as property (capital gains), not currency. If you buy Bitcoin for $40k and sell for $60k, you owe capital gains tax on the $20k profit. Tax rate depends on how long you held: short-term (&lt;1 year) is taxed as income (10-37% marginal), long-term (&ge;1 year) is taxed at lower rates (0-20%).
          </p>
          <div style={infoBoxStyle}>
            <strong style={{ color: "var(--color-text)" }}>Tax Rate Examples (US 2026):</strong>
            <ul style={{ marginTop: 12, marginBottom: 0, marginLeft: 20, color: "var(--color-text)", fontSize: 14 }}>
          ...
          <p style={{ marginBottom: 16, lineHeight: 1.8, color: "var(--color-text)" }}>
            <strong style={{ color: "var(--color-text)" }}>Tax-efficient strategies:</strong> Hold coins for &gt;1 year to get long-term rates (save 15-25% on taxes). Harvest losses&mdash;sell losing positions to offset gains. Keep meticulous records of buy/sell prices, dates, fees (IRS requires cost basis). Use tax software like Koinly or CoinTracker to automate calculations. Consult a CPA familiar with crypto for complex situations.
          </p>
          <p style={{ marginBottom: 16, lineHeight: 1.8, color: "var(--color-text)" }}>
            <strong style={{ color: "var(--color-text)" }}>Note:</strong> Different countries have different rules. UK taxes at 20% flat (or income rates for high earners). Germany has 1-year holding period for 0% tax. Singapore has no capital gains tax. Always research your jurisdiction and consider professional advice before taking profits.
          </p>
        </section>
        ...
        <section id="common-mistakes" style={{ scrollMarginTop: 24 }}>
          ...
          <div style={infoBoxStyle}>
            <strong style={{ color: "var(--color-text)" }}>Top Mistakes:</strong>
            <ol style={{ marginTop: 12, marginBottom: 0, marginLeft: 20, color: "var(--color-text)", fontSize: 14 }}>
          ...
          {[
            {
              ...
              a: "Crypto profit = (Sell Price × Quantity) - (Buy Price × Quantity) - Trading Fees - Taxes. First, calculate your proceeds (what you sold for minus sell fees). Then subtract your cost basis (what you paid plus buy fees). Finally, deduct any capital gains taxes owed. The remainder is your net profit or loss. This calculator automates all steps.",
            },
            {
              q: "What are trading fees and how do they affect profit?",
              a: "Trading fees are charged by exchanges when you buy or sell. Typical fees: 0.1% (Coinbase) to 0.05% (Kraken). On a $10,000 trade with 0.1% fee, you pay $10. If you buy and sell the same coins, fees apply twice. Example: Buy 1 BTC at $50k with 0.1% fee = $50 cost. Sell at $55k with 0.1% fee = $55 cost. Total fees: $105, reducing profit by 2.1%. Use our calculator to factor this in.",
            },
            {
              q: "Do I have to pay taxes on crypto profits?",
              a: "Yes, in most countries. Capital gains tax is owed when you sell crypto at a profit. Short-term gains (held < 1 year) taxed as income (15-37% in the US). Long-term gains (held > 1 year) taxed at lower rates (0-20% in the US). Some countries tax it as income (40%+ in UK). Losses can offset gains. Keep records of all trades. This calculator lets you estimate taxes; consult a tax professional for accurate amounts.",
            },
            {
              q: "What is ROI and how is it different from profit percentage?",
              a: "ROI (Return on Investment) = (Net Profit / Total Cost Basis) × 100. It tells you the percentage return on money invested. Gain/Loss % = ((Sell Price - Buy Price) / Buy Price) × 100. It only looks at price movement, ignoring fees and taxes. Example: Buy $1,000 worth at $50/coin, sell at $75/coin. Price gain = 50%. But with 1% fees ($20) and 20% tax on $500 profit ($100), ROI = ($400 profit / $1,020 cost) = 39.2%. Always check ROI to see true returns.",
            },
            {
              q: "How do trading fees and taxes impact long-term crypto investing?",
              a: "Over time, fees and taxes significantly erode returns. On a 10-year investment with 5 trades: $10,000 invested, each trade 0.2% fees = $200 total fees (2%). Capital gains tax on 100% gains at 25% = $1,875 tax. Combined cost: $2,075 (17% of profit). This is why HODLing (holding > 1 year) is tax-efficient and frequent trading is expensive. Use this calculator to compare: hold-and-sell vs. frequent trading. Long-term usually wins due to lower tax rates and fewer fees.",
            },
          ].map((faq) => (
            <div key={faq.q} style={{ ...infoBoxStyle, marginBottom: 16 }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, color: "var(--color-primary-light)", marginBottom: 10 }}>{faq.q}</h3>
              <p style={{ color: "var(--color-text)", fontSize: 14, lineHeight: 1.7, marginBottom: 0 }}>{faq.a}</p>
            </div>
          ))}
        </section>

        {/* Disclaimer */}
        <div style={{ ...infoBoxStyle, marginTop: 48, fontSize: 13, color: "var(--color-text-secondary)" }}>
          <strong>Disclaimer:</strong> This calculator is for informational purposes only. Not financial advice. Crypto is highly volatile and carries significant risk. Tax laws vary by jurisdiction&mdash;always consult a qualified tax professional or CPA before selling crypto and reporting taxes. degen0x does not endorse any investment strategy or assume responsibility for your trading or tax decisions.
        </div>
        ...
        >
          ...
          <ul style={{ marginLeft: 20, lineHeight: 1.9 }}>
            {[
              { href: "/tools/dca-calculator", label: "DCA Calculator", desc: "Dollar-cost averaging strategy" },
              { href: "/tools/pnl-calculator", label: "P&L Calculator", desc: "Multi-trade profit & loss tracking" },
              { href: "/tools/liquidation-price-calculator", label: "Liquidation Price Calculator", desc: "Know your margin safety" },
              { href: "/learn/how-to-read-crypto-charts-for-beginners", label: "How to Read Crypto Charts", desc: "Technical analysis fundamentals" },
            ].map((link) => (
              <li key={link.href} style={{ transition: "transform 0.15s ease" }}>
                <Link
                  href={link.href}
                  style={linkStyle}
                  className="focus-visible-ring"
