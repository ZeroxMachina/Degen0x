...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Bitcoin Halving Countdown', },
  ],
};
...
export default function BitcoinHalvingCountdown() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="Bitcoin Halving Countdown 2026: 2028 Halving & Miner"
        description="Track Bitcoin halving cycle countdown. 2028 halving cuts block reward from 3.125 to 1.5625 BTC. Understand historical halving impact, miner economics, and"
        url="https://degen0x.com/tools/bitcoin-halving-countdown"
      ...
      />
        ...
        <LastUpdated pathKey="/tools/bitcoin-halving-countdown" />
        <ReadingTime />
      </div>
<AuthoritySources url="/tools/bitcoin-halving-countdown" />
      <SoftwareApplicationSchema
        url="https://degen0x.com/tools/bitcoin-halving-countdown"
        name="Bitcoin Halving Countdown 2026: 2028 Halving & Miner"
        description="Track Bitcoin halving cycle countdown. 2028 halving cuts block reward from 3.125 to 1.5625 BTC. Understand historical halving impact, miner economics, and"
      />
