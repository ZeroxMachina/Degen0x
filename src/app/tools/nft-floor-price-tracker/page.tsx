...
export default function NftFloorPriceTracker() {
  ...
  return (
    <article id="top" style={{ background: '#0d1117', color: '#e6edf3', minHeight: '100vh', padding: '40px 20px', scrollBehavior: 'smooth' }}>
      <ArticleSchema
        headline="NFT Floor Price Tracker | degen0x"
        description="Track NFT floor prices live: Bluechip collections (BAYC, Pudgy Penguins, Punks). Analyze floor vs volume divergence. Top trackers: NFTGo, Blur, OpenSea"
        url="https://degen0x.com/tools/nft-floor-price-tracker"
      ...
      />
        ...
        <LastUpdated pathKey="/tools/nft-floor-price-tracker" />
        <ReadingTime />
      </div>
<AuthoritySources url="/tools/nft-floor-price-tracker" />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "NFT Floor Price Tracker | degen0x", "description": "Track NFT floor prices live: Bluechip collections (BAYC, Pudgy Penguins, Punks). Analyze floor vs volume divergence. Top trackers: NFTGo, Blur, OpenSea", "url": "https://degen0x.com/tools/nft-floor-price-tracker", "datePublished": "2026-04-13", "dateModified": "2026-04-13"}) }} />
        ...
        />
      <RelatedContent category="tools" currentSlug="/tools/nft-floor-price-tracker" />
      </article>
  );
}
