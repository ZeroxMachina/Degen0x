...
export const metadata: Metadata = {
  ...
  description:
    "Master long-term crypto investing. Crypto IRAs, HODL strategies, passive income, retirement planning, estate planning, and FIRE with cryptocurrency. Expert guides, calculators, and provider reviews.",
};
